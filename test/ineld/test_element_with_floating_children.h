...
* \file
*
* This header provides tests for the Ld::ElementWithFloatingChildren class.
***********************************************************************************************************************/

#ifndef TEST_ELEMENT_WITH_FLOATING_CHILDREN_H
#define TEST_ELEMENT_WITH_FLOATING_CHILDREN_H

#include <QObject>
#include <QtTest/QtTest>

class TestElementWithFloatingChildren:public QObject {
    Q_OBJECT

    public:
        TestElementWithFloatingChildren();

        ~TestElementWithFloatingChildren() override;
