...
* \file
*
* This header provides tests for the Ld::ElementWithFixedChildren class.  Also tests core functions of the
* Ld::Element class.
***********************************************************************************************************************/

#ifndef TEST_ELEMENT_WITH_FIXED_CHILDREN_H
#define TEST_ELEMENT_WITH_FIXED_CHILDREN_H

#include <QObject>
#include <QtTest/QtTest>

class TestElementWithFixedChildren:public QObject {
    Q_OBJECT

    public:
        TestElementWithFixedChildren();

        ~TestElementWithFixedChildren() override;
    ...
    private slots:
        ...
        void testNumberChildren();

        void testVisualTracking();

        void testCreatorFunctions();

        void testProgramWriteReadFunctions();
        ...
        void testSetChildCursorUpdates();
