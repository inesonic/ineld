...
* \file
*
* This file implements tests of \ref Ld::XmlFileExportContext class.
***********************************************************************************************************************/
...
TestXmlFileExportContext::TestXmlFileExportContext() {}
...
void
TestXmlFileExportContext::testConstructors() {
    Ld::XmlFileExportContext context("index.html", true);
...
void TestXmlFileExportContext::testXmlEngine() {
    // Basically tested by the testConstructors test.
}


void TestXmlFileExportContext::testPayloads() {
    Ld::XmlFileExportContext context("index.html", true);
    QVERIFY(context.payloads().contains("index.html"));
...
void TestXmlFileExportContext::testErrors() {}
