...
* \file
*
* This file implements the \ref Ld::CppFunctionPlaceholderTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppFunctionPlaceholderTranslator::~CppFunctionPlaceholderTranslator() {}


    QString CppFunctionPlaceholderTranslator::elementName() const {
        return FunctionPlaceholderElement::elementName;
    }


    bool CppFunctionPlaceholderTranslator::identifyDependenciesAndExplicitTypes(
