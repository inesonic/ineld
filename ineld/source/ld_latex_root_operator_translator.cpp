...
* \file
*
* This file implements the \ref Ld::LaTeXRootOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXRootOperatorTranslator::~LaTeXRootOperatorTranslator() {}


    QString LaTeXRootOperatorTranslator::elementName() const {
        return RootOperatorElement::elementName;
    }


    bool LaTeXRootOperatorTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
