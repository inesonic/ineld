...
* \file
*
* This file implements the \ref Ld::LaTeXIntegerTypeTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXIntegerTypeTranslator::~LaTeXIntegerTypeTranslator() {}


    QString LaTeXIntegerTypeTranslator::elementName() const {
        return IntegerTypeElement::elementName;
    }


    bool LaTeXIntegerTypeTranslator::body(ElementPointer, LaTeXCodeGenerationEngine& engine) {
