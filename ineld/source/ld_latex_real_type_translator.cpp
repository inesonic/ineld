...
* \file
*
* This file implements the \ref Ld::LaTeXRealTypeTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXRealTypeTranslator::~LaTeXRealTypeTranslator() {}


    QString LaTeXRealTypeTranslator::elementName() const {
        return RealTypeElement::elementName;
    }


    bool LaTeXRealTypeTranslator::body(ElementPointer, LaTeXCodeGenerationEngine& engine) {
