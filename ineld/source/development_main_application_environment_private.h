...
* \file
*
* This header defines the \ref DevelopmentMainApplicationEnvironmentPrivate class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef DEVELOPMENT_MAIN_APPLICATION_ENVIRONMENT_PRIVATE_H
#define DEVELOPMENT_MAIN_APPLICATION_ENVIRONMENT_PRIVATE_H
 ...
 * code development.
 */
class LD_PUBLIC_API DevelopmentMainApplicationEnvironmentPrivate:public DevelopmentEnvironmentPrivate {
    public:
        /**
         * Constructor
         *
         ...
         */
        DevelopmentMainApplicationEnvironmentPrivate(const QString& executableFilePath, bool useHeaderFiles);

        ~DevelopmentMainApplicationEnvironmentPrivate() override;
