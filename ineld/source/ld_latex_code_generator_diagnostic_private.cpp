...
* \file
*
* This file implements the \ref Ld::LaTeXCodeGeneratorDiagnostic::Private class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXCodeGeneratorDiagnostic::Private::Private(
    ...
    const LaTeXTranslationPhase& LaTeXCodeGeneratorDiagnostic::Private::translationPhase() const {
        return currentTranslationPhase;
    }


    LaTeXCodeGeneratorDiagnostic::Code LaTeXCodeGeneratorDiagnostic::Private::diagnosticCode() const {
        return currentDiagnosticCode;
    }


    QSharedPointer<TextExportContext> LaTeXCodeGeneratorDiagnostic::Private::context() const {
