...
* \file
*
* This file implements the \ref Ld::LaTeXMatrixCombineTopToBottomOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXMatrixCombineTopToBottomOperatorTranslator::~LaTeXMatrixCombineTopToBottomOperatorTranslator() {}


    QString LaTeXMatrixCombineTopToBottomOperatorTranslator::elementName() const {
        return MatrixCombineTopToBottomOperatorElement::elementName;
    }


    bool LaTeXMatrixCombineTopToBottomOperatorTranslator::body(
