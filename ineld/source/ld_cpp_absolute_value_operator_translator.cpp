...
* \file
*
* This file implements the \ref Ld::CppAbsoluteValueOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppAbsoluteValueOperatorTranslator::~CppAbsoluteValueOperatorTranslator() {}


    QString CppAbsoluteValueOperatorTranslator::elementName() const {
        return AbsoluteValueOperatorElement::elementName;
    }


    bool CppAbsoluteValueOperatorTranslator::threadImplementation(
    ...
    bool CppAbsoluteValueOperatorTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
