...
* \file
*
* This file implements the \ref Ld::LaTeXUnarySuperscriptOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXUnarySuperscriptOperatorTranslatorBase::~LaTeXUnarySuperscriptOperatorTranslatorBase() {}


    bool LaTeXUnarySuperscriptOperatorTranslatorBase::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
        ...
        context << tr("^{%1}").arg(latexOperator(element->format().dynamicCast<OperatorFormat>()));
