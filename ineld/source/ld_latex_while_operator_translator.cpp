...
* \file
*
* This file implements the \ref Ld::LaTeXWhileOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXWhileOperatorTranslator::~LaTeXWhileOperatorTranslator() {}


    QString LaTeXWhileOperatorTranslator::elementName() const {
        return WhileOperatorElement::elementName;
    }


    bool LaTeXWhileOperatorTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
