...
* \file
*
* This file implements the \ref Ld::AdditionOperatorElementBase class.
***********************************************************************************************************************/
...
namespace Ld {
    const DataType::ValueType AdditionOperatorElementBase::allowedConversions
    ...
    AdditionOperatorElementBase::AdditionOperatorElementBase() {}


    AdditionOperatorElementBase::~AdditionOperatorElementBase() {}


    DataType::ValueType AdditionOperatorElementBase::valueType() const {
    ...
    Element::Precedence AdditionOperatorElementBase::intrinsicPrecedence() const {
