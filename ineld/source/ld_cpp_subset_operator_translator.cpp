...
********************************************************************************************************************//**
* \file Ld::CppSubsetOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppSubsetOperatorTranslator::~CppSubsetOperatorTranslator() {}


    QString CppSubsetOperatorTranslator::elementName() const {
        return SubsetOperatorElement::elementName;
    }


    QString CppSubsetOperatorTranslator::cppFunction() const {
        return QString("M::isSubsetOf");
    }
}
