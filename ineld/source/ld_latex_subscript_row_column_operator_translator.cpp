...
* \file
*
* This file implements the \ref Ld::LaTeXSubscriptRowColumnOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXSubscriptRowColumnOperatorTranslator::~LaTeXSubscriptRowColumnOperatorTranslator() {}


    QString LaTeXSubscriptRowColumnOperatorTranslator::elementName() const {
        return SubscriptRowColumnOperatorElement::elementName;
    }


    bool LaTeXSubscriptRowColumnOperatorTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
