...
* \file
*
* This file implements the \ref Ld::HtmlListPlaceholderTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlListPlaceholderTranslator::~HtmlListPlaceholderTranslator() {}


    QString HtmlListPlaceholderTranslator::elementName() const {
        return Ld::ListPlaceholderElement::elementName;
    }
}
