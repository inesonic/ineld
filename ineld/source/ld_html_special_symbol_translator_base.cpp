...
* \file
*
* This file implements the \ref Ld::HtmlSpecialSymbolTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlSpecialSymbolTranslatorBase::~HtmlSpecialSymbolTranslatorBase() {}


    bool HtmlSpecialSymbolTranslatorBase::body(ElementPointer, HtmlCodeGenerationEngine& engine) {
        bool success;
        ...
        if (mathMode == HtmlCodeGenerationEngine::MathMode::MATHML         ||
            ...
            context.writeCharacters(latexOperator());
        }
