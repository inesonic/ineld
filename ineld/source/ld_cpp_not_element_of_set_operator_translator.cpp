...
********************************************************************************************************************//**
* \file Ld::CppNotElementOfSetOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppNotElementOfSetOperatorTranslator::~CppNotElementOfSetOperatorTranslator() {}


    QString CppNotElementOfSetOperatorTranslator::elementName() const {
        return NotElementOfSetOperatorElement::elementName;
    }


    bool CppNotElementOfSetOperatorTranslator::threadImplementation(
    ...
    bool CppNotElementOfSetOperatorTranslator::methodDefinitions(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
