...
* \file
*
* This file implements the \ref Ld::HtmlTupleTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlTupleTranslator::~HtmlTupleTranslator() {}


    QString HtmlTupleTranslator::elementName() const {
        return Ld::TupleElement::elementName;
    }


    bool HtmlTupleTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
