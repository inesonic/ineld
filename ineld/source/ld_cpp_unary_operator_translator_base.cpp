...
* \file
*
* This file implements the \ref Ld::CppUnaryOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    CppUnaryOperatorTranslatorBase::~CppUnaryOperatorTranslatorBase() {}


    bool CppUnaryOperatorTranslatorBase::threadImplementation(
    ...
    bool CppUnaryOperatorTranslatorBase::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
