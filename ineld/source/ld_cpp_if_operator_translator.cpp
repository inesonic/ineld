...
********************************************************************************************************************//**
* \file Ld::CppIfOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppIfOperatorTranslator::~CppIfOperatorTranslator() {}


    QString CppIfOperatorTranslator::elementName() const {
        return IfOperatorElement::elementName;
    }


    bool CppIfOperatorTranslator::threadImplementation(ElementPointer element, CppCodeGenerationEngine& engine) {
        bool success = true;
        ...
        if (!condition.isNull() && !operation.isNull()) {
            ...
            context(element) << "if (M::inlineToBoolean(";
    ...
    bool CppIfOperatorTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
        bool success;
