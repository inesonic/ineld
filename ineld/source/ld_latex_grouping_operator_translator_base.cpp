...
* \file
*
* This file implements the \ref Ld::LaTeXGroupingOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXGroupingOperatorTranslatorBase::~LaTeXGroupingOperatorTranslatorBase() {}


    bool LaTeXGroupingOperatorTranslatorBase::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
        ...
        context << "\\left " << leftParenthesis;
        engine.translateChild(child0);
        context << "\\right " << rightParenthesis;
