...
* \file
*
* This file implements the \ref Ld::CppThereforeOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppThereforeOperatorTranslator::~CppThereforeOperatorTranslator() {}


    QString CppThereforeOperatorTranslator::elementName() const {
        return ThereforeOperatorElement::elementName;
    }


    bool CppThereforeOperatorTranslator::threadImplementation(
    ...
    bool CppThereforeOperatorTranslator::methodDefinitions(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
