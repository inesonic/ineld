...
* \file
*
* This file implements the \ref Ld::HtmlWhileOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlWhileOperatorTranslator::~HtmlWhileOperatorTranslator() {}


    QString HtmlWhileOperatorTranslator::elementName() const {
        return Ld::WhileOperatorElement::elementName;
    }


    bool HtmlWhileOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;

        QSharedPointer<Ld::WhileOperatorElement> forAllElement = element.dynamicCast<Ld::WhileOperatorElement>();
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_MATHML: {
                ...
                context.writeCharacters(tr("while"));
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_LATEX: {
                context.writeCharacters(tr("{\\text{while }}"));
