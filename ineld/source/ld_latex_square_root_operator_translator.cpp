...
* \file
*
* This file implements the \ref Ld::LaTeXSquareRootOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXSquareRootOperatorTranslator::~LaTeXSquareRootOperatorTranslator() {}


    QString LaTeXSquareRootOperatorTranslator::elementName() const {
        return SquareRootOperatorElement::elementName;
    }


    bool LaTeXSquareRootOperatorTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
