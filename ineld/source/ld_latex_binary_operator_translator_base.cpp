...
* \file
*
* This file implements the \ref Ld::LaTeXBinaryOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXBinaryOperatorTranslatorBase::~LaTeXBinaryOperatorTranslatorBase() {}


    bool LaTeXBinaryOperatorTranslatorBase::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
