...
* \file
*
* This file implements the \ref Ld::HtmlUnaryOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlUnaryOperatorTranslatorBase::~HtmlUnaryOperatorTranslatorBase() {}


    bool HtmlUnaryOperatorTranslatorBase::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_MATHML: {
                ...
                QString mathOperator = mathMlOperator(element->format());
                if (!mathOperator.isEmpty()) {
                    context.writeStartElement("mo");
                    context.writeAttribute("stretchy", "false");
                    context.writeCharacters(mathOperator);
                    context.writeEndElement(); // mo
                }
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_LATEX: {
                ...
                context.writeCharacters(tr(" %1 ").arg(latexOperator(element->format())));
    ...
    bool HtmlUnaryOperatorTranslatorBase::shouldPrecede() const {
        return true;
    }
}
