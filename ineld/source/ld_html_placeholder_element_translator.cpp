...
* \file
*
* This file implements the \ref Ld::HtmlPlaceholderElementTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlPlaceholderElementTranslator::~HtmlPlaceholderElementTranslator() {}


    QString HtmlPlaceholderElementTranslator::elementName() const {
        return Ld::PlaceholderElement::elementName;
    }


    bool HtmlPlaceholderElementTranslator::body(ElementPointer, HtmlCodeGenerationEngine& engine) {
        bool success;
