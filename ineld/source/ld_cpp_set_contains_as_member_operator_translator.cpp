...
********************************************************************************************************************//**
* \file Ld::CppSetContainsAsMemberOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppSetContainsAsMemberOperatorTranslator::~CppSetContainsAsMemberOperatorTranslator() {}


    QString CppSetContainsAsMemberOperatorTranslator::elementName() const {
        return SetContainsAsMemberOperatorElement::elementName;
    }


    bool CppSetContainsAsMemberOperatorTranslator::threadImplementation(
    ...
    bool CppSetContainsAsMemberOperatorTranslator::methodDefinitions(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
