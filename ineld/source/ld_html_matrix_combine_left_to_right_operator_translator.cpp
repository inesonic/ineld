...
* \file
*
* This file implements the \ref Ld::HtmlMatrixCombineLeftToRightOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlMatrixCombineLeftToRightOperatorTranslator::~HtmlMatrixCombineLeftToRightOperatorTranslator() {}


    QString HtmlMatrixCombineLeftToRightOperatorTranslator::elementName() const {
        return Ld::MatrixCombineLeftToRightOperatorElement::elementName;
    }


    bool HtmlMatrixCombineLeftToRightOperatorTranslator::body(
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_LATEX: {
                ...
                context.writeCharacters("\\begin{array}{c|c} { ");
                engine.translateChild(child0);
                context.writeCharacters("} & {");
                engine.translateChild(child1);
