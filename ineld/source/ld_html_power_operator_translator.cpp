...
* \file
*
* This file implements the \ref Ld::HtmlPowerOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlPowerOperatorTranslator::~HtmlPowerOperatorTranslator() {}


    QString HtmlPowerOperatorTranslator::elementName() const {
        return Ld::PowerOperatorElement::elementName;
    }


    bool HtmlPowerOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
