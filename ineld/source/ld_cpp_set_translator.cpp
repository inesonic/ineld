...
* \file
*
* This file implements the \ref Ld::CppSetTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppSetTranslator::~CppSetTranslator() {}


    QString CppSetTranslator::elementName() const {
        return Ld::SetElement::elementName;
    }


    bool CppSetTranslator::threadImplementation(ElementPointer element, CppCodeGenerationEngine& engine) {
        CppContext& context = engine.context();

        context(element) << "M::Set::build(";
    ...
    bool CppSetTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
