...
* \file
*
* This file implements the \ref Ld::CppFloorOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppFloorOperatorTranslator::~CppFloorOperatorTranslator() {}


    QString CppFloorOperatorTranslator::elementName() const {
        return FloorOperatorElement::elementName;
    }


    bool CppFloorOperatorTranslator::threadImplementation(
    ...
    bool CppFloorOperatorTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
