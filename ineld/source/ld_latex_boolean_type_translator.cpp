...
* \file
*
* This file implements the \ref Ld::LaTeXBooleanTypeTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXBooleanTypeTranslator::~LaTeXBooleanTypeTranslator() {}


    QString LaTeXBooleanTypeTranslator::elementName() const {
        return BooleanTypeElement::elementName;
    }


    bool LaTeXBooleanTypeTranslator::body(ElementPointer, LaTeXCodeGenerationEngine& engine) {
