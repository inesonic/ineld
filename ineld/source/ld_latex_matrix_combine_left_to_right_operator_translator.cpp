...
* \file
*
* This file implements the \ref Ld::LaTeXMatrixCombineLeftToRightOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXMatrixCombineLeftToRightOperatorTranslator::~LaTeXMatrixCombineLeftToRightOperatorTranslator() {}


    QString LaTeXMatrixCombineLeftToRightOperatorTranslator::elementName() const {
        return MatrixCombineLeftToRightOperatorElement::elementName;
    }


    bool LaTeXMatrixCombineLeftToRightOperatorTranslator::body(
