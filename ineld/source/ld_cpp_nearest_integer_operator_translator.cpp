...
* \file
*
* This file implements the \ref Ld::CppNearestIntegerOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppNearestIntegerOperatorTranslator::~CppNearestIntegerOperatorTranslator() {}


    QString CppNearestIntegerOperatorTranslator::elementName() const {
        return NearestIntegerOperatorElement::elementName;
    }


    bool CppNearestIntegerOperatorTranslator::threadImplementation(
        ...
        ElementPointer child = element->child(0);
        if (!child.isNull()) {
            context(element) << "M::nint(";
    ...
    bool CppNearestIntegerOperatorTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
