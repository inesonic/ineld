...
* \file
*
* This file implements the \ref Ld::CppBinaryOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    CppBinaryOperatorTranslatorBase::~CppBinaryOperatorTranslatorBase() {}


    bool CppBinaryOperatorTranslatorBase::threadImplementation(
    ...
    bool CppBinaryOperatorTranslatorBase::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
