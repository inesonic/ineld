...
********************************************************************************************************************//**
* \file Ld::CppNotSetContainsAsMemberOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppNotSetContainsAsMemberOperatorTranslator::~CppNotSetContainsAsMemberOperatorTranslator() {}


    QString CppNotSetContainsAsMemberOperatorTranslator::elementName() const {
        return NotSetContainsAsMemberOperatorElement::elementName;
    }


    bool CppNotSetContainsAsMemberOperatorTranslator::threadImplementation(
        ...
        if (!parent.isNull()) {
            ...
            if (!root.isNull() && !child0.isNull() && !child1.isNull()) {
                context(element) << "M::isNotElementOfSet((";
    ...
    bool CppNotSetContainsAsMemberOperatorTranslator::methodDefinitions(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
