...
* \file
*
* This file implements the \ref Ld::LaTeXIfOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXIfOperatorTranslator::~LaTeXIfOperatorTranslator() {}


    QString LaTeXIfOperatorTranslator::elementName() const {
        return IfOperatorElement::elementName;
    }


    bool LaTeXIfOperatorTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
