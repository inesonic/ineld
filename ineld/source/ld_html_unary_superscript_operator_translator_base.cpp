...
* \file
*
* This file implements the \ref Ld::HtmlUnarySuperscriptOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlUnarySuperscriptOperatorTranslatorBase::~HtmlUnarySuperscriptOperatorTranslatorBase() {}


    bool HtmlUnarySuperscriptOperatorTranslatorBase::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
