...
* \file
*
* This file implements the \ref Ld::CppNullSetSpecialValueTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppNullSetSpecialValueTranslator::~CppNullSetSpecialValueTranslator() {}


    QString CppNullSetSpecialValueTranslator::elementName() const {
        return NullSetSpecialValueElement::elementName;
    }


    bool CppNullSetSpecialValueTranslator::threadImplementation(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
        CppContext& context = engine.context();
        context(element) << "M::nullSet";

        return true;
    }


    bool CppNullSetSpecialValueTranslator::methodDefinitions(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
