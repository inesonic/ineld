...
* \file
*
* This file implements the \ref Ld::LaTeXTrinaryOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXTrinaryOperatorTranslatorBase::~LaTeXTrinaryOperatorTranslatorBase() {}


    bool LaTeXTrinaryOperatorTranslatorBase::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
        ...
        bool success = buildOperator(element, engine);
    ...
    bool LaTeXTrinaryOperatorTranslatorBase::buildOperator(
