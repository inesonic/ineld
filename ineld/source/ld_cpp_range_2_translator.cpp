...
* \file
*
* This file implements the \ref Ld::CppRange2Translator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppRange2Translator::~CppRange2Translator() {}


    QString CppRange2Translator::elementName() const {
        return Ld::Range2Element::elementName;
    }


    bool CppRange2Translator::threadImplementation(ElementPointer element, CppCodeGenerationEngine& engine) {
    ...
    bool CppRange2Translator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
