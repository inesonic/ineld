...
* \file
*
* This file implements the \ref Ld::HtmlIfOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlIfOperatorTranslator::~HtmlIfOperatorTranslator() {}


    QString HtmlIfOperatorTranslator::elementName() const {
        return Ld::IfOperatorElement::elementName;
    }


    bool HtmlIfOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;

        QSharedPointer<Ld::IfOperatorElement> forAllElement = element.dynamicCast<Ld::IfOperatorElement>();
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_LATEX: {
                context.writeCharacters(tr("{\\text{if }}"));
