...
* \file
*
* This file implements the \ref Ld::LaTeXTopLevelOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXTopLevelOperatorTranslatorBase::~LaTeXTopLevelOperatorTranslatorBase() {}


    bool LaTeXTopLevelOperatorTranslatorBase::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
