...
* \file
*
* This file implements the \ref Ld::HtmlSquareRootOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlSquareRootOperatorTranslator::~HtmlSquareRootOperatorTranslator() {}


    QString HtmlSquareRootOperatorTranslator::elementName() const {
        return SquareRootOperatorElement::elementName;
    }


    bool HtmlSquareRootOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_MATHML: {
                ...
                context.writeStartElement("msqrt");
                engine.translateChild(child0);
                context.writeEndElement(); // msqrt
