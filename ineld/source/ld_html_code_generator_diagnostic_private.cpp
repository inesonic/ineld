...
* \file
*
* This file implements the \ref Ld::HtmlCodeGeneratorDiagnostic::Private class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlCodeGeneratorDiagnostic::Private::Private(
    ...
    const HtmlTranslationPhase& HtmlCodeGeneratorDiagnostic::Private::translationPhase() const {
        return currentTranslationPhase;
    }


    HtmlCodeGeneratorDiagnostic::Code HtmlCodeGeneratorDiagnostic::Private::diagnosticCode() const {
        return currentDiagnosticCode;
    }


    QSharedPointer<XmlExportContext> HtmlCodeGeneratorDiagnostic::Private::context() const {
