...
* \file
*
* This file implements the \ref Ld::CppLogicalTrueSpecialValueTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppLogicalTrueSpecialValueTranslator::~CppLogicalTrueSpecialValueTranslator() {}


    QString CppLogicalTrueSpecialValueTranslator::elementName() const {
        return LogicalTrueSpecialValueElement::elementName;
    }


    bool CppLogicalTrueSpecialValueTranslator::threadImplementation(
    ...
    bool CppLogicalTrueSpecialValueTranslator::methodDefinitions(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
