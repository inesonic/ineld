...
* \file
*
* This file implements the \ref Ld::CppGroupingOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    CppGroupingOperatorTranslatorBase::~CppGroupingOperatorTranslatorBase() {}


    bool CppGroupingOperatorTranslatorBase::threadImplementation(
    ...
    bool CppGroupingOperatorTranslatorBase::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
