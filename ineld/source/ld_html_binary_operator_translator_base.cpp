...
* \file
*
* This file implements the \ref Ld::HtmlBinaryOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlBinaryOperatorTranslatorBase::~HtmlBinaryOperatorTranslatorBase() {}


    bool HtmlBinaryOperatorTranslatorBase::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_MATHML: {
                ...
                if (!mathOperator.isEmpty()) {
                    ...
                    context.writeCharacters(mathMlOperator(element->format()));
                    context.writeEndElement(); // mo
                }
