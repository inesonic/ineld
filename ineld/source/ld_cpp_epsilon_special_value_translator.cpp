...
* \file
*
* This file implements the \ref Ld::CppEpsilonSpecialValueTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppEpsilonSpecialValueTranslator::~CppEpsilonSpecialValueTranslator() {}


    QString CppEpsilonSpecialValueTranslator::elementName() const {
        return EpsilonSpecialValueElement::elementName;
    }


    bool CppEpsilonSpecialValueTranslator::threadImplementation(
            ElementPointer           element,
            CppCodeGenerationEngine& engine
        ) {
        CppContext& context = engine.context();
        context(element) << "M::epsilon";

        return true;
    }


    bool CppEpsilonSpecialValueTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
