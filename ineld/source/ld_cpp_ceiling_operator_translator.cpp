...
* \file
*
* This file implements the \ref Ld::CppCeilingOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppCeilingOperatorTranslator::~CppCeilingOperatorTranslator() {}


    QString CppCeilingOperatorTranslator::elementName() const {
        return CeilingOperatorElement::elementName;
    }


    bool CppCeilingOperatorTranslator::threadImplementation(
    ...
    bool CppCeilingOperatorTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
