...
* \file
*
* This file implements the \ref Ld::HtmlMatrixCombineTopToBottomOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlMatrixCombineTopToBottomOperatorTranslator::~HtmlMatrixCombineTopToBottomOperatorTranslator() {}


    QString HtmlMatrixCombineTopToBottomOperatorTranslator::elementName() const {
        return Ld::MatrixCombineTopToBottomOperatorElement::elementName;
    }


    bool HtmlMatrixCombineTopToBottomOperatorTranslator::body(
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_LATEX: {
                ...
                context.writeCharacters("\\begin{array}{c}{ ");
                engine.translateChild(child0);
                context.writeCharacters(" } \\\\ \\hline { ");
                engine.translateChild(child1);
