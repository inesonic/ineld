...
* \file
*
* This file implements the \ref Ld::LaTeXBooleanDataTypeTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    const LaTeXBooleanDataTypeTranslator LaTeXBooleanDataTypeTranslator::instance;

    LaTeXBooleanDataTypeTranslator::LaTeXBooleanDataTypeTranslator() {}


    LaTeXBooleanDataTypeTranslator::~LaTeXBooleanDataTypeTranslator() {}


    QString LaTeXBooleanDataTypeTranslator::elementName() const {
        return BooleanTypeElement::elementName;
    }


    bool LaTeXBooleanDataTypeTranslator::toLaTeX(
        ...
        if (success) {
            ...
            context << Util::booleanToUnicodeString(value, booleanStyle);
        }
