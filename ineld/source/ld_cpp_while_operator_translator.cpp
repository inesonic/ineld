...
********************************************************************************************************************//**
* \file Ld::CppWhileOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    CppWhileOperatorTranslator::~CppWhileOperatorTranslator() {}


    QString CppWhileOperatorTranslator::elementName() const {
        return WhileOperatorElement::elementName;
    }


    bool CppWhileOperatorTranslator::threadImplementation(ElementPointer element, CppCodeGenerationEngine& engine) {
        bool success = true;
        ...
        if (!condition.isNull() && !operation.isNull()) {
            ...
            context(element) << "while (M::inlineToBoolean(";
    ...
    bool CppWhileOperatorTranslator::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
        bool success;
