...
* \file
*
* This file implements the \ref Ld::HtmlSubscriptIndexOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlSubscriptIndexOperatorTranslator::~HtmlSubscriptIndexOperatorTranslator() {}


    QString HtmlSubscriptIndexOperatorTranslator::elementName() const {
        return Ld::SubscriptIndexOperatorElement::elementName;
    }


    bool HtmlSubscriptIndexOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
