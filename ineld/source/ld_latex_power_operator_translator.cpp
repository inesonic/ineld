...
* \file
*
* This file implements the \ref Ld::LaTeXPowerOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXPowerOperatorTranslator::~LaTeXPowerOperatorTranslator() {}


    QString LaTeXPowerOperatorTranslator::elementName() const {
        return PowerOperatorElement::elementName;
    }


    bool LaTeXPowerOperatorTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
