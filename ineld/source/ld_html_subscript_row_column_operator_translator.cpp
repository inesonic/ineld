...
* \file
*
* This file implements the \ref Ld::HtmlSubscriptRowColumnOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlSubscriptRowColumnOperatorTranslator::~HtmlSubscriptRowColumnOperatorTranslator() {}


    QString HtmlSubscriptRowColumnOperatorTranslator::elementName() const {
        return Ld::SubscriptRowColumnOperatorElement::elementName;
    }


    bool HtmlSubscriptRowColumnOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
