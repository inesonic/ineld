...
* \file
*
* This file implements the \ref Ld::HtmlElseOperatorTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    HtmlElseOperatorTranslator::~HtmlElseOperatorTranslator() {}


    QString HtmlElseOperatorTranslator::elementName() const {
        return Ld::ElseOperatorElement::elementName;
    }


    bool HtmlElseOperatorTranslator::body(ElementPointer element, HtmlCodeGenerationEngine& engine) {
        bool                               result;
        ...
        switch (mathMode) {
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_MATHML: {
                ...
                context.writeCharacters(tr("else:"));
            ...
            case HtmlCodeGenerationEngine::MathMode::MATHJAX_LATEX: {
                context.writeCharacters(tr("{\\text{else: }}"));
                engine.translateChild(operation);
