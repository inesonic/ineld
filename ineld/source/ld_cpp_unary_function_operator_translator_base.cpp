...
* \file
*
* This file implements the \ref Ld::CppUnaryFunctionOperatorTranslatorBase class.
***********************************************************************************************************************/
...
namespace Ld {
    CppUnaryFunctionOperatorTranslatorBase::~CppUnaryFunctionOperatorTranslatorBase() {}


    bool CppUnaryFunctionOperatorTranslatorBase::threadImplementation(
    ...
    bool CppUnaryFunctionOperatorTranslatorBase::methodDefinitions(ElementPointer element, CppCodeGenerationEngine& engine) {
