...
* \file
*
* This header defines the \ref DevelopmentTestEnvironmentPrivate class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef DEVELOPMENT_TEST_ENVIRONMENT_PRIVATE_H
#define DEVELOPMENT_TEST_ENVIRONMENT_PRIVATE_H
 ...
 * code development.
 */
class LD_PUBLIC_API DevelopmentTestEnvironmentPrivate:public DevelopmentEnvironmentPrivate {
    public:
        /**
         * Constructor
         *
         ...
         */
        DevelopmentTestEnvironmentPrivate(const QString& executableFilePath, bool useHeaderFiles);

        ~DevelopmentTestEnvironmentPrivate() override;
        ...
        /**
         * Method you can call to get the application root directory.
         *
