...
* \file
*
* This file implements the \ref Ld::LaTeXDataTypeTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXDataTypeTranslator::LaTeXDataTypeTranslator() {}


    LaTeXDataTypeTranslator::~LaTeXDataTypeTranslator() {}


    bool LaTeXDataTypeTranslator::generateDefaultLaTeX(
