...
* \file
*
* This file implements the \ref Ld::LaTeXComplexTypeTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXComplexTypeTranslator::~LaTeXComplexTypeTranslator() {}


    QString LaTeXComplexTypeTranslator::elementName() const {
        return ComplexTypeElement::elementName;
    }


    bool LaTeXComplexTypeTranslator::body(ElementPointer, LaTeXCodeGenerationEngine& engine) {
