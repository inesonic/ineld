...
* \file
*
* This file implements the \ref Ld::LaTeXSetTranslator class.
***********************************************************************************************************************/
...
namespace Ld {
    LaTeXSetTranslator::~LaTeXSetTranslator() {}


    QString LaTeXSetTranslator::elementName() const {
        return SetElement::elementName;
    }


    bool LaTeXSetTranslator::body(ElementPointer element, LaTeXCodeGenerationEngine& engine) {
