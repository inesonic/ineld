...
* \file
*
* This header defines the \ref Ld::AdditionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ADDITION_OPERATOR_ELEMENT_H
#define LD_ADDITION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class AdditionOperatorVisual;

    /**
     * Element that supports an addition operation.
     */
    class LD_PUBLIC_API AdditionOperatorElement:public AdditionOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::AdditionOperatorElement)
        ...
        public:
            ...
            AdditionOperatorElement();

            ~AdditionOperatorElement() override;
             ...
             * \ref AdditionOperatorElement instance.
             *
             * If the newly added \ref AdditionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref AdditionOperatorVisual instance and \ref AdditionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(AdditionOperatorVisual* newVisual);
             ...
             */
            AdditionOperatorVisual* visual() const;
    };
};
