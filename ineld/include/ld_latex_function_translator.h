...
* \file
*
* This header defines the \ref Ld::LaTeXFunctionTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_FUNCTION_TRANSLATOR_H
#define LD_LATEX_FUNCTION_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::FunctionElement.
     */
    class LD_PUBLIC_API LaTeXFunctionTranslator:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXFunctionTranslator)

        public:
            ~LaTeXFunctionTranslator() override;
        ...
        private:
            /**
             * Method you can use to determine if parenthesis are required.
             *
             * \param[in] format The format associated with this function.
             *
             * \return Returns the type of parenthesis to be included.
             */
            static OperatorFormat::ParenthesisStyle parenthesisStyle(QSharedPointer<OperatorFormat> format);
    };
};
