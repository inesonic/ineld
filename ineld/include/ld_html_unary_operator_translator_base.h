...
* \file
*
* This header defines the \ref Ld::HtmlUnaryOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_UNARY_OPERATOR_TRANSLATOR_BASE_H
#define LD_HTML_UNARY_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for HTML translators used to render unary operators.
     */
    class LD_PUBLIC_API HtmlUnaryOperatorTranslatorBase:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlUnaryOperatorTranslatorBase)

        public:
            ~HtmlUnaryOperatorTranslatorBase() override;
