...
* \file
*
* This header defines the \ref Ld::CppFunctionTranslationEngine class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_FUNCTION_TRANSLATION_ENGINE_H
#define LD_CPP_FUNCTION_TRANSLATION_ENGINE_H
...
namespace Ld {
    ...
    /**
     * Virtual base class for C++ function translators.  You can use this class as a common base class for C++
     * function translators used to translate function calls into C++.
     *
     * Derived classes are expected to be defined as static const instances so all methods are defined as static.
     */
    class LD_PUBLIC_API CppFunctionTranslationEngine:public FunctionTranslationEngine {
        public:
            /**
             * Static translation engine instance.
             */
            static const CppFunctionTranslationEngine instance;

            CppFunctionTranslationEngine();

            ~CppFunctionTranslationEngine() override;
        ...
        protected:
            /**
             * Method you can call from derived classes to call children to identify dependencies and explicit types
             * of child elements.
             *
             * \param[in]     functionData     The function data defining the standard function.
             *
             ...
             *         true.
             */
            static bool identifyChildDependenciesAndExplicitTypes(
                const FunctionData&             functionData,
                QSharedPointer<FunctionElement> element,
                CppCodeGenerationEngine&        generationEngine
            );
