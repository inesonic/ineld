...
* \file
*
* This header defines the \ref Ld::HtmlLogicalFalseSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LOGICAL_FALSE_SPECIAL_VALUE_TRANSLATOR_H
#define LD_HTML_LOGICAL_FALSE_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LogicalFalseSpecialValueElement class.
     */
    class LD_PUBLIC_API HtmlLogicalFalseSpecialValueTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLogicalFalseSpecialValueTranslator)

        public:
            ~HtmlLogicalFalseSpecialValueTranslator() override;
