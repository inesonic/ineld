...
* \file
*
* This header defines the \ref Ld::NotEqualToOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_EQUAL_TO_OPERATOR_ELEMENT_H
#define LD_NOT_EQUAL_TO_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotEqualToOperatorVisual;

    /**
     * Element that provides the not-equal-to binary operator.
     */
    class LD_PUBLIC_API NotEqualToOperatorElement:public BinaryRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotEqualToOperatorElement)
        ...
        public:
            ...
            NotEqualToOperatorElement();

            ~NotEqualToOperatorElement() override;
             ...
             * \ref NotEqualToOperatorElement instance.
             *
             * If the newly added \ref NotEqualToOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotEqualToOperatorVisual instance and \ref NotEqualToOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotEqualToOperatorVisual* newVisual);
             ...
             */
            NotEqualToOperatorVisual* visual() const;
    };
};
