...
* \file
*
* This header defines the \ref Ld::LaTeXRealDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_REAL_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_REAL_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * Class that translates real values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXRealDataTypeTranslator:public LaTeXDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const LaTeXRealDataTypeTranslator instance;

            LaTeXRealDataTypeTranslator();

            ~LaTeXRealDataTypeTranslator() override;
