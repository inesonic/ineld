...
* \file
*
* This header defines the \ref Ld::HtmlEulersNumberSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_EULERS_NUMBER_SPECIAL_VALUE_TRANSLATOR_H
#define LD_HTML_EULERS_NUMBER_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::EulersNumberSpecialValueElement class.
     */
    class LD_PUBLIC_API HtmlEulersNumberSpecialValueTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlEulersNumberSpecialValueTranslator)

        public:
            ~HtmlEulersNumberSpecialValueTranslator() override;
