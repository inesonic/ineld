...
* \file
*
* This header defines the \ref Ld::LaTeXSubscriptIndexOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SUBSCRIPT_INDEX_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SUBSCRIPT_INDEX_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SubscriptIndexOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSubscriptIndexOperatorTranslator:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSubscriptIndexOperatorTranslator)

        public:
            ~LaTeXSubscriptIndexOperatorTranslator() override;
