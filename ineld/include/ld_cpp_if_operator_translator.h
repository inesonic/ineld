...
* \file
*
* This header defines the \ref Ld::CppIfOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_IF_OPERATOR_TRANSLATOR_H
#define LD_CPP_IF_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::IfOperatorElement class.
     */
    class LD_PUBLIC_API CppIfOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppIfOperatorTranslator)

        public:
            ~CppIfOperatorTranslator() override;
