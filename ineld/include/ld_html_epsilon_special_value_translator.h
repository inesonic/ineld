...
* \file
*
* This header defines the \ref Ld::HtmlEpsilonSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_EPSILON_SPECIAL_VALUE_TRANSLATOR_H
#define LD_HTML_EPSILON_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::EpsilonSpecialValueElement class.
     */
    class LD_PUBLIC_API HtmlEpsilonSpecialValueTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlEpsilonSpecialValueTranslator)

        public:
            ~HtmlEpsilonSpecialValueTranslator() override;
