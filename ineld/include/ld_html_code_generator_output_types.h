...
* \file
*
* This header defines the \ref Ld::HtmlOutputType class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_CODE_GENERATOR_OUTPUT_TYPES_H
#define LD_HTML_CODE_GENERATOR_OUTPUT_TYPES_H
...
namespace Ld {
    ...
    /**
     * Class that indicates HTML output from a code generator.
     */
    class LD_PUBLIC_API HtmlOutputType:public CodeGeneratorOutputTypeBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlOutputType)
