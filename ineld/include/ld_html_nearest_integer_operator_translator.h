...
* \file
*
* This header defines the \ref Ld::HtmlNearestIntegerOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NEAREST_INTEGER_OPERATOR_TRANSLATOR_H
#define LD_HTML_NEAREST_INTEGER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NearestIntegerOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNearestIntegerOperatorTranslator:public HtmlGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNearestIntegerOperatorTranslator)

        public:
            ~HtmlNearestIntegerOperatorTranslator() override;
