...
* \file
*
* This header defines the \ref Ld::CppFunctionTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_FUNCTION_TRANSLATOR_H
#define LD_CPP_FUNCTION_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for sets.
     */
    class LD_PUBLIC_API CppFunctionTranslator:public CppTranslator {
        public:
            ~CppFunctionTranslator() override;
