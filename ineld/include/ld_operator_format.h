...
* \file
*
* This header defines the \ref Ld::OperatorFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_OPERATOR_FORMAT_H
#define LD_OPERATOR_FORMAT_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API OperatorFormat:public virtual ParenthesisFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::OperatorFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual ParenthesisFormat::Aggregation {
                public:
                    Aggregation();
                    ...
                    /**
                     * Method you can use to obtain a set of all the force parenthesis values across the aggregation.
                     *
                     * \return Returns a boolean aggregation indicating the force parenthesis values reported across
                     *         the aggregation.
                     */
                    const BooleanAggregation& forceParenthesis() const;

                private:
                    /**
                     * Set of force parenthesis states.
                     */
                    BooleanAggregation currentForceParenthesisValues;
            };
             ...
             */
            OperatorFormat(const OperatorFormat& other);

            ~OperatorFormat() override;
             ...
             *
             * \return Returns the format identifying name, in this case, "OperatorFormat".
             */
            QString typeName() const override;
             ...
             *         does not support the default parenthesis style.  This version returns false.
             */
            bool supportsDefaultParenthesisStyle() const override;

            /**
             * Method you can use to force parenthesis to be shown.  This setting should also change the precedence of
             * the operator accordingly.
             *
             * \param[in] nowForced If true, parenthesis will be forced visible.  If false, parenthesis will be shown
             *                      based on operator precedence.
             */
            void setForcedParenthesis(bool nowForced = true);

            /**
             * Method you can use to determine if parenthesis are currently forced.
             *
             * \return Returns true if parenthesis are being forced.  Returns false if parenthesis are currently not
             *         forced.
             */
            bool forcedParenthesis() const;
        ...
        private:
            /**
             * Flag indicating if parenthesis are currently forced.
             */
            bool currentForceParenthesis;
    };
};
