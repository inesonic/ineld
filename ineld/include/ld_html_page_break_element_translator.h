...
* \file
*
* This header defines the \ref Ld::HtmlPageBreakElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_PAGE_BREAK_ELEMENT_TRANSLATOR_H
#define LD_HTML_PAGE_BREAK_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::PageBreakElement class.
     */
    class LD_PUBLIC_API HtmlPageBreakElementTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlPageBreakElementTranslator)

        public:
            ~HtmlPageBreakElementTranslator() override;
