...
* \file
*
* This header defines the \ref Ld::LaTeXUnaryPlusOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_UNARY_PLUS_OPERATOR_TRANSLATOR_H
#define LD_LATEX_UNARY_PLUS_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::UnaryPlusOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXUnaryPlusOperatorTranslator:public LaTeXUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXUnaryPlusOperatorTranslator)

        public:
            ~LaTeXUnaryPlusOperatorTranslator() override;
