...
* \file
*
* This file defines the \ref Ld::HtmlLogicalBiconditionalOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LOGICAL_BICONDITIONAL_OPERATOR_TRANSLATOR_H
#define LD_HTML_LOGICAL_BICONDITIONAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LogicalBiconditionalOperatorElement class.
     */
    class LD_PUBLIC_API HtmlLogicalBiconditionalOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLogicalBiconditionalOperatorTranslator)

        public:
            ~HtmlLogicalBiconditionalOperatorTranslator() override;
