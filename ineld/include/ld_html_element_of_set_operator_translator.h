...
* \file
*
* This header defines the \ref Ld::HtmlElementOfSetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
#define LD_HTML_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ElementOfSetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlElementOfSetOperatorTranslator:public HtmlTopLevelOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlElementOfSetOperatorTranslator)

        public:
            ~HtmlElementOfSetOperatorTranslator() override;
