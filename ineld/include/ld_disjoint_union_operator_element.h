...
* \file
*
* This header defines the \ref Ld::DisjointUnionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_DISJOINT_UNION_OPERATOR_ELEMENT_H
#define LD_DISJOINT_UNION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class DisjointUnionOperatorVisual;

    /**
     * Element that provides support for calculating disjoint unions.
     */
    class LD_PUBLIC_API DisjointUnionOperatorElement:public BinarySetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::DisjointUnionOperatorElement)
        ...
        public:
            ...
            DisjointUnionOperatorElement();

            ~DisjointUnionOperatorElement() override;
             ...
             * \ref DisjointUnionOperatorElement instance.
             *
             * If the newly added \ref DisjointUnionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref DisjointUnionOperatorVisual instance and \ref DisjointUnionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(DisjointUnionOperatorVisual* newVisual);
             ...
             */
            DisjointUnionOperatorVisual* visual() const;
