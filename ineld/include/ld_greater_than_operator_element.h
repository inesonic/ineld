...
* \file
*
* This header defines the \ref Ld::GreaterThanOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_GREATER_THAN_OPERATOR_ELEMENT_H
#define LD_GREATER_THAN_OPERATOR_ELEMENT_H
...
namespace Ld {
    class GreaterThanOperatorVisual;

    /**
     * Element that provides support for the greater than relational operator.
     */
    class LD_PUBLIC_API GreaterThanOperatorElement:public BinaryScalarRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::GreaterThanOperatorElement)
        ...
        public:
            ...
            GreaterThanOperatorElement();

            ~GreaterThanOperatorElement() override;
             ...
             * \ref GreaterThanOperatorElement instance.
             *
             * If the newly added \ref GreaterThanOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref GreaterThanOperatorVisual instance and \ref GreaterThanOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(GreaterThanOperatorVisual* newVisual);
             ...
             */
            GreaterThanOperatorVisual* visual() const;
    };
};
