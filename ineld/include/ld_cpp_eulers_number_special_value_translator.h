...
* \file
*
* This header defines the \ref Ld::CppEulersNumberSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_EULERS_NUMBER_SPECIAL_VALUE_TRANSLATOR_H
#define LD_CPP_EULERS_NUMBER_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::EulersNumberSpecialValueElement class.
     */
    class LD_PUBLIC_API CppEulersNumberSpecialValueTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppEulersNumberSpecialValueTranslator)

        public:
            ~CppEulersNumberSpecialValueTranslator() override;
