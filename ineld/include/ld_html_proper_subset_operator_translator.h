...
* \file
*
* This file defines the \ref Ld::HtmlProperSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_PROPER_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_PROPER_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ProperSubsetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlProperSubsetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlProperSubsetOperatorTranslator)

        public:
            ~HtmlProperSubsetOperatorTranslator() override;
