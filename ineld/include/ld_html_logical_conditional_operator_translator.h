...
* \file
*
* This file defines the \ref Ld::HtmlLogicalConditionalOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LOGICAL_CONDITIONAL_OPERATOR_TRANSLATOR_H
#define LD_HTML_LOGICAL_CONDITIONAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LogicalConditionalOperatorElement class.
     */
    class LD_PUBLIC_API HtmlLogicalConditionalOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLogicalConditionalOperatorTranslator)

        public:
            ~HtmlLogicalConditionalOperatorTranslator() override;
