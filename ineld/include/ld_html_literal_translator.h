...
* \file
*
* This header defines the \ref Ld::HtmlLiteralTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LITERAL_TRANSLATOR_H
#define LD_HTML_LITERAL_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LiteralElement class.
     */
    class LD_PUBLIC_API HtmlLiteralTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLiteralTranslator)

        public:
            ~HtmlLiteralTranslator() override;
