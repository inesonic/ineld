...
* \file
*
* This header defines the \ref Ld::HtmlIntegerDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_INTEGER_DATA_TYPE_TRANSLATOR_H
#define LD_HTML_INTEGER_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML data type translator for integer values.
     */
    class LD_PUBLIC_API HtmlIntegerDataTypeTranslator:public HtmlDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const HtmlIntegerDataTypeTranslator instance;

            HtmlIntegerDataTypeTranslator();

            ~HtmlIntegerDataTypeTranslator() override;
