...
* \file
*
* This header defines the \ref Ld::LaTeXLogicalFalseSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_LOGICAL_FALSE_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_LOGICAL_FALSE_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the LogicalFalseSpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXLogicalFalseSpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXLogicalFalseSpecialValueTranslator)

        public:
            virtual ~LaTeXLogicalFalseSpecialValueTranslator();
