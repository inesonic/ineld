...
* \file
*
* This file defines the \ref Ld::HtmlCartesianProductOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_CARTESIAN_PRODUCT_OPERATOR_TRANSLATOR_H
#define LD_HTML_CARTESIAN_PRODUCT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::CartesianProductOperatorElement class.
     */
    class LD_PUBLIC_API HtmlCartesianProductOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlCartesianProductOperatorTranslator)

        public:
            ~HtmlCartesianProductOperatorTranslator() override;
