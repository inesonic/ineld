...
* \file
*
* This header defines the \ref Ld::LessThanOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LESS_THAN_OPERATOR_ELEMENT_H
#define LD_LESS_THAN_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LessThanOperatorVisual;

    /**
     * Element that provides support for the less-than operation.
     */
    class LD_PUBLIC_API LessThanOperatorElement:public BinaryScalarRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LessThanOperatorElement)
        ...
        public:
            ...
            LessThanOperatorElement();

            ~LessThanOperatorElement() override;
             ...
             * \ref LessThanOperatorElement instance.
             *
             * If the newly added \ref LessThanOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LessThanOperatorVisual instance and \ref LessThanOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LessThanOperatorVisual* newVisual);
             ...
             */
            LessThanOperatorVisual* visual() const;
    };
};
