...
* \file
*
* This header defines the \ref Ld::HtmlFloorOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_FLOOR_OPERATOR_TRANSLATOR_H
#define LD_HTML_FLOOR_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::FloorOperatorElement class.
     */
    class LD_PUBLIC_API HtmlFloorOperatorTranslator:public HtmlGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlFloorOperatorTranslator)

        public:
            ~HtmlFloorOperatorTranslator() override;
