...
* \file
*
* This header defines the \ref Ld::ListDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LIST_DATA_TYPE_FORMAT_H
#define LD_LIST_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides format information to render list (set and tuple) data type values.
     */
    class LD_PUBLIC_API ListDataTypeFormat:public virtual DataTypeFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ListDataTypeFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual DataTypeFormat::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to obtain the requested number of leading displayed members.
                     *
                     * \return Returns a set of the counts of requested leading displayed members.
                     */
                    const QSet<unsigned long>& leadingMemberCounts() const;

                    /**
                     * Method you can use to obtain the requested number of trailing displayed members.
                     *
                     * \return Returns a set of the counts of requested trailing displayed members.
                     */
                    const QSet<unsigned long>& trailingMemberCounts() const;

                    /**
                     * Method you can use to determine if hidden member count is displayed.
                     *
                     * \return Returns whether hidden member counts will be shown.
                     */
                    const BooleanAggregation& showHiddenMemberCounts() const;

                private:
                    /**
                     * Set of displayed leading member counts.
                     */
                    QSet<unsigned long> currentLeadingMemberCounts;

                    /**
                     * Set of displayed trailing member counts.
                     */
                    QSet<unsigned long> currentTrailingMemberCounts;

                    /**
                     * Flag indicating whether unshown members counts should be displayed.
                     */
                    BooleanAggregation currentShowHiddenMemberCounts;
            };
            ...
            /**
             * The default unknown member count display setting.
             */
            static const bool defaultShowHiddenMemberCount;
             ...
             */
            ListDataTypeFormat(const ListDataTypeFormat& other);

            ~ListDataTypeFormat() override;
            ...
            /**
             * Method you can use to set the leading member count for the list.
             *
             * \param[in] newLeadingMemberCount The new count of leading members to be displayed.
             */
            void setLeadingMemberCount(unsigned long newLeadingMemberCount);

            /**
             * Method you can use to obtain the current leading member count for the list.
             *
             * \return Returns the current leading member count for the list.
             */
            unsigned long leadingMemberCount() const;

            /**
             * Method you can use to set the trailing member count for the list.
             *
             * \param[in] newTrailingMemberCount The new count of trailing members to be displayed.
             */
            void setTrailingMemberCount(unsigned long newTrailingMemberCount);

            /**
             * Method you can use to obtain the current trailing member count for the list.
             *
             * \return Returns the current trailing member count for the list.
             */
            unsigned long trailingMemberCount() const;

            /**
             * Method you can use to indicate whether the hidden member count should be displayed.
             *
             * \param[in] nowDisplayed If true, the hidden member count will be displayed.  If false, the hidden
             *                         member count will not be displayed.
             */
            void setHiddenMemberCountVisible(bool nowDisplayed = true);

            /**
             * Method you can use to indicate whether the hidden member count should be hidden.
             *
             * \param[in] nowHidden If true, the hidden member count will not be displayed.  If false, the hidden
             *                      member count will be displayed.
             */
            void setHiddenMemberCountHidden(bool nowHidden = true);

            /**
             * Method you can use to determine if the hidden member count should be displayed.
             *
             * \return Returns true if the hidden member count should be displayed.  Returns false if the hidden member
             *         count should not be displayed.
             */
            bool displayHiddenMemberCount() const;

            /**
             * Method you can use to determine if the hidden member count should not be displayed.
             *
             * \return Returns true if the hidden member count should not be displayed.  Returns false if the hidden
             *         member count should not be displayed.
             */
        ...
        private:
            /**
             * The current leading member count.
             */
            unsigned long currentLeadingMemberCount;

            /**
             * The current trailing member count.
             */
            unsigned long currentTrailingMemberCount;

            /**
             * Flag indicating whether unshown the members count should be displayed.
             */
            bool currentShowHiddenMemberCount;
    };
}
