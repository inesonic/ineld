...
* \file
*
* This file defines the \ref Ld::HtmlElseOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ELSE_OPERATOR_TRANSLATOR_H
#define LD_HTML_ELSE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ElseOperatorElement class.
     */
    class LD_PUBLIC_API HtmlElseOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlElseOperatorTranslator)

        public:
            ~HtmlElseOperatorTranslator() override;
