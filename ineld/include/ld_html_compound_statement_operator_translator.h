...
* \file
*
* This file defines the \ref Ld::HtmlCompoundStatementOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_COMPOUND_STATEMENT_OPERATOR_TRANSLATOR_H
#define LD_HTML_COMPOUND_STATEMENT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::CompoundStatementOperatorElement class.
     */
    class LD_PUBLIC_API HtmlCompoundStatementOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlCompoundStatementOperatorTranslator)

        public:
            ~HtmlCompoundStatementOperatorTranslator() override;
