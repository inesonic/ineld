...
* \file
*
* This header defines the \ref Ld::LaTeXNotSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_NOT_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_LATEX_NOT_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::NotSubsetOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXNotSubsetOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXNotSubsetOperatorTranslator)

        public:
            ~LaTeXNotSubsetOperatorTranslator() override;
