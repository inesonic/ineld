...
* \file
*
* This header defines the \ref Ld::UnaryMinusOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNARY_MINUS_OPERATOR_ELEMENT_H
#define LD_UNARY_MINUS_OPERATOR_ELEMENT_H
...
namespace Ld {
    class UnaryMinusOperatorVisual;

    /**
     * Element that provides support for a unary minus operation.
     */
    class LD_PUBLIC_API UnaryMinusOperatorElement:public UnaryNumericAndMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::UnaryMinusOperatorElement)
        ...
        public:
            ...
            UnaryMinusOperatorElement();

            ~UnaryMinusOperatorElement() override;
             ...
             * \ref Ld::UnaryMinusOperatorElement instance.
             *
             * If the newly added \ref UnaryMinusOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref UnaryMinusOperatorVisual instance and \ref UnaryMinusOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(UnaryMinusOperatorVisual* newVisual);
             ...
             */
            UnaryMinusOperatorVisual* visual() const;
