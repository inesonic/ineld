...
* \file
*
* This header defines the \ref Ld::ParagraphFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PARAGRAPH_FORMAT_H
#define LD_PARAGRAPH_FORMAT_H
...
namespace Ld {
    /**
     * Class that extends the \ref Ld::TextBlockFormat class to configure it for paragraph formatting.  You can use
     * this class as the format for simple paragraphs.
     */
    class LD_PUBLIC_API ParagraphFormat:public virtual TextBlockFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ParagraphFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual TextBlockFormat::Aggregation {
                public:
                    Aggregation();
             ...
             */
            ParagraphFormat(const ParagraphFormat& other);

            ~ParagraphFormat() override;
