...
#ifndef LD_CPP_PLOT_TRANSLATOR_H
#define LD_CPP_PLOT_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for the plot element.
     */
    class LD_PUBLIC_API CppPlotTranslator:public CppTranslator {
        public:
            ~CppPlotTranslator() override;
