...
#ifndef LD_HTML_TRANSLATION_PHASE_H
#define LD_HTML_TRANSLATION_PHASE_H
...
namespace Ld {
    /**
     * Class that manages HTML code translation phases.
     */
    class LD_PUBLIC_API HtmlTranslationPhase:public TranslationPhase {
        public:
            /**
            ...
            enum class Phase:unsigned {
                /**
                 * Phase used to insert the DTD header.
                 */
                DTD = 0,

                /**
                 * Phase used to register formats.
                 */
                REGISTER_FORMATS = 1,

                /**
                 * Phase used to insert the header.
                 */
                HEADER = 2,

                /**
                 * Phase that inserts the HTML body.
                 */
                BODY = 3
            };

            ~HtmlTranslationPhase() override;
