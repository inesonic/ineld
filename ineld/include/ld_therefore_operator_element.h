...
* \file
*
* This header defines the \ref Ld::ThereforeOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_THEREFORE_OPERATOR_ELEMENT_H
#define LD_THEREFORE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ThereforeOperatorVisual;

    /**
     * Element that provides support for the "therefore" operator.  This operator can be used to specify the value of
     * and terminate a compound statement.
     */
    class LD_PUBLIC_API ThereforeOperatorElement:public UnaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ThereforeOperatorElement)
        ...
        public:
            ...
            ThereforeOperatorElement();

            ~ThereforeOperatorElement() override;
             ...
             * \ref Ld::ThereforeOperatorElement instance.
             *
             * If the newly added \ref ThereforeOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ThereforeOperatorVisual instance and \ref ThereforeOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ThereforeOperatorVisual* newVisual);
             ...
             */
            ThereforeOperatorVisual* visual() const;
    };
};
