...
* \file
*
* This header defines the \ref Ld::MatrixIntegerDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_INTEGER_DATA_TYPE_FORMAT_H
#define LD_MATRIX_INTEGER_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides format information to render integer matrices.
     */
    class LD_PUBLIC_API MatrixIntegerDataTypeFormat:public virtual MatrixDataTypeFormat,
                                                    public virtual IntegerDataTypeFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::MatrixIntegerDataTypeFormat instances.
             */
             ...
             */
            MatrixIntegerDataTypeFormat(const MatrixIntegerDataTypeFormat& other);

            ~MatrixIntegerDataTypeFormat() override;
