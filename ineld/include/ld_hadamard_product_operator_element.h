...
* \file
*
* This header defines the \ref Ld::HadamardProductOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HADAMARD_PRODUCT_OPERATOR_ELEMENT_H
#define LD_HADAMARD_PRODUCT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class HadamardProductOperatorVisual;

    /**
     * Element that provides support for the Hadamard product operator.
     */
    class LD_PUBLIC_API HadamardProductOperatorElement:public BinaryMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HadamardProductOperatorElement)
        ...
        public:
            ...
            HadamardProductOperatorElement();

            ~HadamardProductOperatorElement() override;
             ...
             * \ref HadamardProductOperatorElement instance.
             *
             * If the newly added \ref HadamardProductOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref HadamardProductOperatorVisual instance and \ref HadamardProductOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(HadamardProductOperatorVisual* newVisual);
             ...
             */
            HadamardProductOperatorVisual* visual() const;
