...
* \file
*
* This header defines the \ref Ld::Range3Visual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_RANGE_3_VISUAL_H
#define LD_RANGE_3_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::Range3Element instance.
     */
    class LD_PUBLIC_API Range3Visual:public virtual VisualWithFixedChildren {
        public:
            Range3Visual();

            ~Range3Visual() override;

            /**
             * Method you can use to obtain the \ref Range3Element class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref Range3Element instance.
             */
            QSharedPointer<Range3Element> element() const;
