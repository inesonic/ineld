...
* \file
*
* This header defines the \ref Ld::LogicalConditionalOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_CONDITIONAL_OPERATOR_ELEMENT_H
#define LD_LOGICAL_CONDITIONAL_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalConditionalOperatorVisual;

    /**
     * Element that support for the logical conditional operator.
     */
    class LD_PUBLIC_API LogicalConditionalOperatorElement:public BinaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalConditionalOperatorElement)
        ...
        public:
            ...
            LogicalConditionalOperatorElement();

            ~LogicalConditionalOperatorElement() override;
             ...
             *         top level operator.  This version returns true if this operator is being used as a conditional
             *         operator, returns false if this operator is being used as a relational operator.
             */
             ...
             * \ref LogicalConditionalOperatorElement instance.
             *
             * If the newly added \ref LogicalConditionalOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalConditionalOperatorVisual instance and \ref LogicalConditionalOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalConditionalOperatorVisual* newVisual);
             ...
             */
            LogicalConditionalOperatorVisual* visual() const;
