...
* \file
*
* This header defines the \ref Ld::KroneckerProductOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_KRONECKER_PRODUCT_OPERATOR_ELEMENT_H
#define LD_KRONECKER_PRODUCT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class KroneckerProductOperatorVisual;

    /**
     * Element that provides support for the Kronecker product.
     */
    class LD_PUBLIC_API KroneckerProductOperatorElement:public BinaryMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::KroneckerProductOperatorElement)
        ...
        public:
            ...
            KroneckerProductOperatorElement();

            ~KroneckerProductOperatorElement() override;
             ...
             * \ref KroneckerProductOperatorElement instance.
             *
             * If the newly added \ref KroneckerProductOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref KroneckerProductOperatorVisual instance and \ref KroneckerProductOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(KroneckerProductOperatorVisual* newVisual);
             ...
             */
            KroneckerProductOperatorVisual* visual() const;
