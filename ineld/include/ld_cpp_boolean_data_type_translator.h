...
* \file
*
* This header defines the \ref Ld::CppBooleanDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_BOOLEAN_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_BOOLEAN_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API CppBooleanDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppBooleanDataTypeTranslator instance;

            CppBooleanDataTypeTranslator();

            ~CppBooleanDataTypeTranslator() override;
