...
* \file
*
* This header defines the \ref Ld::CppFloorOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_FLOOR_OPERATOR_TRANSLATOR_H
#define LD_CPP_FLOOR_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator class for the \ref Ld::FloorOperatorElement class.
     */
    class LD_PUBLIC_API CppFloorOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppFloorOperatorTranslator)

        public:
            ~CppFloorOperatorTranslator() override;
