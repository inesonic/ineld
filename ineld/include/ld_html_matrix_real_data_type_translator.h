...
* \file
*
* This header defines the \ref Ld::HtmlMatrixRealDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_MATRIX_REAL_DATA_TYPE_TRANSLATOR_H
#define LD_HTML_MATRIX_REAL_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    /**
     * HTML data type translator for real matrix values.
     */
    class LD_PUBLIC_API HtmlMatrixRealDataTypeTranslator:public HtmlMatrixDataTypeTranslator {
        public:
            /**
             * Context used to translate a real matrix to HTML.
             */
            class LD_PUBLIC_API Context:public virtual HtmlMatrixDataTypeTranslator::Context,
                                        public virtual MatrixRealDataTypeDecoder::Context {
                public:
                    /**
                     * Constructor
                     *
             ...
             * Static instance.
             */
            static const HtmlMatrixRealDataTypeTranslator instance;

            HtmlMatrixRealDataTypeTranslator();

            ~HtmlMatrixRealDataTypeTranslator() override;
