...
* \file
*
* This header defines the \ref Ld::UnaryLogicalOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNARY_LOGICAL_OPERATOR_ELEMENT_BASE_H
#define LD_UNARY_LOGICAL_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API UnaryLogicalOperatorElementBase:public UnaryOperatorElementBase {
        public:
            /**
            ...
            UnaryLogicalOperatorElementBase();

            ~UnaryLogicalOperatorElementBase() override;
