...
* \file
*
* This header defines the \ref Ld::HtmlRealTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_REAL_TYPE_TRANSLATOR_H
#define LD_HTML_REAL_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::RealTypeElement class.
     */
    class LD_PUBLIC_API HtmlRealTypeTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlRealTypeTranslator)

        public:
            ~HtmlRealTypeTranslator() override;
