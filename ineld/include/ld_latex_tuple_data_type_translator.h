...
* \file
*
* This header defines the \ref Ld::LaTeXTupleDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_TUPLE_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_TUPLE_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * Class that translates tuple values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXTupleDataTypeTranslator:public LaTeXDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const LaTeXTupleDataTypeTranslator instance;

            LaTeXTupleDataTypeTranslator();

            ~LaTeXTupleDataTypeTranslator() override;
