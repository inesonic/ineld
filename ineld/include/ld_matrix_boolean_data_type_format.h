...
* \file
*
* This header defines the \ref Ld::MatrixBooleanDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_BOOLEAN_DATA_TYPE_FORMAT_H
#define LD_MATRIX_BOOLEAN_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides format information to render boolean matrices.
     */
    class LD_PUBLIC_API MatrixBooleanDataTypeFormat:public virtual MatrixDataTypeFormat,
                                                    public virtual BooleanDataTypeFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::MatrixBooleanDataTypeFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual MatrixDataTypeFormat::Aggregation,
                                            public virtual BooleanDataTypeFormat::Aggregation {
                public:
                    Aggregation();
             ...
             */
            MatrixBooleanDataTypeFormat(const MatrixBooleanDataTypeFormat& other);

            ~MatrixBooleanDataTypeFormat() override;
