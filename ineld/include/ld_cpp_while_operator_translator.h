...
* \file
*
* This header defines the \ref Ld::CppWhileOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_WHILE_OPERATOR_TRANSLATOR_H
#define LD_CPP_WHILE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::WhileOperatorElement class.
     */
    class LD_PUBLIC_API CppWhileOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppWhileOperatorTranslator)

        public:
            ~CppWhileOperatorTranslator() override;
