...
* \file
*
* This header defines the \ref Ld::EpsilonSpecialValueElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_EPSILON_SPECIAL_VALUE_ELEMENT_H
#define LD_EPSILON_SPECIAL_VALUE_ELEMENT_H
...
namespace Ld {
    class EpsilonSpecialValueVisual;

    /**
     * Element that provides the epsilon special value.
     */
    class LD_PUBLIC_API EpsilonSpecialValueElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::EpsilonSpecialValueElement)
        ...
        public:
            ...
            EpsilonSpecialValueElement();

            ~EpsilonSpecialValueElement() override;
             ...
             * \ref Ld::EpsilonSpecialValueElement instance.
             *
             * If the newly added \ref Ld::EpsilonSpecialValueVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Ld::EpsilonSpecialValueVisual instance and \ref Ld::EpsilonSpecialValueElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(EpsilonSpecialValueVisual* newVisual);
             ...
             */
            EpsilonSpecialValueVisual* visual() const;
    };
};
