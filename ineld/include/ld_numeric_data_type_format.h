...
* \file
*
* This header defines the \ref Ld::NumericDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NUMERIC_DATA_TYPE_FORMAT_H
#define LD_NUMERIC_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Base class for numeric data type formats.
     */
    class LD_PUBLIC_API NumericDataTypeFormat:public virtual DataTypeFormat {
        public:
            /**
            ...
            class LD_PUBLIC_API Aggregation:public virtual DataTypeFormat::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to determine all the upper/lower case settings.
                     *
                     * \return Returns a boolean aggregation indicating if numbers are shown in upper-case or
                     *         lower-case.
                     */
                    const BooleanAggregation& upperCase() const;
                     ...
                     *         lower-case.
                     */
                    const BooleanAggregation& lowerCase() const;

                private:
                    /**
                     * Boolean aggregation indicating if numbers are shown in upper or lower case.
                     */
                    BooleanAggregation currentUpperCase;

                    /**
                     * Boolean aggregation indicating if numbers are shown in upper or lower case.
                     */
                    BooleanAggregation currentLowerCase;
            };
            ...
            /**
             * The default upper-case setting.
             */
            static const bool defaultUpperCase;
             ...
             */
            NumericDataTypeFormat(const NumericDataTypeFormat& other);

            ~NumericDataTypeFormat() override;
            ...
            /**
             * Method you can use to set the field to use upper-case letters (when needed).
             *
             * \param[in] nowUpperCase If true, the field will be shown using upper-case letters.  If false, the field
             *                         will be shown using lower-case letters.
             */
            void setUpperCase(bool nowUpperCase = true);

            /**
             * Method you can use to set the field to use lower-case letters (when needed).
             *
             * \param[in] nowLowerCase If true, the field will be shown using lower-case letters.  If false, the field
             *                         will be shown using upper-case letters.
             */
            void setLowerCase(bool nowLowerCase = true);

            /**
             * Method you can use to determine if the field should use upper-case letters (when needed).
             *
             * \return Returns true if the field should use upper-case letters.  Returns false if the field should use
             *         lower-case letters.
             */
            bool upperCase() const;

            /**
             * Method you can use to determine if the field should use lower-case letters (when needed).
             *
             * \return Returns true if the field should use lower-case letters.  Returns false if the field should use
             *         upper-case letters.
             */
        ...
        private:
            /**
             * Flag indicating if uppper case letters should be used.
             */
