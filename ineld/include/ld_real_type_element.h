...
* \file
*
* This header defines the \ref Ld::RealTypeElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_REAL_TYPE_ELEMENT_H
#define LD_REAL_TYPE_ELEMENT_H
...
namespace Ld {
    class RealTypeVisual;

    /**
     * Element that is used to represent the set of real values.
     */
    class LD_PUBLIC_API RealTypeElement:public DataTypeElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::RealTypeElement)
        ...
        public:
             ...
             * \ref RealTypeElement instance.
             *
             * If the newly added \ref RealTypeVisual already points to a different element, then those connections
             * will be broken in order to maintain a 1:1 relationship between any \ref RealTypeVisual instance and
             * \ref RealTypeElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(RealTypeVisual* newVisual);
