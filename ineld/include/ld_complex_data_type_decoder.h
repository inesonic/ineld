...
* \file
*
* This header defines the \ref Ld::ComplexDataTypeDecoder class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_COMPLEX_DATA_TYPE_DECODER_H
#define LD_COMPLEX_DATA_TYPE_DECODER_H
...
namespace Ld {
    ...
    /**
     * Class you can use to decode complex values of the type Model::Complex
     */
    class LD_PUBLIC_API ComplexDataTypeDecoder:public virtual RealDataTypeDecoderBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ComplexDataTypeDecoder)

        public:
            ComplexDataTypeDecoder();

            ~ComplexDataTypeDecoder() override;
