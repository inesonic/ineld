...
* \file
*
* This header defines the \ref Ld::HtmlComplexTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_COMPLEX_TYPE_TRANSLATOR_H
#define LD_HTML_COMPLEX_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ComplexTypeElement class.
     */
    class LD_PUBLIC_API HtmlComplexTypeTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlComplexTypeTranslator)

        public:
            ~HtmlComplexTypeTranslator() override;
