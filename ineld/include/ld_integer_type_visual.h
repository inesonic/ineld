...
* \file
*
* This header defines the \ref Ld::IntegerTypeVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_INTEGER_TYPE_VISUAL_H
#define LD_INTEGER_TYPE_VISUAL_H
...
namespace Ld {
    class IntegerTypeElement;

    /**
     * Visual used to interact with a \ref Ld::IntegerTypeElement instance.
     */
    class LD_PUBLIC_API IntegerTypeVisual:public virtual VisualWithNoChildren {
        public:
            IntegerTypeVisual();

            ~IntegerTypeVisual() override;
             ...
             */
            QSharedPointer<IntegerTypeElement> element() const;
