...
* \file
*
* This file defines the \ref Ld::HtmlLogicalExclusiveOrOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LOGICAL_EXCLUSIVE_OR_OPERATOR_TRANSLATOR_H
#define LD_HTML_LOGICAL_EXCLUSIVE_OR_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LogicalExclusiveOrOperatorElement class.
     */
    class LD_PUBLIC_API HtmlLogicalExclusiveOrOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLogicalExclusiveOrOperatorTranslator)

        public:
            ~HtmlLogicalExclusiveOrOperatorTranslator() override;
