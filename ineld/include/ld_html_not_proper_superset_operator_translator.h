...
* \file
*
* This file defines the \ref Ld::HtmlNotProperSupersetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_PROPER_SUPERSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_PROPER_SUPERSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotProperSupersetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotProperSupersetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotProperSupersetOperatorTranslator)

        public:
            ~HtmlNotProperSupersetOperatorTranslator() override;
