...
* \file
*
* This header defines the \ref Ld::LaTeXMatrixBooleanDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_MATRIX_BOOLEAN_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_MATRIX_BOOLEAN_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * Class that translates boolean matrix values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXMatrixBooleanDataTypeTranslator:public LaTeXMatrixDataTypeTranslator {
        public:
            /**
             ...
             * Static instance.
             */
            static const LaTeXMatrixBooleanDataTypeTranslator instance;

            LaTeXMatrixBooleanDataTypeTranslator();

            ~LaTeXMatrixBooleanDataTypeTranslator() override;
