...
* \file
*
* This header defines the \ref Ld::LaTeXBinaryOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_BINARY_OPERATOR_TRANSLATOR_BASE_H
#define LD_LATEX_BINARY_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for LaTeX translators used to render binary operators.
     */
    class LD_PUBLIC_API LaTeXBinaryOperatorTranslatorBase:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXBinaryOperatorTranslatorBase)

        public:
            ~LaTeXBinaryOperatorTranslatorBase() override;
