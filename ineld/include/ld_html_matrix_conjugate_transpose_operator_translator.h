...
* \file
*
* This header defines the \ref Ld::HtmlMatrixConjugateTransposeOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_MATRIX_CONJUGATE_TRANSPOSE_OPERATOR_TRANSLATOR_H
#define LD_HTML_MATRIX_CONJUGATE_TRANSPOSE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::MatrixConjugateTransposeOperatorElement class.
     */
    class LD_PUBLIC_API HtmlMatrixConjugateTransposeOperatorTranslator:
        public HtmlUnarySuperscriptOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlMatrixConjugateTransposeOperatorTranslator)

        public:
            ~HtmlMatrixConjugateTransposeOperatorTranslator() override;
