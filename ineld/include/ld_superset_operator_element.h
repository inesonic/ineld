...
* \file
*
* This header defines the \ref Ld::SupersetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SUPERSET_OPERATOR_ELEMENT_H
#define LD_SUPERSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SupersetOperatorVisual;

    /**
     * Element that provides support for the superset operator.
     */
    class LD_PUBLIC_API SupersetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SupersetOperatorElement)
        ...
        public:
            ...
            SupersetOperatorElement();

            ~SupersetOperatorElement() override;
             ...
             * \ref SupersetOperatorElement instance.
             *
             * If the newly added \ref SupersetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SupersetOperatorVisual instance and \ref SupersetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SupersetOperatorVisual* newVisual);
             ...
             */
            SupersetOperatorVisual* visual() const;
    };
};
