...
* \file
*
* This header defines the \ref Ld::LaTeXAbsoluteValueOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_ABSOLUTE_VALUE_OPERATOR_TRANSLATOR_H
#define LD_LATEX_ABSOLUTE_VALUE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::AbsoluteValueOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXAbsoluteValueOperatorTranslator:public LaTeXGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXAbsoluteValueOperatorTranslator)

        public:
            ~LaTeXAbsoluteValueOperatorTranslator() override;
