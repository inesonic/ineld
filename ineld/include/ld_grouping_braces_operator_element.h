...
* \file
*
* This header defines the \ref Ld::GroupingBracesOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_GROUPING_BRACES_OPERATOR_ELEMENT_H
#define LD_GROUPING_BRACES_OPERATOR_ELEMENT_H
...
namespace Ld {
    class GroupingBracesOperatorVisual;

    /**
     * Element that provides support for a braces grouping operator.
     */
    class LD_PUBLIC_API GroupingBracesOperatorElement:public GenericGroupingOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::GroupingBracesOperatorElement)
        ...
        public:
            ...
            GroupingBracesOperatorElement();

            ~GroupingBracesOperatorElement() override;
             ...
             * \ref GroupingBracesOperatorElement instance.
             *
             * If the newly added \ref GroupingBracesOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref GroupingBracesOperatorVisual instance and \ref GroupingBracesOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(GroupingBracesOperatorVisual* newVisual);
             ...
             */
            GroupingBracesOperatorVisual* visual() const;
