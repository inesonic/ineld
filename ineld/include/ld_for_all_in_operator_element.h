...
* \file
*
* This header defines the \ref Ld::ForAllInOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_FOR_ALL_IN_OPERATOR_ELEMENT_H
#define LD_FOR_ALL_IN_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ForAllInOperatorVisual;

    /**
     * Element that provides a for-all operator you can use to iterate through sets, tuples, or matrices.
     */
    class LD_PUBLIC_API ForAllInOperatorElement:public TrinaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ForAllInOperatorElement)
        ...
        public:
            ...
            ForAllInOperatorElement();

            ~ForAllInOperatorElement() override;
            ...
            /**
             * Method you can use to determine the data-type that the for-all operator is iterating over.  This method
             * will examine the data type of child 1.  If the data type can-not be determined, this method will look
             * at the capabilities provided by child 1.  This approach allows the type to be accurately determined
             * in all cases after compilation and in most cases prior to compilation.
             *
             * \return Returns true if the iterable is a set.  Returns false if the iterable is likely not a set.
             */
            bool isSetIterable() const;
             ...
             * \ref ForAllInOperatorElement instance.
             *
             * If the newly added \ref ForAllInOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ForAllInOperatorVisual instance and \ref ForAllInOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ForAllInOperatorVisual* newVisual);
             ...
             */
            ForAllInOperatorVisual* visual() const;
