...
* \file
*
* This header defines the \ref Ld::ValueFieldFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_VALUE_FIELD_FORMAT_H
#define LD_VALUE_FIELD_FORMAT_H
...
namespace Ld {
    /**
     * Class that extends the unified data type format to support value fields.
     */
    class LD_PUBLIC_API ValueFieldFormat:public virtual UnifiedDataTypeFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ValueFieldFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual UnifiedDataTypeFormat::Aggregation {
                public:
                    Aggregation();
                    ...
                    /**
                     * Method you can use to obtain the set of unique variable names.
                     *
                     * \return Returns a set of unique variable names.
                     */
                    const QSet<VariableName>& variableNames() const;

                    /**
                     * Method you can use to obtain the set of unique text1 field values.
                     *
                     * \return Returns a set of text1 field values.
                     */
                    const QSet<QString>& text1() const;

                    /**
                     * Method you can use to obtain the set of unique text2 field values.
                     *
                     * \return Returns a set of text2 field values.
                     */
                    const QSet<QString>& text2() const;

                private:
                    /**
                     * Set of unique variable names.
                     */
                    QSet<VariableName> currentVariableNames;

                    /**
                     * The variable name, text1.
                     */
                    QSet<QString> currentText1;

                    /**
                     * The variable name, text2.
                     */
                    QSet<QString> currentText2;
            };
             ...
             */
            ValueFieldFormat(const ValueFieldFormat& other);

            ~ValueFieldFormat() override;
            ...
            /**
             * Method you can use to set the tracked variable name.
             *
             * \param[in] variableName The variable name.
             */
            void setVariableName(const VariableName& variableName);

            /**
             * Convenience method you can use to set the tracked variable name.
             *
             * \param[in] text1 The first text in the variable name.
             *
             * \param[in] text2 Optional subscript for the variable name.
             */
            void setVariableName(const QString& text1, const QString& text2);

            /**
             * method you can use to obtain the tracked variable name.
             *
             * \return Returns the tracked variable name.
             */
