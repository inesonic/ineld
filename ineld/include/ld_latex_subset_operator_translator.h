...
* \file
*
* This header defines the \ref Ld::LaTeXSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SubsetOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSubsetOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSubsetOperatorTranslator)

        public:
            ~LaTeXSubsetOperatorTranslator() override;
