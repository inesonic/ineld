...
* \file
*
* This file defines the \ref Ld::HtmlWhileOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_WHILE_OPERATOR_TRANSLATOR_H
#define LD_HTML_WHILE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::WhileOperatorElement class.
     */
    class LD_PUBLIC_API HtmlWhileOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlWhileOperatorTranslator)

        public:
            ~HtmlWhileOperatorTranslator() override;
