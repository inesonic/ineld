...
* \file
*
* This header defines the \ref Ld::CppSetDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_SET_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_SET_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ set data type translator.
     */
    class LD_PUBLIC_API CppSetDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppSetDataTypeTranslator instance;

            CppSetDataTypeTranslator();

            ~CppSetDataTypeTranslator() override;
