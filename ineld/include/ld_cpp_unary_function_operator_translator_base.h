...
* \file
*
* This header defines the \ref Ld::CppUnaryFunctionOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_UNARY_FUNCTION_OPERATOR_TRANSLATOR_BASE_H
#define LD_CPP_UNARY_FUNCTION_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * C++ translator for basic unary operators that translate to a function call.
     */
    class LD_PUBLIC_API CppUnaryFunctionOperatorTranslatorBase:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppUnaryFunctionOperatorTranslatorBase)

        public:
            ~CppUnaryFunctionOperatorTranslatorBase() override;
