...
* \file
*
* This header defines the \ref Ld::LaTeXEpsilonSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_EPSILON_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_EPSILON_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the EpsilonSpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXEpsilonSpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXEpsilonSpecialValueTranslator)

        public:
            virtual ~LaTeXEpsilonSpecialValueTranslator();
