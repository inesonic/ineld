...
* \file
*
* This header defines the \ref Ld::LaTeXMatrixRealDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_MATRIX_REAL_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_MATRIX_REAL_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    /**
     * Class that translates real matrix values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXMatrixRealDataTypeTranslator:public virtual LaTeXMatrixDataTypeTranslator {
        public:
            /**
             * Context used to translate an real matrix to HTML.
             */
             ...
             * Static instance.
             */
            static const LaTeXMatrixRealDataTypeTranslator instance;

            LaTeXMatrixRealDataTypeTranslator();

            ~LaTeXMatrixRealDataTypeTranslator() override;
