...
* \file
*
* This header defines the \ref Ld::HtmlUnaryMinusOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_UNARY_MINUS_OPERATOR_TRANSLATOR_H
#define LD_HTML_UNARY_MINUS_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::UnaryMinusOperatorElement class.
     */
    class LD_PUBLIC_API HtmlUnaryMinusOperatorTranslator:public HtmlUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlUnaryMinusOperatorTranslator)

        public:
            ~HtmlUnaryMinusOperatorTranslator() override;
