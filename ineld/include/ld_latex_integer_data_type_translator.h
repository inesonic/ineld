...
* \file
*
* This header defines the \ref Ld::LaTeXIntegerDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_INTEGER_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_INTEGER_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * Class that translates integer values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXIntegerDataTypeTranslator:public LaTeXDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const LaTeXIntegerDataTypeTranslator instance;

            LaTeXIntegerDataTypeTranslator();

            ~LaTeXIntegerDataTypeTranslator() override;
