...
* \file
*
* This header defines the \ref Ld::MatrixComplexDataTypeDecoder class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_COMPLEX_DATA_TYPE_DECODER_H
#define LD_MATRIX_COMPLEX_DATA_TYPE_DECODER_H
...
namespace Ld {
    /**
     * Complex matrix data type decoder.
     */
    class LD_PUBLIC_API MatrixComplexDataTypeDecoder:public virtual MatrixDataTypeDecoder {
        Q_DECLARE_TR_FUNCTIONS(Ld::MatrixComplexDataTypeDecoder)
        ...
        public:
            ...
            class LD_PUBLIC_API Context:public virtual MatrixDataTypeDecoder::Context {
                public:
                    ...
                    /**
                     * Method you can use to determine the desired imaginary unit.
                     *
                     * \return Returns the desired imagainary unit.
                     */
                    ComplexDataTypeFormat::ImaginaryUnit imaginaryUnit() const;
                ...
                private:
                    ...
                    /**
                     * Value indicating the desired unit to use for imaginary numbers.
                     */
                    ComplexDataTypeFormat::ImaginaryUnit currentImaginaryUnit;
            ...
            ~MatrixComplexDataTypeDecoder() override;
