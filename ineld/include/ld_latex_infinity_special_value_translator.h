...
* \file
*
* This header defines the \ref Ld::LaTeXInfinitySpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_INFINITY_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_INFINITY_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the InfinitySpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXInfinitySpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXInfinitySpecialValueTranslator)

        public:
            virtual ~LaTeXInfinitySpecialValueTranslator();
