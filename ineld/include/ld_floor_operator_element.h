...
* \file
*
* This header defines the \ref Ld::FloorOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_FLOOR_OPERATOR_ELEMENT_H
#define LD_FLOOR_OPERATOR_ELEMENT_H
...
namespace Ld {
    class FloorOperatorVisual;

    /**
     * Element that provides support for the floor operator.
     */
    class LD_PUBLIC_API FloorOperatorElement:public NumericGroupingOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::FloorOperatorElement)
        ...
        public:
            ...
            FloorOperatorElement();

            ~FloorOperatorElement() override;
             ...
             * \ref Ld::FloorOperatorElement instance.
             *
             * If the newly added \ref FloorOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref FloorOperatorVisual instance and \ref FloorOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(FloorOperatorVisual* newVisual);
             ...
             */
            FloorOperatorVisual* visual() const;
    };
};
