...
* \file
*
* This header defines the \ref Ld::UnifiedDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNIFIED_DATA_TYPE_FORMAT_H
#define LD_UNIFIED_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides a unified data type format.  This class can provide formatting support for all intrinsic
     * numeric types, sets, tuples, and matricies, including:
     *
     *     * Boolean types
     *     * Integer types
     *     * Real types
     ...
     *     * Complex matricies
     *
     * The class includes hooks allowing the reported type to be specified at run-time and changed dynamically.
     */
    class LD_PUBLIC_API UnifiedDataTypeFormat:public virtual BooleanDataTypeFormat,
                                              public virtual IntegerDataTypeFormat,
                                              public virtual RealDataTypeFormat,
                                              public virtual ComplexDataTypeFormat,
                                              public virtual ListDataTypeFormat,
                                              public virtual SetDataTypeFormat,
                                              public virtual TupleDataTypeFormat,
                                              public virtual MatrixBooleanDataTypeFormat,
                                              public virtual MatrixIntegerDataTypeFormat,
                                              public virtual MatrixRealDataTypeFormat,
                                              public virtual MatrixComplexDataTypeFormat {
        public:
            /**
             * Type used to programmatically specify the reported type.
             */
            typedef DataType::ValueType Type;

            /**
             * Class you can use to track an aggregation of multiple \ref Ld::UnifiedDataTypeFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual BooleanDataTypeFormat::Aggregation,
                                            public virtual IntegerDataTypeFormat::Aggregation,
                                            public virtual RealDataTypeFormat::Aggregation,
                                            public virtual ComplexDataTypeFormat::Aggregation,
                                            public virtual ListDataTypeFormat::Aggregation,
                                            public virtual SetDataTypeFormat::Aggregation,
                                            public virtual TupleDataTypeFormat::Aggregation,
                                            public virtual MatrixBooleanDataTypeFormat::Aggregation,
                                            public virtual MatrixIntegerDataTypeFormat::Aggregation,
                                            public virtual MatrixRealDataTypeFormat::Aggregation,
                                            public virtual MatrixComplexDataTypeFormat::Aggregation {
                ...
                public:
                    ...
                    /**
                     * Method you can use to determine the types that are being collected in this aggregation.
                     *
                     * \return Returns a set of type names representing the supported types.
                     */
                    QSet<QString> typeNames() const;

                private:
                    /**
                     * Set of reported type names.
                     */
                    QSet<QString> currentTypeNames;
            };
            ...
            /**
             * The default imaginary unit.
             */
            static const ImaginaryUnit defaultImaginaryUnit;
             ...
             */
            UnifiedDataTypeFormat(const UnifiedDataTypeFormat& other);

            ~UnifiedDataTypeFormat() override;
             ...
             *
             * \return Returns the format identifying name.
             */
            QString typeName() const override;

            /**
             * Method you can use to set the reported type.
             *
             * \param[in] newTypeName The new type-name to report for this format.
             */
             ...
             * Method you can use to set the reported type.
             *
             * \param[in] newType The new type-name to report for this format.
             */
        ...
        private:
            /**
             * The currently reported type-name.
             */
