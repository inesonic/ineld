...
* \file
*
* This header defines the \ref Ld::HtmlBooleanDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_BOOLEAN_DATA_TYPE_TRANSLATOR_H
#define LD_HTML_BOOLEAN_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML data type translator for boolean values.
     */
    class LD_PUBLIC_API HtmlBooleanDataTypeTranslator:public HtmlDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const HtmlBooleanDataTypeTranslator instance;

            HtmlBooleanDataTypeTranslator();

            ~HtmlBooleanDataTypeTranslator() override;
