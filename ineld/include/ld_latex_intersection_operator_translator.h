...
* \file
*
* This header defines the \ref Ld::LaTeXIntersectionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_INTERSECTION_OPERATOR_TRANSLATOR_H
#define LD_LATEX_INTERSECTION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::IntersectionOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXIntersectionOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXIntersectionOperatorTranslator)

        public:
            ~LaTeXIntersectionOperatorTranslator() override;
