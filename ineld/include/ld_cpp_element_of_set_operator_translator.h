...
* \file
*
* This header defines the \ref Ld::CppElementOfSetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
#define LD_CPP_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for the element of set operator.
     */
    class LD_PUBLIC_API CppElementOfSetOperatorTranslator:public CppTranslator {
        public:
            ~CppElementOfSetOperatorTranslator() override;
