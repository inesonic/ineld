...
* \file
*
* This header defines the \ref Ld::LaTeXNullSetSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_NULL_SET_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_NULL_SET_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the NullSetSpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXNullSetSpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXNullSetSpecialValueTranslator)

        public:
            virtual ~LaTeXNullSetSpecialValueTranslator();
