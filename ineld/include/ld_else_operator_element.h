...
* \file
*
* This header defines the \ref Ld::ElseOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ELSE_OPERATOR_ELEMENT_H
#define LD_ELSE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ElseOperatorVisual;

    /**
     * Element that provides an else conditional operator.
     */
    class LD_PUBLIC_API ElseOperatorElement:public UnaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ElseOperatorElement)
        ...
        public:
             ...
             * \ref ElseOperatorElement instance.
             *
             * If the newly added \ref ElseOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ElseOperatorVisual instance and \ref ElseOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ElseOperatorVisual* newVisual);
             ...
             */
            ElseOperatorVisual* visual() const;
