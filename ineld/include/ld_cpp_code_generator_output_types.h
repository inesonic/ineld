...
* \file
*
* This header defines the output types supported by the \ref Ld::CppCodeGenerator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_CODE_GENERATOR_OUTPUT_TYPES_H
#define LD_CPP_CODE_GENERATOR_OUTPUT_TYPES_H
...
namespace Ld {
    /**
     * Class that indicates an application loadable module based on C++ source.
     */
    class LD_PUBLIC_API CppLoadableModuleOutputType:public CodeGeneratorOutputTypeBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppLoadableModuleOutputType)
        ...
        public:
             ...
             *
             * \return Returns the default export mode.  This method returns the value
             *         \ref Ld::CodeGeneratorOutputType::ExportMode::EXPORT_AS_FILE.
             */
    ...
    /**
     * Class that indicates a linkable object file based on C++ source.
     */
    class LD_PUBLIC_API CppObjectFileOutputType:public CodeGeneratorOutputTypeBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppObjectFileOutputType)
