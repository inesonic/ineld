...
* \file
*
* This header defines the \ref Ld::NaryUnionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NARY_UNION_OPERATOR_ELEMENT_H
#define LD_NARY_UNION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NaryUnionOperatorVisual;

    /**
     * Element that provides support for an N-ary union operator.
     */
    class LD_PUBLIC_API NaryUnionOperatorElement:public UnaryLargeSetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NaryUnionOperatorElement)
        ...
        public:
            ...
            NaryUnionOperatorElement();

            ~NaryUnionOperatorElement() override;
             ...
             * \ref Ld::NaryUnionOperatorElement instance.
             *
             * If the newly added \ref NaryUnionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NaryUnionOperatorVisual instance and \ref NaryUnionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NaryUnionOperatorVisual* newVisual);
             ...
             */
            NaryUnionOperatorVisual* visual() const;
    };
};
