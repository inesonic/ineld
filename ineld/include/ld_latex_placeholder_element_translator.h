...
* \file
*
* This header defines the \ref Ld::LaTeXPlaceholderElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_PLACEHOLDER_ELEMENT_TRANSLATOR_H
#define LD_LATEX_PLACEHOLDER_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the placeholder element.
     */
    class LD_PUBLIC_API LaTeXPlaceholderElementTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXPlaceholderElementTranslator)

        public:
            ~LaTeXPlaceholderElementTranslator() override;
