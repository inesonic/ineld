...
* \file
*
* This header defines the \ref Ld::Range2Element class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_RANGE_2_ELEMENT_H
#define LD_RANGE_2_ELEMENT_H
...
namespace Ld {
    ...
    /**
     * Element that supports a range with a first and final value with an inferred second value.
     */
    class LD_PUBLIC_API Range2Element:public BinaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::Range2Element)

        public:
            /**
             * The typename for the range element.
             */
             ...
             * \ref Range2Element instance.
             *
             * If the newly added \ref Range2Visual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Range2Visual instance and \ref Range2Element instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(Range2Visual* newVisual);
