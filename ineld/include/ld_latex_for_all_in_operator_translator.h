...
* \file
*
* This header defines the \ref Ld::LaTeXForAllInOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_FOR_ALL_IN_OPERATOR_TRANSLATOR_H
#define LD_LATEX_FOR_ALL_IN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::ForAllInOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXForAllInOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXForAllInOperatorTranslator)

        public:
            ~LaTeXForAllInOperatorTranslator() override;
