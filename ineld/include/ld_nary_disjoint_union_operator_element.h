...
* \file
*
* This header defines the \ref Ld::NaryDisjointUnionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NARY_DISJOINT_UNION_OPERATOR_ELEMENT_H
#define LD_NARY_DISJOINT_UNION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NaryDisjointUnionOperatorVisual;

    /**
     * Element that provides support for the N-ary disjoint union operator.
     */
    class LD_PUBLIC_API NaryDisjointUnionOperatorElement:public UnaryLargeSetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NaryDisjointUnionOperatorElement)
        ...
        public:
            ...
            NaryDisjointUnionOperatorElement();

            ~NaryDisjointUnionOperatorElement() override;
             ...
             * \ref Ld::NaryDisjointUnionOperatorElement instance.
             *
             * If the newly added \ref NaryDisjointUnionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NaryDisjointUnionOperatorVisual instance and \ref NaryDisjointUnionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NaryDisjointUnionOperatorVisual* newVisual);
             ...
             */
            NaryDisjointUnionOperatorVisual* visual() const;
    };
};
