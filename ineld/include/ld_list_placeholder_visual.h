...
* \file
*
* This header defines the \ref Ld::ListPlaceholderVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LIST_PLACEHOLDER_VISUAL_H
#define LD_LIST_PLACEHOLDER_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::ListPlaceholderElement instance.
     */
    class LD_PUBLIC_API ListPlaceholderVisual:public virtual VisualWithNoChildren {
        public:
            ListPlaceholderVisual();

            ~ListPlaceholderVisual() override;

            /**
             * Method you can use to obtain the \ref PlaceholderElement class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref PlaceholderElement instance.
             */
            QSharedPointer<PlaceholderElement> element() const;
