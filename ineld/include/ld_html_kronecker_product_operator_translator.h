...
* \file
*
* This file defines the \ref Ld::HtmlKroneckerProductOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_KRONECKER_PRODUCT_OPERATOR_TRANSLATOR_H
#define LD_HTML_KRONECKER_PRODUCT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::KroneckerProductOperatorElement class.
     */
    class LD_PUBLIC_API HtmlKroneckerProductOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlKroneckerProductOperatorTranslator)

        public:
            ~HtmlKroneckerProductOperatorTranslator() override;
