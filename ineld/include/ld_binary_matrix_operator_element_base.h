...
* \file
*
* This header defines the \ref Ld::BinaryMatrixOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BINARY_MATRIX_OPERATOR_ELEMENT_BASE_H
#define LD_BINARY_MATRIX_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for operator elements with two children that accepts and provides a matrix value.
     */
    class LD_PUBLIC_API BinaryMatrixOperatorElementBase:public BinaryOperatorElementBase {
        public:
            /**
            ...
            BinaryMatrixOperatorElementBase();

            ~BinaryMatrixOperatorElementBase() override;
