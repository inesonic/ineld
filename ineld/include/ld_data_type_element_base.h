...
* \file
*
* This header defines the \ref Ld::DataTypeElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_DATA_TYPE_ELEMENT_BASE_H
#define LD_DATA_TYPE_ELEMENT_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for elements representing basic data types.
     */
    class LD_PUBLIC_API DataTypeElementBase:public SpecialSymbolElementBase {
        public:
            /**
