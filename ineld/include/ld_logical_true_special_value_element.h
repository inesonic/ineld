...
* \file
*
* This header defines the \ref Ld::LogicalTrueSpecialValueElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_TRUE_SPECIAL_VALUE_ELEMENT_H
#define LD_LOGICAL_TRUE_SPECIAL_VALUE_ELEMENT_H
...
namespace Ld {
    class LogicalTrueSpecialValueVisual;

    /**
     * Element that provides the "true" boolean value.
     */
    class LD_PUBLIC_API LogicalTrueSpecialValueElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalTrueSpecialValueElement)
        ...
        public:
            ...
            LogicalTrueSpecialValueElement();

            ~LogicalTrueSpecialValueElement() override;
             ...
             * \ref Ld::LogicalTrueSpecialValueElement instance.
             *
             * If the newly added \ref Ld::LogicalTrueSpecialValueVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Ld::LogicalTrueSpecialValueVisual instance and \ref Ld::LogicalTrueSpecialValueElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalTrueSpecialValueVisual* newVisual);
             ...
             */
            LogicalTrueSpecialValueVisual* visual() const;
    };
};
