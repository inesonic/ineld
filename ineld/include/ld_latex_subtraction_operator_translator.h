...
* \file
*
* This header defines the \ref Ld::LaTeXSubtractionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SUBTRACTION_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SUBTRACTION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SubtractionOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSubtractionOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSubtractionOperatorTranslator)

        public:
            ~LaTeXSubtractionOperatorTranslator() override;
