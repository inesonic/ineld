...
* \file
*
* This header defines the \ref Ld::HtmlAdditionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ADDITION_OPERATOR_TRANSLATOR_H
#define LD_HTML_ADDITION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::AdditionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlAdditionOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlAdditionOperatorTranslator)

        public:
            ~HtmlAdditionOperatorTranslator() override;
