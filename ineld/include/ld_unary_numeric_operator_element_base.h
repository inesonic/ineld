...
* \file
*
* This header defines the \ref Ld::UnaryNumericOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNARY_NUMERIC_OPERATOR_ELEMENT_BASE_H
#define LD_UNARY_NUMERIC_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for operator elements with a single child that accepts and provides a numeric value.
     */
    class LD_PUBLIC_API UnaryNumericOperatorElementBase:public UnaryOperatorElementBase {
        public:
            /**
            ...
            UnaryNumericOperatorElementBase();

            ~UnaryNumericOperatorElementBase() override;
