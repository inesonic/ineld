...
* \file
*
* This header defines the \ref Ld::CppRange2Translator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_RANGE_2_TRANSLATOR_H
#define LD_CPP_RANGE_2_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for ranges with implied increment of 1.
     */
    class LD_PUBLIC_API CppRange2Translator:public CppTranslator {
        public:
            ~CppRange2Translator() override;
