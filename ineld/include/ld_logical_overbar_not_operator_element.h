...
* \file
*
* This header defines the \ref Ld::LogicalOverbarNotOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_OVERBAR_NOT_OPERATOR_ELEMENT_H
#define LD_LOGICAL_OVERBAR_NOT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalOverbarNotOperatorVisual;

    /**
     * Element that provides support for a overbar logical negation operator.
     */
    class LD_PUBLIC_API LogicalOverbarNotOperatorElement:public UnaryLogicalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalOverbarNotOperatorElement)
        ...
        public:
            ...
            LogicalOverbarNotOperatorElement();

            ~LogicalOverbarNotOperatorElement() override;
             ...
             * \ref Ld::LogicalOverbarNotOperatorElement instance.
             *
             * If the newly added \ref LogicalOverbarNotOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalOverbarNotOperatorVisual instance and \ref LogicalOverbarNotOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalOverbarNotOperatorVisual* newVisual);
             ...
             */
            LogicalOverbarNotOperatorVisual* visual() const;
