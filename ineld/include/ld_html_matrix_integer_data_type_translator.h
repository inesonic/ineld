...
* \file
*
* This header defines the \ref Ld::HtmlMatrixIntegerDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_MATRIX_INTEGER_DATA_TYPE_TRANSLATOR_H
#define LD_HTML_MATRIX_INTEGER_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    /**
     * HTML data type translator for integer matrix values.
     */
    class LD_PUBLIC_API HtmlMatrixIntegerDataTypeTranslator:public HtmlMatrixDataTypeTranslator {
        public:
            /**
             * Context used to translate a integer matrix to HTML.
             */
            class LD_PUBLIC_API Context:public virtual HtmlMatrixDataTypeTranslator::Context,
                                        public virtual MatrixIntegerDataTypeDecoder::Context {
                public:
                    /**
                     * Constructor
                     *
             ...
             * Static instance.
             */
            static const HtmlMatrixIntegerDataTypeTranslator instance;

            HtmlMatrixIntegerDataTypeTranslator();

            ~HtmlMatrixIntegerDataTypeTranslator() override;
