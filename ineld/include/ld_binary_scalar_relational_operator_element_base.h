...
* \file
*
* This header defines the \ref Ld::BinaryScalarRelationalOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BINARY_SCALAR_RELATIONAL_OPERATOR_ELEMENT_BASE_H
#define LD_BINARY_SCALAR_RELATIONAL_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Trivial base class for relational operator elements with two children containing scalar values.
     */
    class LD_PUBLIC_API BinaryScalarRelationalOperatorElementBase:public BinaryRelationalOperatorElementBase {
        public:
            /**
            ...
            BinaryScalarRelationalOperatorElementBase();

            ~BinaryScalarRelationalOperatorElementBase() override;
