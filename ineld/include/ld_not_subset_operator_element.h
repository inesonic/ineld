...
* \file
*
* This header defines the \ref Ld::NotSubsetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_SUBSET_OPERATOR_ELEMENT_H
#define LD_NOT_SUBSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotSubsetOperatorVisual;

    /**
     * Element that provides support for the not subset operator.
     */
    class LD_PUBLIC_API NotSubsetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotSubsetOperatorElement)
        ...
        public:
            ...
            NotSubsetOperatorElement();

            ~NotSubsetOperatorElement() override;
             ...
             * \ref NotSubsetOperatorElement instance.
             *
             * If the newly added \ref NotSubsetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotSubsetOperatorVisual instance and \ref NotSubsetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotSubsetOperatorVisual* newVisual);
             ...
             */
            NotSubsetOperatorVisual* visual() const;
    };
};
