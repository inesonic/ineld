...
* \file
*
* This header defines the \ref Ld::MatrixTransposeOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_TRANSPOSE_OPERATOR_ELEMENT_H
#define LD_MATRIX_TRANSPOSE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class MatrixTransposeOperatorVisual;

    /**
     * Element that provides support for matrix transpose operations.
     */
    class LD_PUBLIC_API MatrixTransposeOperatorElement:public UnaryMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::MatrixTransposeOperatorElement)
        ...
        public:
            ...
            MatrixTransposeOperatorElement();

            ~MatrixTransposeOperatorElement() override;
             ...
             * \ref Ld::MatrixTransposeOperatorElement instance.
             *
             * If the newly added \ref MatrixTransposeOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref MatrixTransposeOperatorVisual instance and \ref MatrixTransposeOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(MatrixTransposeOperatorVisual* newVisual);
             ...
             */
            MatrixTransposeOperatorVisual* visual() const;
    };
};
