...
* \file
*
* This header defines the \ref Ld::HtmlTextElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_TEXT_ELEMENT_TRANSLATOR_H
#define LD_HTML_TEXT_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::TextElement class.
     */
    class LD_PUBLIC_API HtmlTextElementTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlTextElementTranslator)

        public:
            ~HtmlTextElementTranslator() override;
