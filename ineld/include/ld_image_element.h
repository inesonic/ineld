...
* \file
*
* This header defines the \ref Ld::ImageElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_IMAGE_ELEMENT_H
#define LD_IMAGE_ELEMENT_H
...
namespace Ld {
    ...
    /**
     * Element that is used to represent a picture or image.  The class is a thin wrapper on the
     * \ref Ld::PayloadElement class.
     */
    class LD_PUBLIC_API ImageElement:public PayloadElement {
        Q_DECLARE_TR_FUNCTIONS(Ld::ImageElement)
        ...
        public:
             ...
             * \ref ImageElement instance.
             *
             * If the newly added \ref ImageVisual already points to a different element, then those connections will
             * be broken in order to maintain a 1:1 relationship between any \ref ImageVisual instance and
             * \ref ImageElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ImageVisual* newVisual);
             ...
             *         \ref Ld::Element::ExportImageCapability::INTRINSIC.
             */
             ...
             * array.
             *
             * This method will obtain the image from the underlying payload and will ignore the DPI settings.
             *
             ...
             */
            QByteArray exportImage(float dpi) override;
    };
};
