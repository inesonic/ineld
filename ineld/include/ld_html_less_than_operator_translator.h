...
* \file
*
* This file defines the \ref Ld::HtmlLessThanOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LESS_THAN_OPERATOR_TRANSLATOR_H
#define LD_HTML_LESS_THAN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LessThanOperatorElement class.
     */
    class LD_PUBLIC_API HtmlLessThanOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLessThanOperatorTranslator)

        public:
            ~HtmlLessThanOperatorTranslator() override;
