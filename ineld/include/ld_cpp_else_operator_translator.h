...
* \file
*
* This header defines the \ref Ld::CppElseOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_ELSE_OPERATOR_TRANSLATOR_H
#define LD_CPP_ELSE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::ElseOperatorElement class.
     */
    class LD_PUBLIC_API CppElseOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppElseOperatorTranslator)

        public:
            ~CppElseOperatorTranslator() override;
