...
* \file
*
* This file defines the \ref Ld::HtmlDisjointUnionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_DISJOINT_UNION_OPERATOR_TRANSLATOR_H
#define LD_HTML_DISJOINT_UNION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::DisjointUnionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlDisjointUnionOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlDisjointUnionOperatorTranslator)

        public:
            ~HtmlDisjointUnionOperatorTranslator() override;
