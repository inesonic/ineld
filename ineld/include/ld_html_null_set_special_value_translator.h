...
* \file
*
* This header defines the \ref Ld::HtmlNullSetSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NULL_SET_SPECIAL_VALUE_TRANSLATOR_H
#define LD_HTML_NULL_SET_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NullSetSpecialValueElement class.
     */
    class LD_PUBLIC_API HtmlNullSetSpecialValueTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNullSetSpecialValueTranslator)

        public:
            ~HtmlNullSetSpecialValueTranslator() override;
