...
* \file
*
* This header defines the \ref Ld::LaTeXAdditionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_ADDITION_OPERATOR_TRANSLATOR_H
#define LD_LATEX_ADDITION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the AdditionOperator element.
     */
    class LD_PUBLIC_API LaTeXAdditionOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXAdditionOperatorTranslator)

        public:
            ~LaTeXAdditionOperatorTranslator() override;
