...
* \file
*
* This file defines the \ref Ld::HtmlBraceConditionalOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_BRACE_CONDITIONAL_OPERATOR_TRANSLATOR_H
#define LD_HTML_BRACE_CONDITIONAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::BraceConditionalOperatorElement class.
     */
    class LD_PUBLIC_API HtmlBraceConditionalOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlBraceConditionalOperatorTranslator)

        public:
            ~HtmlBraceConditionalOperatorTranslator() override;
