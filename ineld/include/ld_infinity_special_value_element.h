...
* \file
*
* This header defines the \ref Ld::InfinitySpecialValueElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_INFINITY_SPECIAL_VALUE_ELEMENT_H
#define LD_INFINITY_SPECIAL_VALUE_ELEMENT_H
...
namespace Ld {
    class InfinitySpecialValueVisual;

    /**
     * Element that tracks the special value, infinity.
     */
    class LD_PUBLIC_API InfinitySpecialValueElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::InfinitySpecialValueElement)
        ...
        public:
            ...
            InfinitySpecialValueElement();

            ~InfinitySpecialValueElement() override;
             ...
             * \ref Ld::InfinitySpecialValueElement instance.
             *
             * If the newly added \ref Ld::InfinitySpecialValueVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Ld::InfinitySpecialValueVisual instance and \ref Ld::InfinitySpecialValueElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(InfinitySpecialValueVisual* newVisual);
             ...
             */
            InfinitySpecialValueVisual* visual() const;
    };
};
