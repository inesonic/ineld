...
* \file
*
* This header defines the \ref Ld::ProperSubsetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PROPER_SUBSET_OPERATOR_ELEMENT_H
#define LD_PROPER_SUBSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ProperSubsetOperatorVisual;

    /**
     * Element that provides support for the proper subset operator.
     */
    class LD_PUBLIC_API ProperSubsetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ProperSubsetOperatorElement)
        ...
        public:
            ...
            ProperSubsetOperatorElement();

            ~ProperSubsetOperatorElement() override;
             ...
             * \ref ProperSubsetOperatorElement instance.
             *
             * If the newly added \ref ProperSubsetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ProperSubsetOperatorVisual instance and \ref ProperSubsetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ProperSubsetOperatorVisual* newVisual);
             ...
             */
            ProperSubsetOperatorVisual* visual() const;
    };
};
