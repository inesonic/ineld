...
* \file
*
* This header defines the \ref Ld::ComplexTypeElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_COMPLEX_TYPE_ELEMENT_H
#define LD_COMPLEX_TYPE_ELEMENT_H
...
namespace Ld {
    class ComplexTypeVisual;

    /**
     * Element that is used to represent the set of complex values.
     */
    class LD_PUBLIC_API ComplexTypeElement:public DataTypeElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ComplexTypeElement)
        ...
        public:
             ...
             * \ref ComplexTypeElement instance.
             *
             * If the newly added \ref ComplexTypeVisual already points to a different element, then those connections
             * will be broken in order to maintain a 1:1 relationship between any \ref ComplexTypeVisual instance and
             * \ref ComplexTypeElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ComplexTypeVisual* newVisual);
             ...
             */
            ComplexTypeVisual* visual() const;
    };
};
