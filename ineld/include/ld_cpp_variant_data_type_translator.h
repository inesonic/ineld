...
* \file
*
* This header defines the \ref Ld::CppVariantDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_VARIANT_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_VARIANT_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ boolean data type translator.
     */
    class LD_PUBLIC_API CppVariantDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppVariantDataTypeTranslator instance;

            CppVariantDataTypeTranslator();

            ~CppVariantDataTypeTranslator() override;
