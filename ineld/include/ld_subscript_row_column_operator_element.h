...
* \file
*
* This header defines the \ref Ld::SubscriptRowColumnOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SUBSCRIPT_ROW_COLUMN_OPERATOR_ELEMENT_H
#define LD_SUBSCRIPT_ROW_COLUMN_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SubscriptRowColumnOperatorVisual;

    /**
     * Element that provides a subscripting operator with two index positions.
     */
    class LD_PUBLIC_API SubscriptRowColumnOperatorElement:public SubscriptOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SubscriptRowColumnOperatorElement)
        ...
        public:
            ...
            SubscriptRowColumnOperatorElement();

            ~SubscriptRowColumnOperatorElement() override;
             ...
             *
             * \return Returns the name of the plug-in that provides this element. The name must match the name
             *         provided in the plug-in structures.  Elements defined as part of the ineld library should return
             *         an empty string.
             */
             ...
             * \ref SubscriptRowColumnOperatorElement instance.
             *
             * If the newly added \ref SubscriptRowColumnOperatorVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SubscriptRowColumnOperatorVisual instance and \ref SubscriptRowColumnOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SubscriptRowColumnOperatorVisual* newVisual);
             ...
             */
            SubscriptRowColumnOperatorVisual* visual() const;
