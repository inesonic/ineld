...
* \file
*
* This header defines the \ref Ld::HtmlLogicalNotOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LOGICAL_NOT_OPERATOR_TRANSLATOR_BASE_H
#define LD_HTML_LOGICAL_NOT_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for HTML translators for logical not operators.
     */
    class LD_PUBLIC_API HtmlLogicalNotOperatorTranslatorBase:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLogicalNotOperatorTranslatorBase)

        public:
            ~HtmlLogicalNotOperatorTranslatorBase() override;
