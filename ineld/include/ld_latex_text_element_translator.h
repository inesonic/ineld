...
* \file
*
* This header defines the \ref Ld::LaTeXTextElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_TEXT_ELEMENT_TRANSLATOR_H
#define LD_LATEX_TEXT_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the text element.
     */
    class LD_PUBLIC_API LaTeXTextElementTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXTextElementTranslator)

        public:
            ~LaTeXTextElementTranslator() override;
        ...
        private:
            /**
             * The desired maximum column width.
             */
            static constexpr unsigned maximumTextWidth = 79;
    };
};
