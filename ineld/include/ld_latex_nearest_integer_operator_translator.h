...
* \file
*
* This header defines the \ref Ld::LaTeXNearestIntegerOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_NEAREST_INTEGER_OPERATOR_TRANSLATOR_H
#define LD_LATEX_NEAREST_INTEGER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::NearestIntegerOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXNearestIntegerOperatorTranslator:public LaTeXGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXNearestIntegerOperatorTranslator)

        public:
            ~LaTeXNearestIntegerOperatorTranslator() override;
