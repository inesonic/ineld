...
* \file
*
* This header defines the \ref Ld::ListParagraphFormatBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LIST_PARAGRAPH_FORMAT_BASE_H
#define LD_LIST_PARAGRAPH_FORMAT_BASE_H
...
namespace Ld {
    /**
     * Base class that extends the \ref Ld::ParagraphFormat class to support fonts.  You can use this class as a common
     * base class for all list paragraphs that must display numbers or bullets using a specific font.
     *
     * While you can use the aggregation in this class, this class is intended to be used as a base class for various
     * list paragraph types.  You should never use this class directly.
     */
    class LD_PUBLIC_API ListParagraphFormatBase:public virtual ParagraphFormat, public virtual FontFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ListParagraphFormatBase instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual ParagraphFormat::Aggregation,
                                            public virtual FontFormat::Aggregation           {
                public:
                    Aggregation();
                     ...
                     */
                    QSet<float> listIndentations() const;

                private:
                    /**
                     * The current list of unique list indentation values.
                     */
                    QSet<float> currentListIndentations;
            };
             ...
             */
            ListParagraphFormatBase(const ListParagraphFormatBase& other);

            ~ListParagraphFormatBase() override;
             ...
             */
            FormatPointer formatForSplit(ElementPointer element) override;
            ...
            /**
             * Method you can use to set the list indentation value.  This value is added to the left indentation when
             * calculating the indentation for the text block.  Bullets and numbers are aligned based on the left
             * indentation value.
             *
             * \param[in] newListIndentation The new list indentation setting, in points.
             */
             ...
             * indentation when calculating the indentation for the text block.  Bullets and numbers are aligned based
             * on the left indentation value.
             *
             * \return Returns the current list indentation value, in points.
             */
