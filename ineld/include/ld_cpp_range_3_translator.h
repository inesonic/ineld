...
* \file
*
* This header defines the \ref Ld::CppRange3Translator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_RANGE_3_TRANSLATOR_H
#define LD_CPP_RANGE_3_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for ranges with an explicit second term indicating the increment.
     */
    class LD_PUBLIC_API CppRange3Translator:public CppTranslator {
        public:
            ~CppRange3Translator() override;
