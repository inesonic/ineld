...
* \file
*
* This header defines the \ref Ld::HtmlRootElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ROOT_ELEMENT_TRANSLATOR_H
#define LD_HTML_ROOT_ELEMENT_TRANSLATOR_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API HtmlRootElementTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlRootElementTranslator)

        public:
            ~HtmlRootElementTranslator() override;
