...
* \file
*
* This header defines the \ref Ld::LaTeXDisjointUnionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_DISJOINT_UNION_OPERATOR_TRANSLATOR_H
#define LD_LATEX_DISJOINT_UNION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::DisjointUnionOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXDisjointUnionOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXDisjointUnionOperatorTranslator)

        public:
            ~LaTeXDisjointUnionOperatorTranslator() override;
