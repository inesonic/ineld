...
* \file
*
* This header defines the \ref Ld::IfOperatorVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_IF_OPERATOR_VISUAL_H
#define LD_IF_OPERATOR_VISUAL_H
...
namespace Ld {
    class IfOperatorElement;

    /**
     * Visual used to interact with a \ref Ld::IfOperatorElement instance.
     */
    class LD_PUBLIC_API IfOperatorVisual:public virtual VisualWithFixedChildren {
        public:
            IfOperatorVisual();

            ~IfOperatorVisual() override;

            /**
             * Method you can use to obtain the \ref IfOperatorElement class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref IfOperatorElement instance.
             */
            QSharedPointer<IfOperatorElement> element() const;
