...
* \file
*
* This header defines the \ref Ld::ComplexTypeVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_COMPLEX_TYPE_VISUAL_H
#define LD_COMPLEX_TYPE_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::ComplexTypeElement instance.
     */
    class LD_PUBLIC_API ComplexTypeVisual:public virtual VisualWithNoChildren {
        public:
            ComplexTypeVisual();

            ~ComplexTypeVisual() override;
             ...
             */
            QSharedPointer<ComplexTypeElement> element() const;
