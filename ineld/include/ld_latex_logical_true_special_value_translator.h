...
* \file
*
* This header defines the \ref Ld::LaTeXLogicalTrueSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_LOGICAL_TRUE_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_LOGICAL_TRUE_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the LogicalTrueSpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXLogicalTrueSpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXLogicalTrueSpecialValueTranslator)

        public:
            virtual ~LaTeXLogicalTrueSpecialValueTranslator();
