...
* \file
*
* This header defines the \ref Ld::LogicalFalseSpecialValueElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_FALSE_SPECIAL_VALUE_ELEMENT_H
#define LD_LOGICAL_FALSE_SPECIAL_VALUE_ELEMENT_H
...
namespace Ld {
    class LogicalFalseSpecialValueVisual;

    /**
     * Element that provides the "false" boolean value.
     */
    class LD_PUBLIC_API LogicalFalseSpecialValueElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalFalseSpecialValueElement)
        ...
        public:
            ...
            LogicalFalseSpecialValueElement();

            ~LogicalFalseSpecialValueElement() override;
             ...
             * \ref Ld::LogicalFalseSpecialValueElement instance.
             *
             * If the newly added \ref Ld::LogicalFalseSpecialValueVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Ld::LogicalFalseSpecialValueVisual instance and \ref Ld::LogicalFalseSpecialValueElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalFalseSpecialValueVisual* newVisual);
             ...
             */
            LogicalFalseSpecialValueVisual* visual() const;
    };
};
