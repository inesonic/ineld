...
* \file
*
* This header defines the \ref Ld::TextFileExportContext class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_TEXT_FILE_EXPORT_CONTEXT_H
#define LD_TEXT_FILE_EXPORT_CONTEXT_H
...
namespace Ld {
    /**
     * Class you can use to export contexts into one or more files.  All files will be placed in the same directory.
     */
    class LD_PUBLIC_API TextFileExportContext:public TextExportContext {
        Q_DECLARE_TR_FUNCTIONS(Ld::TextFileExportContext)

        public:
            /**
             * Constructor
             *
             * \param[in] outputFile     The name of the output file to contain the exported text.  The directory
             *                           specified for the output file will be used as the directory to contain the
             *                           payloads.
             *
             ...
             */
            TextFileExportContext(const QString& outputFile, bool allowOverwrite);

            ~TextFileExportContext() override;
        ...
        private:
            ...
            /**
             * The directory containing the output file and payloads.
             */
