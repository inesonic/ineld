...
* \file
*
* This header defines the \ref Ld::NotSupersetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_SUPERSET_OPERATOR_ELEMENT_H
#define LD_NOT_SUPERSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotSupersetOperatorVisual;

    /**
     * Element that provides support for the not superset operator.
     */
    class LD_PUBLIC_API NotSupersetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotSupersetOperatorElement)
        ...
        public:
            ...
            NotSupersetOperatorElement();

            ~NotSupersetOperatorElement() override;
             ...
             * \ref NotSupersetOperatorElement instance.
             *
             * If the newly added \ref NotSupersetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotSupersetOperatorVisual instance and \ref NotSupersetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotSupersetOperatorVisual* newVisual);
             ...
             */
            NotSupersetOperatorVisual* visual() const;
    };
};
