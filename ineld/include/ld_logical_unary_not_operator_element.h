...
* \file
*
* This header defines the \ref Ld::LogicalUnaryNotOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_UNARY_NOT_OPERATOR_ELEMENT_H
#define LD_LOGICAL_UNARY_NOT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalUnaryNotOperatorVisual;

    /**
     * Element that provides support for a unary logical negation operator.
     */
    class LD_PUBLIC_API LogicalUnaryNotOperatorElement:public UnaryLogicalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalUnaryNotOperatorElement)
        ...
        public:
            ...
            LogicalUnaryNotOperatorElement();

            ~LogicalUnaryNotOperatorElement() override;
             ...
             * \ref Ld::LogicalUnaryNotOperatorElement instance.
             *
             * If the newly added \ref LogicalUnaryNotOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalUnaryNotOperatorVisual instance and \ref LogicalUnaryNotOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalUnaryNotOperatorVisual* newVisual);
             ...
             */
            LogicalUnaryNotOperatorVisual* visual() const;
