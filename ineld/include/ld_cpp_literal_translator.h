...
* \file
*
* This header defines the \ref Ld::CppLiteralTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_LITERAL_TRANSLATOR_H
#define LD_CPP_LITERAL_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for literals.
     */
    class LD_PUBLIC_API CppLiteralTranslator:public CppTranslator {
        public:
            ~CppLiteralTranslator() override;
