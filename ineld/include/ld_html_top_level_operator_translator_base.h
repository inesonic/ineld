...
* \file
*
* This header defines the \ref Ld::HtmlTopLevelOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_TOP_LEVEL_OPERATOR_TRANSLATOR_BASE_H
#define LD_HTML_TOP_LEVEL_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for HTML translators to render top-level operators.
     */
    class LD_PUBLIC_API HtmlTopLevelOperatorTranslatorBase:public HtmlTranslator {
        public:
            ~HtmlTopLevelOperatorTranslatorBase() override;
