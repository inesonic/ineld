...
* \file
*
* This header defines the \ref Ld::TextVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_TEXT_VISUAL_H
#define LD_TEXT_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::TextElement instance.
     */
    class LD_PUBLIC_API TextVisual:public virtual VisualWithNoChildren {
        ...
        public:
             ...
             */
            QSharedPointer<TextElement> element() const;
        ...
        protected:
             ...
             */
            virtual void textChanged(const QString& newText);
    };
};
