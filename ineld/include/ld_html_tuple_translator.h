...
* \file
*
* This header defines the \ref Ld::HtmlTupleTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_TUPLE_TRANSLATOR_H
#define LD_HTML_TUPLE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::TupleElement class.
     */
    class LD_PUBLIC_API HtmlTupleTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlTupleTranslator)

        public:
            ~HtmlTupleTranslator() override;
