...
* \file
*
* This header defines the \ref Ld::CppRealDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_REAL_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_REAL_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ real data type translator.
     */
    class LD_PUBLIC_API CppRealDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppRealDataTypeTranslator instance;

            CppRealDataTypeTranslator();

            ~CppRealDataTypeTranslator() override;
