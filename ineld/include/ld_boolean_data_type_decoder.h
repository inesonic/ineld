...
* \file
*
* This header defines the \ref Ld::BooleanDataTypeDecoder class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BOOLEAN_DATA_TYPE_DECODER_H
#define LD_BOOLEAN_DATA_TYPE_DECODER_H
...
namespace Ld {
    ...
    /**
     * Class you can use to decode boolean values of the type Model::Boolean
     */
    class LD_PUBLIC_API BooleanDataTypeDecoder:public virtual DataTypeDecoder {
        Q_DECLARE_TR_FUNCTIONS(Ld::BooleanDataTypeDecoder)

        public:
            BooleanDataTypeDecoder();

            ~BooleanDataTypeDecoder() override;
