...
* \file
*
* This header defines the \ref Ld::GreaterThanOrEqualToOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_GREATER_THAN_OR_EQUAL_TO_OPERATOR_ELEMENT_H
#define LD_GREATER_THAN_OR_EQUAL_TO_OPERATOR_ELEMENT_H
...
namespace Ld {
    class GreaterThanOrEqualToOperatorVisual;

    /**
     * Element that provides support for the greater than or equal to operator.
     */
    class LD_PUBLIC_API GreaterThanOrEqualToOperatorElement:public BinaryScalarRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::GreaterThanOrEqualToOperatorElement)
        ...
        public:
            ...
            GreaterThanOrEqualToOperatorElement();

            ~GreaterThanOrEqualToOperatorElement() override;
             ...
             * \ref GreaterThanOrEqualToOperatorElement instance.
             *
             * If the newly added \ref GreaterThanOrEqualToOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref GreaterThanOrEqualToOperatorVisual instance and \ref GreaterThanOrEqualToOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(GreaterThanOrEqualToOperatorVisual* newVisual);
             ...
             */
            GreaterThanOrEqualToOperatorVisual* visual() const;
    };
};
