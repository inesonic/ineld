...
* \file
*
* This header defines the \ref Ld::LaTeXSquareRootOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SQUARE_ROOT_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SQUARE_ROOT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::SquareRootOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSquareRootOperatorTranslator:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSquareRootOperatorTranslator)

        public:
            ~LaTeXSquareRootOperatorTranslator() override;
