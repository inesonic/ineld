...
* \file
*
* This file defines the \ref Ld::HtmlGreaterThanOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_GREATER_THAN_OPERATOR_TRANSLATOR_H
#define LD_HTML_GREATER_THAN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::GreaterThanOperatorElement class.
     */
    class LD_PUBLIC_API HtmlGreaterThanOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlGreaterThanOperatorTranslator)

        public:
            ~HtmlGreaterThanOperatorTranslator() override;
