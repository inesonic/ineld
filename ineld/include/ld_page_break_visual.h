...
* \file
*
* This header defines the \ref Ld::PageBreakVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PAGE_BREAK_VISUAL_H
#define LD_PAGE_BREAK_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::PageBreakElement instance.
     */
    class LD_PUBLIC_API PageBreakVisual:public virtual VisualWithNoChildren {
        public:
            PageBreakVisual();

            ~PageBreakVisual() override;
             ...
             */
            QSharedPointer<PageBreakElement> element() const;
