...
* \file
*
* This header defines the \ref Ld::CppComplexDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_COMPLEX_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_COMPLEX_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ complex data type translator.
     */
    class LD_PUBLIC_API CppComplexDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppComplexDataTypeTranslator instance;

            CppComplexDataTypeTranslator();

            ~CppComplexDataTypeTranslator() override;
             ...
             * elements from the M::ValueType enumeration.  For example, the value returned for boolean types should
             * be "M::ValueType::BOOLEAN".
             *
