...
* \file
*
* This header defines the \ref Ld::BooleanDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BOOLEAN_DATA_TYPE_FORMAT_H
#define LD_BOOLEAN_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides format information to render boolean data type values.
     */
    class LD_PUBLIC_API BooleanDataTypeFormat:public virtual DataTypeFormat {
        public:
            /**
             * Enumeration of supported boolean presentation styles.
             */
            typedef Util::BooleanStyle BooleanStyle;

            /**
             * Class you can use to track an aggregation of multiple \ref Ld::BooleanDataTypeFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual DataTypeFormat::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to obtain all the displayed presentation styles.
                     *
                     * \return Returns a set of currently displayed boolean presentation styles.
                     */
                    QSet<BooleanStyle> booleanStyles() const;

                private:
                    /**
                     * The currently displayed boolean presentation styles.
                     */
                    QSet<BooleanStyle> currentStyles;
            };
            ...
            /**
             * The default boolean presentation style.
             */
            static const BooleanStyle defaultBooleanStyle;
             ...
             */
            BooleanDataTypeFormat(const BooleanDataTypeFormat& other);

            ~BooleanDataTypeFormat() override;
             ...
             *
             * \return Returns the format identifying name, in this case, "BooleanDataTypeFormat".
             */
            QString typeName() const override;
            ...
            /**
             * Method you can use to set the boolean presentation style.
             *
             * \param[in] newBooleanStyle The new presentation style for the boolean value.
             */
            void setBooleanStyle(BooleanStyle newBooleanStyle);

            /**
             * Method you can use to obtain the current boolean presentation style.
             *
             * \return Returns the current boolean presentation style.
             */
        ...
        private:
            /**
             * Method that converts a boolean presentation style to a string.
             *
             * \param[in] booleanStyle The boolean presentation style to be converted.
             *
             * \return Returns a string representation of the boolean presentation style.
             */
            static QString toString(BooleanStyle booleanStyle);

            /**
             * Method that converts a string to a boolean presentation style.
             *
             * \param[in]  str The string to convert.
             *
             * \param[out] ok  A boolean variable that will be populated with true on success, false on error.
             *
             * \return Returns the translated boolean presentation style.
             */
            static BooleanStyle toBooleanStyle(const QString& str, bool* ok = nullptr);

            /**
             * The current boolean presentation style.
             */
            BooleanStyle currentStyle;
    };
}
