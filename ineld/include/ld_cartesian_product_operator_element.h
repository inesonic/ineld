...
* \file
*
* This header defines the \ref Ld::CartesianProductOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CARTESIAN_PRODUCT_OPERATOR_ELEMENT_H
#define LD_CARTESIAN_PRODUCT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class CartesianProductOperatorVisual;

    /**
     * Element that provides support for cartesian products.
     */
    class LD_PUBLIC_API CartesianProductOperatorElement:public BinarySetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::CartesianProductOperatorElement)
        ...
        public:
            ...
            ~CartesianProductOperatorElement() override;
             ...
             * \ref CartesianProductOperatorElement instance.
             *
             * If the newly added \ref CartesianProductOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref CartesianProductOperatorVisual instance and \ref CartesianProductOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(CartesianProductOperatorVisual* newVisual);
             ...
             */
            CartesianProductOperatorVisual* visual() const;
