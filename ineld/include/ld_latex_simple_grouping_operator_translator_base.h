...
* \file
*
* This header defines the \ref Ld::LaTeXSimpleGroupingOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SIMPLE_GROUPING_OPERATOR_TRANSLATOR_BASE_H
#define LD_LATEX_SIMPLE_GROUPING_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for LaTeX translators for simple grouping operators.
     */
    class LD_PUBLIC_API LaTeXSimpleGroupingOperatorTranslatorBase:public LaTeXGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXGroupingOperatorTranslatorBase)

        public:
            ~LaTeXSimpleGroupingOperatorTranslatorBase() override;
