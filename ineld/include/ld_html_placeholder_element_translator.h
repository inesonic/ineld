...
#ifndef LD_HTML_PLACEHOLDER_ELEMENT_TRANSLATOR_H
#define LD_HTML_PLACEHOLDER_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::PlaceholderElement class.
     */
    class LD_PUBLIC_API HtmlPlaceholderElementTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlPlaceholderElementTranslator)

        public:
            ~HtmlPlaceholderElementTranslator() override;
