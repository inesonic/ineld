...
* \file
*
* This header defines the \ref Ld::CppPiSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_PI_SPECIAL_VALUE_TRANSLATOR_H
#define LD_CPP_PI_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::PiSpecialValueElement class.
     */
    class LD_PUBLIC_API CppPiSpecialValueTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppPiSpecialValueTranslator)

        public:
            virtual ~CppPiSpecialValueTranslator() override;
