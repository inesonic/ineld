...
* \file
*
* This header defines the \ref Ld::CppMatrixBooleanDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_MATRIX_BOOLEAN_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_MATRIX_BOOLEAN_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ boolean matrix data type translator.
     */
    class LD_PUBLIC_API CppMatrixBooleanDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppMatrixBooleanDataTypeTranslator instance;

            CppMatrixBooleanDataTypeTranslator();

            ~CppMatrixBooleanDataTypeTranslator() override;
             ...
             * should be "M::ValueType::MATRIX_BOOLEAN".
             *
