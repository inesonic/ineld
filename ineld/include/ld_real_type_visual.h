...
* \file
*
* This header defines the \ref Ld::RealTypeVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_REAL_TYPE_VISUAL_H
#define LD_REAL_TYPE_VISUAL_H
...
namespace Ld {
    class RealTypeElement;

    /**
     * Visual used to interact with a \ref Ld::RealTypeElement instance.
     */
    class LD_PUBLIC_API RealTypeVisual:public virtual VisualWithNoChildren {
        public:
            RealTypeVisual();

            ~RealTypeVisual() override;
             ...
             */
            QSharedPointer<RealTypeElement> element() const;
