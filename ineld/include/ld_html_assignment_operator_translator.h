...
* \file
*
* This header defines the \ref Ld::HtmlAssignmentOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ASSIGNMENT_OPERATOR_TRANSLATOR_H
#define LD_HTML_ASSIGNMENT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::AssignmentOperatorElement class.
     */
    class LD_PUBLIC_API HtmlAssignmentOperatorTranslator:public HtmlTopLevelOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlAssignmentOperatorTranslator)

        public:
            ~HtmlAssignmentOperatorTranslator() override;
