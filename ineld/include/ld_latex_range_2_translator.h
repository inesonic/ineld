...
* \file
*
* This header defines the \ref Ld::LaTeXRange2Translator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_RANGE_2_TRANSLATOR_H
#define LD_LATEX_RANGE_2_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::Range2Element.
     */
    class LD_PUBLIC_API LaTeXRange2Translator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXRange2Translator)

        public:
            ~LaTeXRange2Translator() override;
        ...
        private:
             ...
             */
            QString latexOperator(FormatPointer operatorFormat) const final;
    };
};
