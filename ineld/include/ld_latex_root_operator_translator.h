...
* \file
*
* This header defines the \ref Ld::LaTeXRootOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_ROOT_OPERATOR_TRANSLATOR_H
#define LD_LATEX_ROOT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::RootOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXRootOperatorTranslator:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXRootOperatorTranslator)

        public:
            ~LaTeXRootOperatorTranslator() override;
