...
* \file
*
* This header defines the \ref Ld::FractionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_FRACTION_OPERATOR_ELEMENT_H
#define LD_FRACTION_OPERATOR_ELEMENT_H
...
namespace Ld {
    ...
    /**
     * Element that provides support for the fraction operator.  The first child represent the numerator and the second
     * child represents the denominator.
     */
    class LD_PUBLIC_API FractionOperatorElement:public DivisionOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::FractionOperatorElement)
        ...
        public:
            ...
            FractionOperatorElement();

            ~FractionOperatorElement() override;
             ...
             * \ref FractionOperatorElement instance.
             *
             ...
             * \ref DivisionOperatorVisual instance and \ref FractionOperatorElement instance.
             *
