...
* \file
*
* This header defines the \ref Ld::LogicalExclusiveOrOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_EXCLUSIVE_OR_OPERATOR_ELEMENT_H
#define LD_LOGICAL_EXCLUSIVE_OR_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalExclusiveOrOperatorVisual;

    /**
     * Element that provides support for the logical exclusive OR operation.
     */
    class LD_PUBLIC_API LogicalExclusiveOrOperatorElement:public BinaryLogicalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalExclusiveOrOperatorElement)
        ...
        public:
            ...
            LogicalExclusiveOrOperatorElement();

            ~LogicalExclusiveOrOperatorElement() override;
             ...
             * \ref LogicalExclusiveOrOperatorElement instance.
             *
             * If the newly added \ref LogicalExclusiveOrOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalExclusiveOrOperatorVisual instance and \ref LogicalExclusiveOrOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalExclusiveOrOperatorVisual* newVisual);
             ...
             */
            LogicalExclusiveOrOperatorVisual* visual() const;
