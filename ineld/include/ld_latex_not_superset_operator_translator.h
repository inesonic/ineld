...
* \file
*
* This header defines the \ref Ld::LaTeXNotSupersetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_NOT_SUPERSET_OPERATOR_TRANSLATOR_H
#define LD_LATEX_NOT_SUPERSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::NotSupersetOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXNotSupersetOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXNotSupersetOperatorTranslator)

        public:
            ~LaTeXNotSupersetOperatorTranslator() override;
