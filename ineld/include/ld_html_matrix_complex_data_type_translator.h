...
* \file
*
* This header defines the \ref Ld::HtmlMatrixComplexDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_MATRIX_COMPLEX_DATA_TYPE_TRANSLATOR_H
#define LD_HTML_MATRIX_COMPLEX_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    /**
     * HTML data type translator for complex matrix values.
     */
    class LD_PUBLIC_API HtmlMatrixComplexDataTypeTranslator:public HtmlMatrixDataTypeTranslator {
        public:
            /**
             * Context used to translate a complex matrix to HTML.
             */
             ...
             * Static instance.
             */
            static const HtmlMatrixComplexDataTypeTranslator instance;

            HtmlMatrixComplexDataTypeTranslator();

            ~HtmlMatrixComplexDataTypeTranslator() override;
