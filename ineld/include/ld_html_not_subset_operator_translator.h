...
* \file
*
* This file defines the \ref Ld::HtmlNotSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotSubsetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotSubsetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotSubsetOperatorTranslator)

        public:
            ~HtmlNotSubsetOperatorTranslator() override;
