...
* \file
*
* This header defines the \ref Ld::IntegerTypeElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_INTEGER_TYPE_ELEMENT_H
#define LD_INTEGER_TYPE_ELEMENT_H
...
namespace Ld {
    class IntegerTypeVisual;

    /**
     * Element that is used to represent the set of integer values.
     */
    class LD_PUBLIC_API IntegerTypeElement:public DataTypeElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::IntegerTypeElement)
        ...
        public:
             ...
             * \ref IntegerTypeElement instance.
             *
             * If the newly added \ref IntegerTypeVisual already points to a different element, then those connections
             * will be broken in order to maintain a 1:1 relationship between any \ref IntegerTypeVisual instance and
             * \ref IntegerTypeElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(IntegerTypeVisual* newVisual);
             ...
             */
            IntegerTypeVisual* visual() const;
    };
};
