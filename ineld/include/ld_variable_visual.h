...
* \file
*
* This header defines the \ref Ld::VariableVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_VARIABLE_VISUAL_H
#define LD_VARIABLE_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::VariableElement instance.
     */
    class LD_PUBLIC_API VariableVisual:public virtual VisualWithNoChildren {
        friend class VariableElement;

        public:
            VariableVisual();

            ~VariableVisual() override;
             ...
             */
            QSharedPointer<VariableElement> element() const;
