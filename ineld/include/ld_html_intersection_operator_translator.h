...
* \file
*
* This file defines the \ref Ld::HtmlIntersectionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_INTERSECTION_OPERATOR_TRANSLATOR_H
#define LD_HTML_INTERSECTION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::IntersectionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlIntersectionOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlIntersectionOperatorTranslator)

        public:
            ~HtmlIntersectionOperatorTranslator() override;
