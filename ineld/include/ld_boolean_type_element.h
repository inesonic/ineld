...
* \file
*
* This header defines the \ref Ld::BooleanTypeElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BOOLEAN_TYPE_ELEMENT_H
#define LD_BOOLEAN_TYPE_ELEMENT_H
...
namespace Ld {
    class BooleanTypeVisual;

    /**
     * Element that is used to represent the set of boolean values.
     */
    class LD_PUBLIC_API BooleanTypeElement:public DataTypeElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::BooleanTypeElement)
        ...
        public:
             ...
             * \ref BooleanTypeElement instance.
             *
             * If the newly added \ref BooleanTypeVisual already points to a different element, then those connections
             * will be broken in order to maintain a 1:1 relationship between any \ref BooleanTypeVisual instance and
             * \ref BooleanTypeElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(BooleanTypeVisual* newVisual);
             ...
             */
            BooleanTypeVisual* visual() const;
    };
};
