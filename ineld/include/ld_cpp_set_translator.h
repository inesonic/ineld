...
* \file
*
* This header defines the \ref Ld::CppSetTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_SET_TRANSLATOR_H
#define LD_CPP_SET_TRANSLATOR_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API CppSetTranslator:public CppTranslator {
        public:
            ~CppSetTranslator() override;
