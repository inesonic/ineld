...
* \file
*
* This header defines the \ref Ld::FactorialOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_FACTORIAL_OPERATOR_ELEMENT_H
#define LD_FACTORIAL_OPERATOR_ELEMENT_H
...
namespace Ld {
    class FactorialOperatorVisual;

    /**
     * Element that provides support for a factorial operation.
     */
    class LD_PUBLIC_API FactorialOperatorElement:public UnaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::FactorialOperatorElement)
        ...
        public:
            ...
            FactorialOperatorElement();

            ~FactorialOperatorElement() override;
            ...
            /**
             * Method you can use to determine the value type this element represents.
             *
             * \return Returns the value type this element would represent.  This version returns
             ...
             * \ref Ld::FactorialOperatorElement instance.
             *
             * If the newly added \ref FactorialOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref FactorialOperatorVisual instance and \ref FactorialOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(FactorialOperatorVisual* newVisual);
             ...
             */
            FactorialOperatorVisual* visual() const;
    };
};
