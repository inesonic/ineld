...
* \file
*
* This header defines the \ref Ld::HtmlMatrixTransposeOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_MATRIX_TRANSPOSE_OPERATOR_TRANSLATOR_H
#define LD_HTML_MATRIX_TRANSPOSE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::MatrixTransposeOperatorElement class.
     */
    class LD_PUBLIC_API HtmlMatrixTransposeOperatorTranslator:public HtmlUnarySuperscriptOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlMatrixTransposeOperatorTranslator)

        public:
            ~HtmlMatrixTransposeOperatorTranslator() override;
