...
* \file
*
* This header defines the \ref Ld::LaTeXElseOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_ELSE_OPERATOR_TRANSLATOR_H
#define LD_LATEX_ELSE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::ElseOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXElseOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXElseOperatorTranslator)

        public:
            ~LaTeXElseOperatorTranslator() override;
