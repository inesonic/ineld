...
* \file
*
* This header defines the \ref Ld::HtmlImageTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_IMAGE_TRANSLATOR_BASE_H
#define LD_HTML_IMAGE_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * HTML translator base class for the items that always embed as images.
     */
    class LD_PUBLIC_API HtmlImageTranslatorBase:public HtmlTranslator {
        public:
            ~HtmlImageTranslatorBase() override;
