...
* \file
*
* This header defines the \ref Ld::HtmlBooleanTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_BOOLEAN_TYPE_TRANSLATOR_H
#define LD_HTML_BOOLEAN_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::BooleanTypeElement class.
     */
    class LD_PUBLIC_API HtmlBooleanTypeTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlBooleanTypeTranslator)

        public:
            ~HtmlBooleanTypeTranslator() override;
