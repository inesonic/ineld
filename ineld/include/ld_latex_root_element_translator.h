...
* \file
*
* This header defines the \ref Ld::LaTeXRootElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_ROOT_ELEMENT_TRANSLATOR_H
#define LD_LATEX_ROOT_ELEMENT_TRANSLATOR_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API LaTeXRootElementTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXRootElementTranslator)

        public:
            ~LaTeXRootElementTranslator() override;
