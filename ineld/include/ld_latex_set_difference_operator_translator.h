...
* \file
*
* This header defines the \ref Ld::LaTeXSetDifferenceOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SET_DIFFERENCE_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SET_DIFFERENCE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SetDifferenceOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSetDifferenceOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSetDifferenceOperatorTranslator)

        public:
            ~LaTeXSetDifferenceOperatorTranslator() override;
