...
* \file
*
* This header defines the \ref Ld::NotProperSubsetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_PROPER_SUBSET_OPERATOR_ELEMENT_H
#define LD_NOT_PROPER_SUBSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotProperSubsetOperatorVisual;

    /**
     * Element that provides the not proper subset operator element.
     */
    class LD_PUBLIC_API NotProperSubsetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotProperSubsetOperatorElement)
        ...
        public:
            ...
            NotProperSubsetOperatorElement();

            ~NotProperSubsetOperatorElement() override;
             ...
             * \ref NotProperSubsetOperatorElement instance.
             *
             * If the newly added \ref NotProperSubsetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotProperSubsetOperatorVisual instance and \ref NotProperSubsetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotProperSubsetOperatorVisual* newVisual);
             ...
             */
            NotProperSubsetOperatorVisual* visual() const;
    };
};
