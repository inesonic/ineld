...
* \file
*
* This header defines the \ref Ld::ElementOfSetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ELEMENT_OF_SET_OPERATOR_ELEMENT_H
#define LD_ELEMENT_OF_SET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ElementOfSetOperatorVisual;

    /**
     * Element that is used to represent a set operator.
     */
    class LD_PUBLIC_API ElementOfSetOperatorElement:public BinaryRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ElementOfSetOperatorElement)
        ...
        public:
            ...
            ElementOfSetOperatorElement();

            ~ElementOfSetOperatorElement() override;
             ...
             *         top level operator.  This version returns true if this operator is being used as a type
             *         definition, returns false if this operator is being used as a relational operator.
             */
             ...
             * \ref ElementOfSetOperatorElement instance.
             *
             * If the newly added \ref ElementOfSetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ElementOfSetOperatorVisual instance and \ref ElementOfSetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ElementOfSetOperatorVisual* newVisual);
             ...
             */
            ElementOfSetOperatorVisual* visual() const;
        ...
        private:
            /**
             * Method that determines if this element is being used as an typing operator or a relational operator.
             *
             * \return Returns true if the operator is being used as a relational operator.  Returns false if the
             *         operator is being used as a variable typing operator.
             */
