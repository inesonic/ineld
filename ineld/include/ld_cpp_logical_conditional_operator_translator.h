...
* \file
*
* This header defines the \ref Ld::CppLogicalConditionalOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_LOGICAL_CONDITIONAL_OPERATOR_TRANSLATOR_H
#define LD_CPP_LOGICAL_CONDITIONAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::LogicalConditionalOperatorElement class.
     */
    class LD_PUBLIC_API CppLogicalConditionalOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppLogicalConditionalOperatorTranslator)

        public:
            ~CppLogicalConditionalOperatorTranslator() override;
