...
* \file
*
* This header defines the \ref Ld::CppNearestIntegerOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_NEAREST_INTEGER_OPERATOR_TRANSLATOR_H
#define LD_CPP_NEAREST_INTEGER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator class for the \ref Ld::NearestIntegerOperatorElement class.
     */
    class LD_PUBLIC_API CppNearestIntegerOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppNearestIntegerOperatorTranslator)

        public:
            ~CppNearestIntegerOperatorTranslator() override;
