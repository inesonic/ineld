...
* \file
*
* This header defines the \ref Ld::SetVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SET_VISUAL_H
#define LD_SET_VISUAL_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API SetVisual:public virtual VisualWithPositionalChildren {
        public:
            SetVisual();
             ...
             */
            QSharedPointer<SetElement> element() const;
