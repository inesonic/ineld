...
* \file
*
* This header defines the \ref Ld::CeilingOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CEILING_OPERATOR_ELEMENT_H
#define LD_CEILING_OPERATOR_ELEMENT_H
...
namespace Ld {
    class CeilingOperatorVisual;

    /**
     * Element that provides support for a ceiling operation.
     */
    class LD_PUBLIC_API CeilingOperatorElement:public NumericGroupingOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::CeilingOperatorElement)
        ...
        public:
            ...
            CeilingOperatorElement();

            ~CeilingOperatorElement() override;
             ...
             * \ref Ld::CeilingOperatorElement instance.
             *
             * If the newly added \ref CeilingOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref CeilingOperatorVisual instance and \ref CeilingOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(CeilingOperatorVisual* newVisual);
             ...
             */
            CeilingOperatorVisual* visual() const;
    };
};
