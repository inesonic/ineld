...
* \file
*
* This header defines the \ref Ld::AbsoluteValueOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ABSOLUTE_VALUE_OPERATOR_ELEMENT_H
#define LD_ABSOLUTE_VALUE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class AbsoluteValueOperatorVisual;

    /**
     * Element that provides support for an absolute value function.  You can also use this element to calculate the
     * magnitude of a complex value, determinate of a matrix, or the cardinality of a set.
     */
    class LD_PUBLIC_API AbsoluteValueOperatorElement:public GroupingOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::AbsoluteValueOperatorElement)
        ...
        public:
            ...
            AbsoluteValueOperatorElement();

            ~AbsoluteValueOperatorElement() override;
             ...
             *
             * \return Returns the value type this element would represent.  This version will return
             *         Ld::DataType::ValueType::INTEGER for set and integer based children,
             *         Ld::DataType::ValueType::REAL for real and complex types.  For matrix types, this method will
             *         look at the matrix contents to determine the return type.
             */
             ...
             * \ref Ld::AbsoluteValueOperatorElement instance.
             *
             * If the newly added \ref AbsoluteValueOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref AbsoluteValueOperatorVisual instance and \ref AbsoluteValueOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(AbsoluteValueOperatorVisual* newVisual);
             ...
             */
            AbsoluteValueOperatorVisual* visual() const;
    };
};
