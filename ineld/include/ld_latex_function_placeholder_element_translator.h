...
* \file
*
* This header defines the \ref Ld::LaTeXFunctionPlaceholderElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_FUNCTION_PLACEHOLDER_ELEMENT_TRANSLATOR_H
#define LD_LATEX_FUNCTION_PLACEHOLDER_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the function placeholder element.
     */
    class LD_PUBLIC_API LaTeXFunctionPlaceholderElementTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXFunctionPlaceholderElementTranslator)

        public:
            ~LaTeXFunctionPlaceholderElementTranslator() override;
