...
* \file
*
* This header defines the \ref Ld::DivisionOperatorFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_DIVISION_OPERATOR_FORMAT_H
#define LD_DIVISION_OPERATOR_FORMAT_H
...
namespace Ld {
    /**
     * Class used to track the division operator format.  This class extends the \ref Ld::OperatorFormat class to
     * include support for different division symbols.
     */
    class LD_PUBLIC_API DivisionOperatorFormat:public OperatorFormat {
        public:
            /**
             * Enumeration of different division symbol styles.
             */
            enum class DivisionSymbol: quint8 {
                /**
                 * Indicates an invalid division symbol.
                 */
                INVALID,

                /**
                 * Indicates the application should use the default division symbol for the type.
                 */
                DEFAULT,

                /**
                 * Indicates an obelus symbol.
                 *
                 */
                OBELUS,

                /**
                 * Indicates a fractional divsion.
                 */
                FRACTION,
            };
            ...
            class LD_PUBLIC_API Aggregation:public virtual OperatorFormat::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to obtain a set of division symbols across the aggregation.
                     *
                     * \return Returns a set of division symbols found across the aggregation.
                     */
                    QSet<DivisionOperatorFormat::DivisionSymbol> divisionSymbols() const;

                private:
                    /*
                     * Set of division symbols.
                     */
                    QSet<DivisionOperatorFormat::DivisionSymbol> currentDivisionSymbols;
            };
            ...
            /**
             * The default division symbol.
             */
            static const DivisionOperatorFormat::DivisionSymbol defaultDivisionSymbol;

            DivisionOperatorFormat();
             ...
             */
            DivisionOperatorFormat(const DivisionOperatorFormat& other);

            ~DivisionOperatorFormat() override;
            ...
            /**
             * Method you can use to set the division symbol.
             *
             * \param[in] newDivisionSymbol The new division symbol.
             */
            void setDivisionSymbol(DivisionSymbol newDivisionSymbol);

            /**
             * Method you can use to determine current division symbol.
             *
             * \return The current division symbol.
             */
        ...
        private:
            /**
             * The current division symbol.
             */
            DivisionSymbol currentDivisionSymbol;
    };

    /**
     * Hash function used to generate hashes of division symbols.
     *
     ...
     */
    LD_PUBLIC_API Util::HashResult qHash(DivisionOperatorFormat::DivisionSymbol symbol, Util::HashSeed seed = 0);
};
