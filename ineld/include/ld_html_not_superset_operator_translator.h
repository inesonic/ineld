...
* \file
*
* This file defines the \ref Ld::HtmlNotSupersetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_SUPERSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_SUPERSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotSupersetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotSupersetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotSupersetOperatorTranslator)

        public:
            ~HtmlNotSupersetOperatorTranslator() override;
