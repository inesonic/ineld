...
* \file
*
* This header defines the \ref Ld::LaTeXNaryUnionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_NARY_UNION_OPERATOR_TRANSLATOR_H
#define LD_LATEX_NARY_UNION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::NaryUnionOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXNaryUnionOperatorTranslator:public LaTeXUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXNaryUnionOperatorTranslator)

        public:
            ~LaTeXNaryUnionOperatorTranslator() override;
