...
* \file
*
* This header defines the \ref Ld::HtmlGroupingOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_GROUPING_OPERATOR_TRANSLATOR_BASE_H
#define LD_HTML_GROUPING_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for HTML translators for grouping operators.
     */
    class LD_PUBLIC_API HtmlGroupingOperatorTranslatorBase:public HtmlOperatorTranslatorBase {
        public:
            ~HtmlGroupingOperatorTranslatorBase() override;
        ...
        protected:
            /**
             * Pure virtual method you should overload to provide the MathML left parenthesis character.
             *
             * \param[in] element The element representing this operator.
             *
             * \return Returns the MathML character for the left parenthesis.
             */
            virtual QString mathMlLeftParenthesis(ElementPointer element) const = 0;

            /**
             * Pure virtual method you should overload to provide the MathML right parenthesis character.
             *
             * \param[in] element The element representing this operator.
             *
             * \return Returns the MathML character for the right parenthesis.
             */
            virtual QString mathMlRightParenthesis(ElementPointer element) const = 0;
