...
* \file
*
* This header defines the \ref Ld::CppTextElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_TEXT_ELEMENT_TRANSLATOR_H
#define LD_CPP_TEXT_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for the text element.
     */
    class LD_PUBLIC_API CppTextElementTranslator:public CppTranslator {
        public:
            ~CppTextElementTranslator() override;
