...
* \file
*
* This header defines the \ref Ld::LaTeXIfOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_IF_OPERATOR_TRANSLATOR_H
#define LD_LATEX_IF_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::IfOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXIfOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXIfOperatorTranslator)

        public:
            ~LaTeXIfOperatorTranslator() override;
