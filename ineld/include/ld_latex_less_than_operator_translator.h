...
* \file
*
* This header defines the \ref Ld::LaTeXLessThanOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_LESS_THAN_OPERATOR_TRANSLATOR_H
#define LD_LATEX_LESS_THAN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::LessThanOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXLessThanOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXLessThanOperatorTranslator)

        public:
            ~LaTeXLessThanOperatorTranslator() override;
