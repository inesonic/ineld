...
* \file
*
* This header defines the \ref Ld::LaTeXThereforeOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_THEREFORE_OPERATOR_TRANSLATOR_H
#define LD_LATEX_THEREFORE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::ThereforeOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXThereforeOperatorTranslator:public LaTeXUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXThereforeOperatorTranslator)

        public:
            ~LaTeXThereforeOperatorTranslator() override;
