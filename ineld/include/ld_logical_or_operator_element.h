...
* \file
*
* This header defines the \ref Ld::LogicalOrOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_OR_OPERATOR_ELEMENT_H
#define LD_LOGICAL_OR_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalOrOperatorVisual;

    /**
     * Element that provides support for logical OR operations.
     */
    class LD_PUBLIC_API LogicalOrOperatorElement:public BinaryLogicalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalOrOperatorElement)
        ...
        public:
            ...
            LogicalOrOperatorElement();

            ~LogicalOrOperatorElement() override;
             ...
             * \ref LogicalOrOperatorElement instance.
             *
             * If the newly added \ref LogicalOrOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalOrOperatorVisual instance and \ref LogicalOrOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalOrOperatorVisual* newVisual);
             ...
             */
            LogicalOrOperatorVisual* visual() const;
