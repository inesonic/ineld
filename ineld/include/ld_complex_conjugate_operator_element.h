...
* \file
*
* This header defines the \ref Ld::ComplexConjugateOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_COMPLEX_CONJUGATE_OPERATOR_ELEMENT_H
#define LD_COMPLEX_CONJUGATE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ComplexConjugateOperatorVisual;

    /**
     * Element that provides support for the complex conjugate operation.
     */
    class LD_PUBLIC_API ComplexConjugateOperatorElement:public UnaryNumericAndMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ComplexConjugateOperatorElement)
        ...
        public:
            ...
            ComplexConjugateOperatorElement();

            ~ComplexConjugateOperatorElement() override;
             ...
             * \ref Ld::ComplexConjugateOperatorElement instance.
             *
             * If the newly added \ref ComplexConjugateOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ComplexConjugateOperatorVisual instance and \ref ComplexConjugateOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ComplexConjugateOperatorVisual* newVisual);
             ...
             */
            ComplexConjugateOperatorVisual* visual() const;
    };
};
