...
* \file
*
* This header defines the \ref Ld::CppTupleDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_TUPLE_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_TUPLE_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ tuple data type translator.
     */
    class LD_PUBLIC_API CppTupleDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppTupleDataTypeTranslator instance;

            CppTupleDataTypeTranslator();

            ~CppTupleDataTypeTranslator() override;
