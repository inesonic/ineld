...
* \file
*
* This header defines the \ref Ld::LaTeXSetTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SET_TRANSLATOR_H
#define LD_LATEX_SET_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SetElement.
     */
    class LD_PUBLIC_API LaTeXSetTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSetTranslator)

        public:
            ~LaTeXSetTranslator() override;
