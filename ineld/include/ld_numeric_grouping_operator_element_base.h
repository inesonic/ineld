...
* \file
*
* This header defines the \ref Ld::NumericGroupingOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NUMERIC_GROUPING_OPERATOR_ELEMENT_BASE_H
#define LD_NUMERIC_GROUPING_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for grouping operators such as parenthesis that perform computation on a numeric value.
     */
    class LD_PUBLIC_API NumericGroupingOperatorElementBase:public GroupingOperatorElementBase {
        public:
            /**
            ...
            NumericGroupingOperatorElementBase();

            ~NumericGroupingOperatorElementBase() override;
        ...
        private:
            /**
             * Table of type conversion rules.
             */
            static const DataType::ValueType allowedConversions[DataType::numberValueTypes];
    };
};
