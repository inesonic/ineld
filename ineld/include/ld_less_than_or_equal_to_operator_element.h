...
* \file
*
* This header defines the \ref Ld::LessThanOrEqualToOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LESS_THAN_OR_EQUAL_TO_OPERATOR_ELEMENT_H
#define LD_LESS_THAN_OR_EQUAL_TO_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LessThanOrEqualToOperatorVisual;

    /**
     * Element that provides the less than or equal to operator.
     */
    class LD_PUBLIC_API LessThanOrEqualToOperatorElement:public BinaryScalarRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LessThanOrEqualToOperatorElement)
        ...
        public:
            ...
            LessThanOrEqualToOperatorElement();

            ~LessThanOrEqualToOperatorElement() override;
             ...
             *         in the plug-in data structure.  Elements defined as part of the ineld library should return an
             *         empty string.
             */
             ...
             * \ref LessThanOrEqualToOperatorElement instance.
             *
             * If the newly added \ref LessThanOrEqualToOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LessThanOrEqualToOperatorVisual instance and \ref LessThanOrEqualToOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LessThanOrEqualToOperatorVisual* newVisual);
             ...
             */
            LessThanOrEqualToOperatorVisual* visual() const;
    };
};
