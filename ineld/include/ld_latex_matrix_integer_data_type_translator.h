...
* \file
*
* This header defines the \ref Ld::LaTeXMatrixIntegerDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_MATRIX_INTEGER_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_MATRIX_INTEGER_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * Class that translates integer matrix values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXMatrixIntegerDataTypeTranslator:public virtual LaTeXMatrixDataTypeTranslator {
        public:
            /**
             * Context used to translate an integer matrix to HTML.
             */
             ...
             * Static instance.
             */
            static const LaTeXMatrixIntegerDataTypeTranslator instance;

            LaTeXMatrixIntegerDataTypeTranslator();

            ~LaTeXMatrixIntegerDataTypeTranslator() override;
