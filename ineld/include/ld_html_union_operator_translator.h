...
* \file
*
* This file defines the \ref Ld::HtmlUnionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_UNION_OPERATOR_TRANSLATOR_H
#define LD_HTML_UNION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::UnionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlUnionOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlUnionOperatorTranslator)

        public:
            ~HtmlUnionOperatorTranslator() override;
