...
* \file
*
* This header defines the \ref Ld::CppSubscriptRowColumnOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_SUBSCRIPT_ROW_COLUMN_OPERATOR_TRANSLATOR_H
#define LD_CPP_SUBSCRIPT_ROW_COLUMN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::SubscriptRowColumnOperatorElement class.
     */
    class LD_PUBLIC_API CppSubscriptRowColumnOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppSubscriptRowColumnOperatorTranslator)

        public:
            ~CppSubscriptRowColumnOperatorTranslator() override;
