...
* \file
*
* This header defines the \ref Ld::LaTeXCompoundStatementOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_COMPOUND_STATEMENT_OPERATOR_TRANSLATOR_H
#define LD_LATEX_COMPOUND_STATEMENT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::CompoundStatementOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXCompoundStatementOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXCompoundStatementOperatorTranslator)

        public:
            ~LaTeXCompoundStatementOperatorTranslator() override;
