...
* \file
*
* This header defines the \ref Ld::LogicalAndOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_AND_OPERATOR_ELEMENT_H
#define LD_LOGICAL_AND_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalAndOperatorVisual;

    /**
     * Element that represents a logical AND operation.
     */
    class LD_PUBLIC_API LogicalAndOperatorElement:public BinaryLogicalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalAndOperatorElement)
        ...
        public:
            ...
            LogicalAndOperatorElement();

            ~LogicalAndOperatorElement() override;
             ...
             * \ref LogicalAndOperatorElement instance.
             *
             * If the newly added \ref LogicalAndOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalAndOperatorVisual instance and \ref LogicalAndOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalAndOperatorVisual* newVisual);
             ...
             */
            LogicalAndOperatorVisual* visual() const;
