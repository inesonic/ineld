...
* \file
*
* This header defines the \ref Ld::CppBinaryOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_BINARY_OPERATOR_TRANSLATOR_BASE_H
#define LD_CPP_BINARY_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * C++ translator for basic operators with 1:1 correspondence with C operators.
     */
    class LD_PUBLIC_API CppBinaryOperatorTranslatorBase:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppBinaryOperatorTranslatorBase)

        public:
            ~CppBinaryOperatorTranslatorBase() override;
