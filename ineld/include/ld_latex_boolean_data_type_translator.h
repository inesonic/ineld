...
* \file
*
* This header defines the \ref Ld::LaTeXBooleanDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_BOOLEAN_DATA_TYPE_TRANSLATOR_H
#define LD_LATEX_BOOLEAN_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * Class that translates boolean values to LaTeX.
     */
    class LD_PUBLIC_API LaTeXBooleanDataTypeTranslator:public LaTeXDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const LaTeXBooleanDataTypeTranslator instance;

            LaTeXBooleanDataTypeTranslator();

            ~LaTeXBooleanDataTypeTranslator() override;
