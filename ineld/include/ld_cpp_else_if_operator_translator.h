...
* \file
*
* This header defines the \ref Ld::CppElseIfOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_ELSE_IF_OPERATOR_TRANSLATOR_H
#define LD_CPP_ELSE_IF_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::ElseIfOperatorElement class.
     */
    class LD_PUBLIC_API CppElseIfOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppElseIfOperatorTranslator)

        public:
            ~CppElseIfOperatorTranslator() override;
