...
* \file
*
* This header defines the \ref Ld::UnaryMatrixOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNARY_MATRIX_OPERATOR_ELEMENT_BASE_H
#define LD_UNARY_MATRIX_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for operator elements with a single child that accepts and provides a matrix value.
     */
    class LD_PUBLIC_API UnaryMatrixOperatorElementBase:public UnaryOperatorElementBase {
        public:
            /**
            ...
            UnaryMatrixOperatorElementBase();

            ~UnaryMatrixOperatorElementBase() override;
