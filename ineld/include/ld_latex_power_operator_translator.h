...
* \file
*
* This header defines the \ref Ld::LaTeXPowerOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_POWER_OPERATOR_TRANSLATOR_H
#define LD_LATEX_POWER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::PowerOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXPowerOperatorTranslator:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXPowerOperatorTranslator)

        public:
            ~LaTeXPowerOperatorTranslator() override;
