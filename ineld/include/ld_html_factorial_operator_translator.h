...
* \file
*
* This header defines the \ref Ld::HtmlFactorialOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_FACTORIAL_OPERATOR_TRANSLATOR_H
#define LD_HTML_FACTORIAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::FactorialOperatorElement class.
     */
    class LD_PUBLIC_API HtmlFactorialOperatorTranslator:public HtmlUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlFactorialOperatorTranslator)

        public:
            ~HtmlFactorialOperatorTranslator() override;
        ...
        protected:
             ...
             *
             * \return Returns true if the operator should precede.  This version returns false.
             */
