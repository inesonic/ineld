...
* \file
*
* This header defines the \ref Ld::CppIntegerDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_INTEGER_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_INTEGER_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ integer data type translator.
     */
    class LD_PUBLIC_API CppIntegerDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppIntegerDataTypeTranslator instance;

            CppIntegerDataTypeTranslator();

            ~CppIntegerDataTypeTranslator() override;
