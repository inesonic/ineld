...
* \file
*
* This header defines the \ref Ld::HtmlImageElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_IMAGE_ELEMENT_TRANSLATOR_H
#define LD_HTML_IMAGE_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ImageElement class.
     */
    class LD_PUBLIC_API HtmlImageElementTranslator:public HtmlImageTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlImageElementTranslator)

        public:
            ~HtmlImageElementTranslator() override;
        ...
        protected:
            /**
             * Method you should overload to provide the required image rotation setting.  This method is only used
             ...
             */
            Format::Rotation getImageRotation(
