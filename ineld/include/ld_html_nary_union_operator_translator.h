...
* \file
*
* This header defines the \ref Ld::HtmlNaryUnionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NARY_UNION_OPERATOR_TRANSLATOR_H
#define LD_HTML_NARY_UNION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NaryUnionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNaryUnionOperatorTranslator:public HtmlUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNaryUnionOperatorTranslator)

        public:
            ~HtmlNaryUnionOperatorTranslator() override;
