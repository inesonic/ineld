...
* \file
*
* This header defines the \ref Ld::LaTeXComplexTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_COMPLEX_TYPE_TRANSLATOR_H
#define LD_LATEX_COMPLEX_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the complex type element.
     */
    class LD_PUBLIC_API LaTeXComplexTypeTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXComplexTypeTranslator)

        public:
            ~LaTeXComplexTypeTranslator() override;
