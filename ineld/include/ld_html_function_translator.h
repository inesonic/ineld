...
* \file
*
* This header defines the \ref Ld::HtmlFunctionTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_FUNCTION_TRANSLATOR_H
#define LD_HTML_FUNCTION_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::FunctionElement class.
     */
    class LD_PUBLIC_API HtmlFunctionTranslator:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlFunctionTranslator)

        public:
            ~HtmlFunctionTranslator() override;
             ...
             */
            bool header(ElementPointer element, HtmlCodeGenerationEngine& generationEngine) final;
