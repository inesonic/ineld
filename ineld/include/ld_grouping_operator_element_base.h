...
* \file
*
* This header defines the \ref Ld::GroupingOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_GROUPING_OPERATOR_ELEMENT_BASE_H
#define LD_GROUPING_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for grouping operators such as parenthesis.
     */
    class LD_PUBLIC_API GroupingOperatorElementBase:public UnaryOperatorElementBase {
        public:
            GroupingOperatorElementBase();

            ~GroupingOperatorElementBase() override;
             ...
             *         \ref Ld::Element::groupingOperatorPrecedence.
             */
