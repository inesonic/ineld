...
* \file
*
* This header defines the \ref Ld::CppMatrixIntegerDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_MATRIX_INTEGER_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_MATRIX_INTEGER_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ integer matrix data type translator.
     */
    class LD_PUBLIC_API CppMatrixIntegerDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppMatrixIntegerDataTypeTranslator instance;

            CppMatrixIntegerDataTypeTranslator();

            ~CppMatrixIntegerDataTypeTranslator() override;
             ...
             * elements from the M::ValueType enumeration.  For example, the value returned for boolean matrix
             * types should be "M::ValueType::MATRIX_INTEGER".
             *
