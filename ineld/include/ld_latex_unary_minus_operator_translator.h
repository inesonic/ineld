...
* \file
*
* This header defines the \ref Ld::LaTeXUnaryMinusOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_UNARY_MINUS_OPERATOR_TRANSLATOR_H
#define LD_LATEX_UNARY_MINUS_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::UnaryMinusOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXUnaryMinusOperatorTranslator:public LaTeXUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXUnaryMinusOperatorTranslator)

        public:
            ~LaTeXUnaryMinusOperatorTranslator() override;
