...
* \file
*
* This header defines the \ref Ld::NotSetContainsAsMemberOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_SET_CONTAINS_AS_MEMBER_OPERATOR_ELEMENT_H
#define LD_NOT_SET_CONTAINS_AS_MEMBER_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotSetContainsAsMemberOperatorVisual;

    /**
     * Element that provides support for the set does not contain element as member operator.
     */
    class LD_PUBLIC_API NotSetContainsAsMemberOperatorElement:public BinaryRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotSetContainsAsMemberOperatorElement)
        ...
        public:
            ...
            NotSetContainsAsMemberOperatorElement();

            ~NotSetContainsAsMemberOperatorElement() override;
             ...
             * \ref NotSetContainsAsMemberOperatorElement instance.
             *
             * If the newly added \ref NotSetContainsAsMemberOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotSetContainsAsMemberOperatorVisual instance and \ref NotSetContainsAsMemberOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotSetContainsAsMemberOperatorVisual* newVisual);
             ...
             */
            NotSetContainsAsMemberOperatorVisual* visual() const;
    };
};
