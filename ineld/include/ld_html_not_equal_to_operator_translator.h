...
* \file
*
* This file defines the \ref Ld::HtmlNotEqualToOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_EQUAL_TO_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_EQUAL_TO_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotEqualToOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotEqualToOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotEqualToOperatorTranslator)

        public:
            ~HtmlNotEqualToOperatorTranslator() override;
