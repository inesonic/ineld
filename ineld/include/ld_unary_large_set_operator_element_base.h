...
* \file
*
* This header defines the \ref Ld::UnaryLargeSetOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNARY_LARGE_SET_OPERATOR_ELEMENT_BASE_H
#define LD_UNARY_LARGE_SET_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for large operator elements with one child that operates on and returns sets.
     */
    class LD_PUBLIC_API UnaryLargeSetOperatorElementBase:public UnaryLargeOperatorElementBase {
        public:
            /**
            ...
            ~UnaryLargeSetOperatorElementBase() override;
