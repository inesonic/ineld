...
* \file
*
* This header defines the \ref Ld::LaTeXValueFieldElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_VALUE_FIELD_ELEMENT_TRANSLATOR_H
#define LD_LATEX_VALUE_FIELD_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the value field element.
     */
    class LD_PUBLIC_API LaTeXValueFieldElementTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXValueFieldElementTranslator)

        public:
            ~LaTeXValueFieldElementTranslator() override;
