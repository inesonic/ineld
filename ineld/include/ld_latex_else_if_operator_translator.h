...
* \file
*
* This header defines the \ref Ld::LaTeXElseIfOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_ELSE_IF_OPERATOR_TRANSLATOR_H
#define LD_LATEX_ELSE_IF_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::ElseIfOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXElseIfOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXElseIfOperatorTranslator)

        public:
            ~LaTeXElseIfOperatorTranslator() override;
