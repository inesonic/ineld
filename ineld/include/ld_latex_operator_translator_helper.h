...
* \file
*
* This header defines the \ref Ld::LaTeXOperatorTranslatorHelper class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_OPERATOR_TRANSLATOR_HELPER_H
#define LD_LATEX_OPERATOR_TRANSLATOR_HELPER_H
...
namespace Ld {
    ...
    /**
     * Helper class for LaTeX translators used to render operators used strictly as r-values.
     */
    class LD_PUBLIC_API LaTeXOperatorTranslatorHelper {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXOperatorTranslatorHelper)

        public:
            virtual ~LaTeXOperatorTranslatorHelper();
