...
* \file
*
* This header defines the \ref Ld::MultiplicationOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MULTIPLICATION_OPERATOR_ELEMENT_H
#define LD_MULTIPLICATION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class MultiplicationOperatorVisual;

    /**
     * Element that provides support for the multiplication operator.
     */
    class LD_PUBLIC_API MultiplicationOperatorElement:public BinaryNumericAndMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::MultiplicationOperatorElement)
        ...
        public:
            ...
            MultiplicationOperatorElement();

            ~MultiplicationOperatorElement() override;
             ...
             * \ref MultiplicationOperatorElement instance.
             *
             * If the newly added \ref MultiplicationOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref MultiplicationOperatorVisual instance and \ref MultiplicationOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(MultiplicationOperatorVisual* newVisual);
             ...
             */
            MultiplicationOperatorVisual* visual() const;
