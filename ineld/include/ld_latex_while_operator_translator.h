...
* \file
*
* This header defines the \ref Ld::LaTeXWhileOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_WHILE_OPERATOR_TRANSLATOR_H
#define LD_LATEX_WHILE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::WhileOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXWhileOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXWhileOperatorTranslator)

        public:
            ~LaTeXWhileOperatorTranslator() override;
