...
* \file
*
* This header defines the \ref Ld::CppMatrixRealDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_MATRIX_REAL_DATA_TYPE_TRANSLATOR_H
#define LD_CPP_MATRIX_REAL_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ real matrix data type translator.
     */
    class LD_PUBLIC_API CppMatrixRealDataTypeTranslator:public CppDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const CppMatrixRealDataTypeTranslator instance;

            CppMatrixRealDataTypeTranslator();

            ~CppMatrixRealDataTypeTranslator() override;
             ...
             * should be "M::ValueType::MATRIX_REAL".
             *
