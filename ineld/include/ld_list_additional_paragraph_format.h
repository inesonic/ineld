...
* \file
*
* This header defines the \ref Ld::ListAdditionalParagraphFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LIST_ADDITIONAL_PARAGRAPH_FORMAT_BASE_H
#define LD_LIST_ADDITIONAL_PARAGRAPH_FORMAT_BASE_H
...
namespace Ld {
    /**
     * Base class that extends the \ref Ld::Format class to handle paragraphs in a bulleted or numbered list.  The class
     * assumes that all indentation and spacing values are taken from the format instance of the first paragraph format
     * in the list.
     */
    class LD_PUBLIC_API ListAdditionalParagraphFormat:public virtual Format {
        public:
            /**
             * Value indicating if the bullet or number is shown by default.
             */
            static const bool defaultBulletNumberShown;

            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ListAdditionalParagraphFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual Format::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to obtain every unique list bullet/number display state.
                     *
                     * \return Returns a boolean aggregation indicating if list bullets/numbers are being shown.
                     */
                    BooleanAggregation listBulletNumberStates() const;

                private:
                    /**
                     * The current list bullet/number state.
                     */
                    BooleanAggregation currentBulletNumberStates;
            };
             ...
             */
            ListAdditionalParagraphFormat(const ListAdditionalParagraphFormat& other);

            ~ListAdditionalParagraphFormat() override;
            ...
            /**
             * Method you can use to indicate if the bullet/number should be shown or hidden.
             *
             * \param[in] nowDisplayed If true, the list's bullet or number will be displayed for this paragraph.  If
             *                         false, the list's bullet/number will be hidden for this paragraph.
             */
            void setBulletNumberDisplayEnabled(bool nowDisplayed = true);

            /**
             * Method you can use to indicate if the bullet/number should be hidden or shown.
             *
             * \param[in] nowHidden If true, the list's bullet or number will be hidden for this paragraph.  If false,
             *                      the list's bullet/number will be displayed for this paragraph.
             */
            void setBulletNumberDisplayDisabled(bool nowHidden = true);

            /**
             * Method you can use to determine if the list bullet/number should be shown or hidden.
             *
             * \return Returns true if the bullet or number should be shown.  Returns false if the bullet or number
             *         should be hidden.
             */
            bool bulletNumberDisplayEnabled() const;

            /**
             * Method you can use to determine if the list bullet/number shold be hidden or shown.
             *
             * \return Returns true if the bullet or number should be hidden.  Returns false if the bullet or number
             *          should be shown.
             */
            bool bulletNumberDisplayDisabled() const;

            /**
             * Method that returns a description of this format as a string.  The string format should be inthe form of
        ...
        protected:
            ...
            /**
             * The current bullet/number display state.
             */
            bool currentBulletNumberDisplayEnabled;
    };
}
