...
* \file
*
* This header defines the \ref Ld::CppFunctionPlaceholderTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_FUNCTION_PLACEHOLDER_TRANSLATOR_H
#define LD_CPP_FUNCTION_PLACEHOLDER_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::FunctionPlaceholderElement class.
     */
    class LD_PUBLIC_API CppFunctionPlaceholderTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppFunctionPlaceholderTranslator)

        public:
            ~CppFunctionPlaceholderTranslator() override;
