...
* \file
*
* This file defines the \ref Ld::HtmlProperSupersetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_PROPER_SUPERSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_PROPER_SUPERSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ProperSupersetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlProperSupersetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlProperSupersetOperatorTranslator)

        public:
            ~HtmlProperSupersetOperatorTranslator() override;
