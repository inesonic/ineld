...
* \file
*
* This header defines the \ref Ld::SubsetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SUBSET_OPERATOR_ELEMENT_H
#define LD_SUBSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SubsetOperatorVisual;

    /**
     * Element that provides support for the subset operator.
     */
    class LD_PUBLIC_API SubsetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SubsetOperatorElement)
        ...
        public:
            ...
            SubsetOperatorElement();

            ~SubsetOperatorElement() override;
             ...
             * \ref SubsetOperatorElement instance.
             *
             * If the newly added \ref SubsetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SubsetOperatorVisual instance and \ref SubsetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SubsetOperatorVisual* newVisual);
             ...
             */
            SubsetOperatorVisual* visual() const;
    };
};
