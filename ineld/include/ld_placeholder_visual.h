...
* \file
*
* This header defines the \ref Ld::PlaceholderVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PLACEHOLDER_VISUAL_H
#define LD_PLACEHOLDER_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::PlaceholderElement instance.
     */
    class LD_PUBLIC_API PlaceholderVisual:public virtual VisualWithNoChildren {
        public:
            PlaceholderVisual();

            ~PlaceholderVisual() override;
