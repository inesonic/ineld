...
* \file
*
* This header defines the \ref Ld::HtmlValueFieldElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_VALUE_FIELD_ELEMENT_TRANSLATOR_H
#define LD_HTML_VALUE_FIELD_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ValueFieldElement class.
     */
    class LD_PUBLIC_API HtmlValueFieldElementTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlValueFieldElementTranslator)

        public:
            ~HtmlValueFieldElementTranslator() override;
