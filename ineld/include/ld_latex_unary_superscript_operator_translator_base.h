...
* \file
*
* This header defines the \ref Ld::LaTeXUnarySuperscriptOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_UNARY_SUPERSCRIPT_OPERATOR_TRANSLATOR_BASE_H
#define LD_LATEX_UNARY_SUPERSCRIPT_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for LaTeX translators used to render superscripted unary operators.
     */
    class LD_PUBLIC_API LaTeXUnarySuperscriptOperatorTranslatorBase:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXUnarySuperscriptOperatorTranslatorBase)

        public:
            ~LaTeXUnarySuperscriptOperatorTranslatorBase() override;
