...
* \file
*
* This file defines the \ref Ld::HtmlPowerOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_POWER_OPERATOR_TRANSLATOR_H
#define LD_HTML_POWER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::PowerOperatorElement class.
     */
    class LD_PUBLIC_API HtmlPowerOperatorTranslator:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlPowerOperatorTranslator)

        public:
            ~HtmlPowerOperatorTranslator() override;
