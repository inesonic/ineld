...
* \file
*
* This header defines the \ref Ld::PiSpecialValueElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PI_SPECIAL_VALUE_ELEMENT_H
#define LD_PI_SPECIAL_VALUE_ELEMENT_H
...
namespace Ld {
    class PiSpecialValueVisual;

    /**
     * Element that ....
     */
    class LD_PUBLIC_API PiSpecialValueElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::PiSpecialValueElement)
        ...
        public:
            ...
            PiSpecialValueElement();

            ~PiSpecialValueElement() override;
             ...
             * \ref Ld::PiSpecialValueElement instance.
             *
             * If the newly added \ref Ld::PiSpecialValueVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Ld::PiSpecialValueVisual instance and \ref Ld::PiSpecialValueElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(PiSpecialValueVisual* newVisual);
             ...
             */
            PiSpecialValueVisual* visual() const;
    };
};
