...
* \file
*
* This header defines the \ref Ld::CppSubscriptIndexOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_SUBSCRIPT_INDEX_OPERATOR_TRANSLATOR_H
#define LD_CPP_SUBSCRIPT_INDEX_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::SubscriptIndexOperatorElement class.
     */
    class LD_PUBLIC_API CppSubscriptIndexOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppSubscriptIndexOperatorTranslator)

        public:
            ~CppSubscriptIndexOperatorTranslator() override;
