...
* \file
*
* This file defines the \ref Ld::HtmlSubtractionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SUBTRACTION_OPERATOR_TRANSLATOR_H
#define LD_HTML_SUBTRACTION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SubtractionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSubtractionOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSubtractionOperatorTranslator)

        public:
            ~HtmlSubtractionOperatorTranslator() override;
