...
* \file
*
* This header defines the \ref Ld::LaTeXTupleTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_TUPLE_TRANSLATOR_H
#define LD_LATEX_TUPLE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::TupleElement.
     */
    class LD_PUBLIC_API LaTeXTupleTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXTupleTranslator)

        public:
            ~LaTeXTupleTranslator() override;
