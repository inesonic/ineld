...
* \file
*
* This header defines the \ref Ld::ComplexDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_COMPLEX_DATA_TYPE_FORMAT_H
#define LD_COMPLEX_DATA_TYPE_FORMAT_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API ComplexDataTypeFormat:public virtual RealDataTypeFormat {
        public:
            /**
             * Enumeration of symbols used for the imaginary unit.
             */
            enum class ImaginaryUnit {
                /**
                 * Value indicating an invalid imaginary unit.
                 */
                INVALID,
            ...
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ComplexDataTypeFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual RealDataTypeFormat::Aggregation {
                public:
                    Aggregation();
                    ...
                    /**
                     * Method you can use to obtain all the displayed imaginary units.
                     *
                     * \return Returns the displayed imaginary units.
                     */
                    QSet<ImaginaryUnit> imaginaryUnits() const;

                private:
                    /**
                     * Set of displayed imaginary units.
                     */
                    QSet<ImaginaryUnit> currentImaginaryUnits;
            };
             ...
             */
            ComplexDataTypeFormat(const ComplexDataTypeFormat& other);

            ~ComplexDataTypeFormat() override;
             ...
             *
             * \return Returns the format identifying name, in this case, "ComplexDataTypeFormat".
             */
            QString typeName() const override;
            ...
            /**
             * Method you can use to set the imaginary unit.
             *
             * \param[in] newImaginaryUnit The new imaginary unit.
             */
            void setImaginaryUnit(ImaginaryUnit newImaginaryUnit);

            /**
             * Method you can use to determine the currently selected imaginary unit.
             *
             * \return Returns the currently selected imaginary unit.
             */
        ...
        private:
            /**
             * Method that converts an imaginary unit value to a string.
             *
             * \param[in] imaginaryUnit The imaginary unit to be converted.
             *
             * \return Returns a string representatin of the imaginary unit.
             */
            static QString toString(ImaginaryUnit imaginaryUnit);

            /**
             * Method that converts an imaginary unit value from a string.
             *
             * \param[in]  str The string to convert.
             *
             * \param[out] ok  A boolean variable that will be populated with true on success, false on error.
             *
             * \return Returns the translated imaginary unit.
             */
            static ImaginaryUnit toImaginaryUnit(const QString& str, bool* ok = nullptr);

            /**
             * The current imaginary unit.
             */
            ImaginaryUnit currentImaginaryUnit;
    };

    /**
     * Hash function for the \ref Ld::ComplexDataTypeFormat::ImaginaryUnit enumeration.
     *
     * \param[in] imaginaryUnit The value to be hashed.
     *
     * \param[in] seed          An optional seed to apply to the hash.
     *
     * \return Returns a hash of the provided value.
     */
    LD_PUBLIC_API Util::HashResult qHash(ComplexDataTypeFormat::ImaginaryUnit imaginaryUnit, Util::HashSeed seed = 0);
}
