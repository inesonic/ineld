...
* \file
*
* This file defines the \ref Ld::HtmlRootOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ROOT_OPERATOR_TRANSLATOR_H
#define LD_HTML_ROOT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::RootOperatorElement class.
     */
    class LD_PUBLIC_API HtmlRootOperatorTranslator:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlRootOperatorTranslator)

        public:
            ~HtmlRootOperatorTranslator() override;
