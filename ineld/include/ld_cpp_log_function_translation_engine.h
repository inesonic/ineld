...
* \file
*
* This header defines the \ref Ld::CppLogFunctionTranslationEngine class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_LOG_FUNCTION_TRANSLATION_ENGINE_H
#define LD_CPP_LOG_FUNCTION_TRANSLATION_ENGINE_H
...
namespace Ld {
    ...
    /**
     * C++ log base b function translator.  You can use this class to translate the natural log function.  This
     * function will call several variants depending on the parameter in the log function.
     */
    class LD_PUBLIC_API CppLogFunctionTranslationEngine:public CppFunctionTranslationEngine {
        public:
            /**
             * Static translation engine instance.
             */
            static const CppLogFunctionTranslationEngine instance;

            CppLogFunctionTranslationEngine();

            ~CppLogFunctionTranslationEngine() override;
