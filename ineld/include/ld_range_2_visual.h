...
* \file
*
* This header defines the \ref Ld::Range2Visual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_RANGE_2_VISUAL_H
#define LD_RANGE_2_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::Range2Element instance.
     */
    class LD_PUBLIC_API Range2Visual:public virtual VisualWithFixedChildren {
        public:
            Range2Visual();

            ~Range2Visual() override;

            /**
             * Method you can use to obtain the \ref Range2Element class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref Range2Element instance.
             */
            QSharedPointer<Range2Element> element() const;
