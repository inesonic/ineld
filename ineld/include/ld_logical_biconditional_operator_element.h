...
* \file
*
* This header defines the \ref Ld::LogicalBiconditionalOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LOGICAL_BICONDITIONAL_OPERATOR_ELEMENT_H
#define LD_LOGICAL_BICONDITIONAL_OPERATOR_ELEMENT_H
...
namespace Ld {
    class LogicalBiconditionalOperatorVisual;

    /**
     * Element that provides support for the logical biconditional operator.
     */
    class LD_PUBLIC_API LogicalBiconditionalOperatorElement:public BinaryLogicalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LogicalBiconditionalOperatorElement)
        ...
        public:
            ...
            LogicalBiconditionalOperatorElement();

            ~LogicalBiconditionalOperatorElement() override;
             ...
             *         in the plug-in data structures.  Elements defined as part of the ineld library should return an
             *         empty string.
             */
             ...
             * \ref LogicalBiconditionalOperatorElement instance.
             *
             * If the newly added \ref LogicalBiconditionalOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref LogicalBiconditionalOperatorVisual instance and \ref LogicalBiconditionalOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(LogicalBiconditionalOperatorVisual* newVisual);
             ...
             */
            LogicalBiconditionalOperatorVisual* visual() const;
