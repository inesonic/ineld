...
* \file
*
* This header defines the \ref Ld::MatrixRealDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_REAL_DATA_TYPE_FORMAT_H
#define LD_MATRIX_REAL_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides format information to render real matrices.
     */
    class LD_PUBLIC_API MatrixRealDataTypeFormat:public virtual MatrixDataTypeFormat,
                                                 public virtual RealDataTypeFormat {
        public:
            /**
             * Class you can use to track an aggregation of multiple \ref Ld::MatrixRealDataTypeFormat instances.
             */
             ...
             */
            MatrixRealDataTypeFormat(const MatrixRealDataTypeFormat& other);

            ~MatrixRealDataTypeFormat() override;
