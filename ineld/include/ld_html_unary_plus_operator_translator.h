...
* \file
*
* This header defines the \ref Ld::HtmlUnaryPlusOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_UNARY_PLUS_OPERATOR_TRANSLATOR_H
#define LD_HTML_UNARY_PLUS_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::UnaryPlusOperatorElement class.
     */
    class LD_PUBLIC_API HtmlUnaryPlusOperatorTranslator:public HtmlUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlUnaryPlusOperatorTranslator)

        public:
            ~HtmlUnaryPlusOperatorTranslator() override;
