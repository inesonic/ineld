...
* \file
*
* This header defines the \ref Ld::LaTeXBooleanTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_BOOLEAN_TYPE_TRANSLATOR_H
#define LD_LATEX_BOOLEAN_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the boolean type element.
     */
    class LD_PUBLIC_API LaTeXBooleanTypeTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXBooleanTypeTranslator)

        public:
            ~LaTeXBooleanTypeTranslator() override;
