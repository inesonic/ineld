...
* \file
*
* This header defines the \ref Ld::CppCeilingOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_CEILING_OPERATOR_TRANSLATOR_H
#define LD_CPP_CEILING_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator class for the \ref Ld::CeilingOperatorElement class.
     */
    class LD_PUBLIC_API CppCeilingOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppCeilingOperatorTranslator)

        public:
            ~CppCeilingOperatorTranslator() override;
