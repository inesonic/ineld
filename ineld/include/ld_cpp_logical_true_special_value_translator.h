...
* \file
*
* This header defines the \ref Ld::CppLogicalTrueSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_LOGICAL_TRUE_SPECIAL_VALUE_TRANSLATOR_H
#define LD_CPP_LOGICAL_TRUE_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::LogicalTrueSpecialValueElement class.
     */
    class LD_PUBLIC_API CppLogicalTrueSpecialValueTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppLogicalTrueSpecialValueTranslator)

        public:
            ~CppLogicalTrueSpecialValueTranslator() override;
