...
* \file
*
* This header defines the \ref Ld::MatrixBooleanDataTypeDecoder class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_BOOLEAN_DATA_TYPE_DECODER_H
#define LD_MATRIX_BOOLEAN_DATA_TYPE_DECODER_H
...
namespace Ld {
    /**
     * Boolean matrix data type decoder.
     */
    class LD_PUBLIC_API MatrixBooleanDataTypeDecoder:public virtual MatrixDataTypeDecoder {
        Q_DECLARE_TR_FUNCTIONS(Ld::MatrixBooleanDataTypeDecoder)
        ...
        public:
            ...
            class LD_PUBLIC_API Context:public virtual MatrixDataTypeDecoder::Context {
                public:
                    ...
                    /**
                     * Method you can call to determine the desired boolean style.
                     */
                    Util::BooleanStyle booleanStyle() const;
                ...
                private:
                     ...
                     */
                    Model::MatrixBoolean currentMatrix;

                    /**
                     * The desired boolean style.
                     */
                    Util::BooleanStyle currentBooleanStyle;
            };

            MatrixBooleanDataTypeDecoder();

            ~MatrixBooleanDataTypeDecoder() override;
