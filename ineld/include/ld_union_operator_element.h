...
* \file
*
* This header defines the \ref Ld::UnionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNION_OPERATOR_ELEMENT_H
#define LD_UNION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class UnionOperatorVisual;

    /**
     * Element that provides support for set unions.
     */
    class LD_PUBLIC_API UnionOperatorElement:public BinarySetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::UnionOperatorElement)
        ...
        public:
             ...
             * \ref UnionOperatorElement instance.
             *
             * If the newly added \ref UnionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref UnionOperatorVisual instance and \ref UnionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(UnionOperatorVisual* newVisual);
             ...
             */
            UnionOperatorVisual* visual() const;
