...
* \file
*
* This header defines the \ref Ld::MatrixConjugateTransposeOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_CONJUGATE_TRANSPOSE_OPERATOR_ELEMENT_H
#define LD_MATRIX_CONJUGATE_TRANSPOSE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class MatrixConjugateTransposeOperatorVisual;

    /**
     * Element that provides support for the conjugate transpose or Hermitian operator.
     */
    class LD_PUBLIC_API MatrixConjugateTransposeOperatorElement:public UnaryMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::MatrixConjugateTransposeOperatorElement)
        ...
        public:
            ...
            MatrixConjugateTransposeOperatorElement();

            ~MatrixConjugateTransposeOperatorElement() override;
             ...
             * \ref Ld::MatrixConjugateTransposeOperatorElement instance.
             *
             * If the newly added \ref MatrixConjugateTransposeOperatorVisual already points to a different element,
             * then those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref MatrixConjugateTransposeOperatorVisual instance and \ref MatrixConjugateTransposeOperatorElement
             * instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(MatrixConjugateTransposeOperatorVisual* newVisual);
             ...
             */
            MatrixConjugateTransposeOperatorVisual* visual() const;
    };
};
