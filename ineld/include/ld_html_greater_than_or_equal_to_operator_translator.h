...
* \file
*
* This file defines the \ref Ld::HtmlGreaterThanOrEqualToOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_GREATER_THAN_OR_EQUAL_TO_OPERATOR_TRANSLATOR_H
#define LD_HTML_GREATER_THAN_OR_EQUAL_TO_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::GreaterThanOrEqualToOperatorElement class.
     */
    class LD_PUBLIC_API HtmlGreaterThanOrEqualToOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlGreaterThanOrEqualToOperatorTranslator)

        public:
            ~HtmlGreaterThanOrEqualToOperatorTranslator() override;
