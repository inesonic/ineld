...
* \file
*
* This header defines the \ref Ld::HtmlIntegerTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_INTEGER_TYPE_TRANSLATOR_H
#define LD_HTML_INTEGER_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::IntegerTypeElement class.
     */
    class LD_PUBLIC_API HtmlIntegerTypeTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlIntegerTypeTranslator)

        public:
            ~HtmlIntegerTypeTranslator() override;
