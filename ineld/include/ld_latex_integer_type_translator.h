...
* \file
*
* This header defines the \ref Ld::LaTeXIntegerTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_INTEGER_TYPE_TRANSLATOR_H
#define LD_LATEX_INTEGER_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the integer type element.
     */
    class LD_PUBLIC_API LaTeXIntegerTypeTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXIntegerTypeTranslator)

        public:
            ~LaTeXIntegerTypeTranslator() override;
