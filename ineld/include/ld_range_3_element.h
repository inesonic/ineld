...
* \file
*
* This header defines the \ref Ld::Range3Element class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_RANGE_3_ELEMENT_H
#define LD_RANGE_3_ELEMENT_H
...
namespace Ld {
    ...
    /**
     * Element that supports a range with a first value, second value, and final value.
     */
    class LD_PUBLIC_API Range3Element:public TrinaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::Range3Element)
        ...
        public:
             ...
             * \ref Range3Element instance.
             *
             * If the newly added \ref Range3Visual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Range3Visual instance and \ref Range3Element instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(Range3Visual* newVisual);
