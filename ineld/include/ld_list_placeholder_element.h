...
* \file
*
* This header defines the \ref Ld::ListPlaceholderElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LIST_PLACEHOLDER_ELEMENT_H
#define LD_LIST_PLACEHOLDER_ELEMENT_H
...
namespace Ld {
    class ListPlaceholderVisual;

    /**
     * Element that is used to populate the last position in the list.  This element exists to be used as a place-holder
     * for empty lists and as a placeholder for the last position in the list so that the cursor can move into the list
     * and can append to the list.
     */
    class LD_PUBLIC_API ListPlaceholderElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ListPlaceholderElement)
        ...
        public:
            ...
            ListPlaceholderElement();

            ~ListPlaceholderElement() override;
             ...
             * \ref ListPlaceholderElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ListPlaceholderVisual* newVisual);
             ...
             */
            ListPlaceholderVisual* visual() const;
    };
};
