...
* \file
*
* This header defines the \ref Ld::PlaceholderElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PLACEHOLDER_ELEMENT_H
#define LD_PLACEHOLDER_ELEMENT_H
...
namespace Ld {
    ...
    /**
     * Element that is used to populate an empty cursor position.
     */
    class LD_PUBLIC_API PlaceholderElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::PlaceholderElement)
        ...
        public:
             ...
             *                      the visual.
             */
            void setVisual(PlaceholderVisual* newVisual);
             ...
             */
            PlaceholderVisual* visual() const;
    };
};
