...
* \file
*
* This file defines the \ref Ld::HtmlIfOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_IF_OPERATOR_TRANSLATOR_H
#define LD_HTML_IF_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::IfOperatorElement class.
     */
    class LD_PUBLIC_API HtmlIfOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlIfOperatorTranslator)

        public:
            ~HtmlIfOperatorTranslator() override;
