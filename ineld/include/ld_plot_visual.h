...
* \file
*
* This header defines the \ref Ld::PlotVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PLOT_VISUAL_H
#define LD_PLOT_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::PlotElement instance.
     */
    class LD_PUBLIC_API PlotVisual:public virtual VisualWithNoChildren {
        public:
            PlotVisual();
             ...
             */
            QSharedPointer<PlotElement> element() const;
