...
* \file
*
* This header defines the \ref Ld::SetContainsAsMemberOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SET_CONTAINS_AS_MEMBER_OPERATOR_ELEMENT_H
#define LD_SET_CONTAINS_AS_MEMBER_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SetContainsAsMemberOperatorVisual;

    /**
     * Element that supports the set contains as member operator.
     */
    class LD_PUBLIC_API SetContainsAsMemberOperatorElement:public BinaryRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SetContainsAsMemberOperatorElement)
        ...
        public:
            ...
            SetContainsAsMemberOperatorElement();

            ~SetContainsAsMemberOperatorElement() override;
             ...
             * \ref SetContainsAsMemberOperatorElement instance.
             *
             * If the newly added \ref SetContainsAsMemberOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SetContainsAsMemberOperatorVisual instance and \ref SetContainsAsMemberOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SetContainsAsMemberOperatorVisual* newVisual);
             ...
             */
            SetContainsAsMemberOperatorVisual* visual() const;
    };
};
