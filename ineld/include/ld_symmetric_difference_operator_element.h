...
* \file
*
* This header defines the \ref Ld::SymmetricDifferenceOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SYMMETRIC_DIFFERENCE_OPERATOR_ELEMENT_H
#define LD_SYMMETRIC_DIFFERENCE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SymmetricDifferenceOperatorVisual;

    /**
     * Element that provides support for the symmetric difference operation.
     */
    class LD_PUBLIC_API SymmetricDifferenceOperatorElement:public BinarySetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SymmetricDifferenceOperatorElement)
        ...
        public:
            ...
            SymmetricDifferenceOperatorElement();

            ~SymmetricDifferenceOperatorElement() override;
             ...
             * \ref SymmetricDifferenceOperatorElement instance.
             *
             * If the newly added \ref SymmetricDifferenceOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SymmetricDifferenceOperatorVisual instance and \ref SymmetricDifferenceOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SymmetricDifferenceOperatorVisual* newVisual);
             ...
             */
            SymmetricDifferenceOperatorVisual* visual() const;
