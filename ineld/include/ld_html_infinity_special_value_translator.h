...
* \file
*
* This header defines the \ref Ld::HtmlInfinitySpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_INFINITY_SPECIAL_VALUE_TRANSLATOR_H
#define LD_HTML_INFINITY_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::InfinitySpecialValueElement class.
     */
    class LD_PUBLIC_API HtmlInfinitySpecialValueTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlInfinitySpecialValueTranslator)

        public:
            ~HtmlInfinitySpecialValueTranslator() override;
