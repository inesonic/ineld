...
* \file
*
* This file defines the \ref Ld::HtmlNotSetContainsAsMemberOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_SET_CONTAINS_AS_MEMBER_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_SET_CONTAINS_AS_MEMBER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotSetContainsAsMemberOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotSetContainsAsMemberOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotSetContainsAsMemberOperatorTranslator)

        public:
            ~HtmlNotSetContainsAsMemberOperatorTranslator() override;
