...
* \file
*
* This header defines the \ref Ld::MatrixCombineLeftToRightOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_COMBINE_LEFT_TO_RIGHT_OPERATOR_ELEMENT_H
#define LD_MATRIX_COMBINE_LEFT_TO_RIGHT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class MatrixCombineLeftToRightOperatorVisual;

    /**
     * Element that provides a Matrix combine operator.  Matrices are combined in left to right order.
     */
    class LD_PUBLIC_API MatrixCombineLeftToRightOperatorElement:public BinaryMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::MatrixCombineLeftToRightOperatorElement)
        ...
        public:
            ...
            MatrixCombineLeftToRightOperatorElement();

            ~MatrixCombineLeftToRightOperatorElement() override;
             ...
             * \ref MatrixCombineLeftToRightOperatorElement instance.
             *
             * If the newly added \ref MatrixCombineLeftToRightOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref MatrixCombineLeftToRightOperatorVisual instance and \ref MatrixCombineLeftToRightOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(MatrixCombineLeftToRightOperatorVisual* newVisual);
             ...
             */
            MatrixCombineLeftToRightOperatorVisual* visual() const;
    };
};
