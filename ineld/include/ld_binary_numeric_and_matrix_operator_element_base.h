...
* \file
*
* This header defines the \ref Ld::BinaryNumericAndMatrixOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BINARY_NUMERIC_AND_MATRIX_OPERATOR_ELEMENT_BASE_H
#define LD_BINARY_NUMERIC_AND_MATRIX_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for operator elements with two children that accepts and provides a numeric or matrix value.
     */
    class LD_PUBLIC_API BinaryNumericAndMatrixOperatorElementBase:public BinaryOperatorElementBase {
        public:
            /**
            ...
            BinaryNumericAndMatrixOperatorElementBase();

            ~BinaryNumericAndMatrixOperatorElementBase() override;
