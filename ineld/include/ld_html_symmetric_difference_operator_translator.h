...
* \file
*
* This file defines the \ref Ld::HtmlSymmetricDifferenceOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SYMMETRIC_DIFFERENCE_OPERATOR_TRANSLATOR_H
#define LD_HTML_SYMMETRIC_DIFFERENCE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SymmetricDifferenceOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSymmetricDifferenceOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSymmetricDifferenceOperatorTranslator)

        public:
            ~HtmlSymmetricDifferenceOperatorTranslator() override;
