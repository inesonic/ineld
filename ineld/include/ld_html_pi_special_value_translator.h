...
* \file
*
* This header defines the \ref Ld::HtmlPiSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_PI_SPECIAL_VALUE_TRANSLATOR_H
#define LD_HTML_PI_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::PiSpecialValueElement class.
     */
    class LD_PUBLIC_API HtmlPiSpecialValueTranslator:public HtmlSpecialSymbolTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlPiSpecialValueTranslator)

        public:
            ~HtmlPiSpecialValueTranslator() override;
