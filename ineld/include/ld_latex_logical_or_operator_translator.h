...
* \file
*
* This header defines the \ref Ld::LaTeXLogicalOrOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_LOGICAL_OR_OPERATOR_TRANSLATOR_H
#define LD_LATEX_LOGICAL_OR_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::LogicalOrOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXLogicalOrOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXLogicalOrOperatorTranslator)

        public:
            ~LaTeXLogicalOrOperatorTranslator() override;
