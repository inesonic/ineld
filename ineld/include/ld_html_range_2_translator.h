...
* \file
*
* This header defines the \ref Ld::HtmlRange2Translator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_RANGE_2_TRANSLATOR_H
#define LD_HTML_RANGE_2_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::Range2Element class.
     */
    class LD_PUBLIC_API HtmlRange2Translator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlRange2Translator)

        public:
            ~HtmlRange2Translator() override;
