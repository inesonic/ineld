...
* \file
*
* This header defines the \ref Ld::LaTeXGreaterThanOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_GREATER_THAN_OPERATOR_TRANSLATOR_H
#define LD_LATEX_GREATER_THAN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::GreaterThanOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXGreaterThanOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXGreaterThanOperatorTranslator)

        public:
            ~LaTeXGreaterThanOperatorTranslator() override;
