...
* \file
*
* This header defines the \ref Ld::GroupingParenthesisOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_GROUPING_PARENTHESIS_OPERATOR_ELEMENT_H
#define LD_GROUPING_PARENTHESIS_OPERATOR_ELEMENT_H
...
namespace Ld {
    class GroupingParenthesisOperatorVisual;

    /**
     * Element that provides a parenthesis grouping operator.
     */
    class LD_PUBLIC_API GroupingParenthesisOperatorElement:public GenericGroupingOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::GroupingParenthesisOperatorElement)
        ...
        public:
            ...
            GroupingParenthesisOperatorElement();

            ~GroupingParenthesisOperatorElement() override;
             ...
             * \ref Ld::GroupingParenthesisOperatorElement instance.
             *
             * If the newly added \ref GroupingParenthesisOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref GroupingParenthesisOperatorVisual instance and \ref GroupingParenthesisOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(GroupingParenthesisOperatorVisual* newVisual);
             ...
             */
            GroupingParenthesisOperatorVisual* visual() const;
