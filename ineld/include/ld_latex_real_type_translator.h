...
* \file
*
* This header defines the \ref Ld::LaTeXRealTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_REAL_TYPE_TRANSLATOR_H
#define LD_LATEX_REAL_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the real type element.
     */
    class LD_PUBLIC_API LaTeXRealTypeTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXRealTypeTranslator)

        public:
            ~LaTeXRealTypeTranslator() override;
