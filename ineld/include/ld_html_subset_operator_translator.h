...
* \file
*
* This file defines the \ref Ld::HtmlSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SubsetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSubsetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSubsetOperatorTranslator)

        public:
            ~HtmlSubsetOperatorTranslator() override;
