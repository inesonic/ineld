...
* \file
*
* This header defines the \ref Ld::DataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_DATA_TYPE_FORMAT_H
#define LD_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Common base class for all data-type formats.
     */
    class LD_PUBLIC_API DataTypeFormat:public virtual FontFormat {
        public:
            /**
             * Base class you can use to track an aggregation of multiple \ref Ld::DataTypeFormat instances.
             */
             ...
             */
            DataTypeFormat(const DataTypeFormat& other);

            ~DataTypeFormat() override;
