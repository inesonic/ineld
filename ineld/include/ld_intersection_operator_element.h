...
* \file
*
* This header defines the \ref Ld::IntersectionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_INTERSECTION_OPERATOR_ELEMENT_H
#define LD_INTERSECTION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class IntersectionOperatorVisual;

    /**
     * Element that provides support for the intersection operator.
     */
    class LD_PUBLIC_API IntersectionOperatorElement:public BinarySetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::IntersectionOperatorElement)
        ...
        public:
            ...
            IntersectionOperatorElement();

            ~IntersectionOperatorElement() override;
             ...
             * \ref IntersectionOperatorElement instance.
             *
             * If the newly added \ref IntersectionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref IntersectionOperatorVisual instance and \ref IntersectionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(IntersectionOperatorVisual* newVisual);
             ...
             */
            IntersectionOperatorVisual* visual() const;
