...
* \file
*
* This file defines the \ref Ld::HtmlLogicalAndOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LOGICAL_AND_OPERATOR_TRANSLATOR_H
#define LD_HTML_LOGICAL_AND_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LogicalAndOperatorElement class.
     */
    class LD_PUBLIC_API HtmlLogicalAndOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLogicalAndOperatorTranslator)

        public:
            ~HtmlLogicalAndOperatorTranslator() override;
