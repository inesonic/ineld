...
* \file
*
* This header defines the \ref Ld::LaTeXSubscriptRowColumnOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SUBSCRIPT_ROW_COLUMN_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SUBSCRIPT_ROW_COLUMN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SubscriptRowColumnOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSubscriptRowColumnOperatorTranslator:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSubscriptRowColumnOperatorTranslator)

        public:
            ~LaTeXSubscriptRowColumnOperatorTranslator() override;
