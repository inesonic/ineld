...
* \file
*
* This header defines the \ref Ld::LaTeXEulersNumberSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_EULERS_NUMBER_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_EULERS_NUMBER_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the EulersNumberSpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXEulersNumberSpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXEulersNumberSpecialValueTranslator)

        public:
            virtual ~LaTeXEulersNumberSpecialValueTranslator();
