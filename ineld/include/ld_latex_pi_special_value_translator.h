...
* \file
*
* This header defines the \ref Ld::LaTeXPiSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_PI_SPECIAL_VALUE_TRANSLATOR_H
#define LD_LATEX_PI_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the PiSpecialValueElement element.
     */
    class LD_PUBLIC_API LaTeXPiSpecialValueTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXPiSpecialValueTranslator)

        public:
            virtual ~LaTeXPiSpecialValueTranslator();
