...
* \file
*
* This file defines the \ref Ld::HtmlSubscriptRowColumnOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SUBSCRIPT_ROW_COLUMN_OPERATOR_TRANSLATOR_H
#define LD_HTML_SUBSCRIPT_ROW_COLUMN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SubscriptRowColumnOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSubscriptRowColumnOperatorTranslator:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSubscriptRowColumnOperatorTranslator)

        public:
            ~HtmlSubscriptRowColumnOperatorTranslator() override;
