...
* \file
*
* This header defines the \ref Ld::ValueFieldVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_VALUE_FIELD_VISUAL_H
#define LD_VALUE_FIELD_VISUAL_H
...
namespace Ld {
    class ValueFieldElement;

    /**
     * Visual used to interact with a \ref Ld::ValueFieldElement instance.
     */
    class LD_PUBLIC_API ValueFieldVisual:public virtual VisualWithNoChildren {
        public:
            ValueFieldVisual();

            ~ValueFieldVisual() override;
             ...
             */
            QSharedPointer<ValueFieldElement> element() const;
