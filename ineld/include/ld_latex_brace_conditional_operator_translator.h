...
* \file
*
* This header defines the \ref Ld::LaTeXBraceConditionalOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_BRACE_CONDITIONAL_OPERATOR_TRANSLATOR_H
#define LD_LATEX_BRACE_CONDITIONAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::BraceConditionalOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXBraceConditionalOperatorTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXBraceConditionalOperatorTranslator)

        public:
            ~LaTeXBraceConditionalOperatorTranslator() override;
