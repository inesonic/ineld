...
* \file
*
* This file defines the \ref Ld::HtmlSubscriptIndexOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SUBSCRIPT_INDEX_OPERATOR_TRANSLATOR_H
#define LD_HTML_SUBSCRIPT_INDEX_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SubscriptIndexOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSubscriptIndexOperatorTranslator:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSubscriptIndexOperatorTranslator)

        public:
            ~HtmlSubscriptIndexOperatorTranslator() override;
