...
* \file
*
* This file defines the \ref Ld::HtmlNotProperSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_PROPER_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_PROPER_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotProperSubsetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotProperSubsetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotProperSubsetOperatorTranslator)

        public:
            ~HtmlNotProperSubsetOperatorTranslator() override;
