...
* \file
*
* This header defines the \ref Ld::BinarySetOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BINARY_SET_OPERATOR_ELEMENT_BASE_H
#define LD_BINARY_SET_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Base class for operator elements with two children that accepts and provides a set value.
     */
    class LD_PUBLIC_API BinarySetOperatorElementBase:public BinaryOperatorElementBase {
        public:
            /**
            ...
            BinarySetOperatorElementBase();

            ~BinarySetOperatorElementBase() override;
