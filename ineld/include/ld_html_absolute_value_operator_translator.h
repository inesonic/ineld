...
* \file
*
* This header defines the \ref Ld::HtmlAbsoluteValueOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ABSOLUTE_VALUE_OPERATOR_TRANSLATOR_H
#define LD_HTML_ABSOLUTE_VALUE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::AbsoluteValueOperatorElement class.
     */
    class LD_PUBLIC_API HtmlAbsoluteValueOperatorTranslator:public HtmlGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlAbsoluteValueOperatorTranslator)

        public:
            ~HtmlAbsoluteValueOperatorTranslator() override;
