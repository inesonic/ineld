...
* \file
*
* This header defines the \ref Ld::LaTeXLogicalUnaryNotOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_LOGICAL_NOT_OPERATOR_TRANSLATOR_BASE_H
#define LD_LATEX_LOGICAL_NOT_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for LaTeX translators for logical not operators.
     */
    class LD_PUBLIC_API LaTeXLogicalNotOperatorTranslatorBase:public LaTeXOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXLogicalNotOperatorTranslatorBase)

        public:
            ~LaTeXLogicalNotOperatorTranslatorBase() override;
        ...
        protected:
             ...
             */
            virtual LogicalUnaryNotOperatorFormat::LogicalNotSymbol defaultLogicalNotSymbol() const = 0;
        ...
        private:
             ...
             */
            LogicalUnaryNotOperatorFormat::LogicalNotSymbol logicalNotStyle(Ld::FormatPointer format) const;
    };
};
