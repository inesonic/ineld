...
* \file
*
* This header defines the \ref Ld::RealDataTypeDecoder class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_REAL_DATA_TYPE_DECODER_H
#define LD_REAL_DATA_TYPE_DECODER_H
...
namespace Ld {
    ...
    /**
     * Class you can use to decode real values of the type Model::Real
     */
    class LD_PUBLIC_API RealDataTypeDecoder:public virtual RealDataTypeDecoderBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::RealDataTypeDecoder)

        public:
            RealDataTypeDecoder();

            ~RealDataTypeDecoder() override;
