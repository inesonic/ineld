...
* \file
*
* This header defines the \ref Ld::LaTeXFactorialOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_FACTORIAL_OPERATOR_TRANSLATOR_H
#define LD_LATEX_FACTORIAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::FactorialOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXFactorialOperatorTranslator:public LaTeXUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXFactorialOperatorTranslator)

        public:
            ~LaTeXFactorialOperatorTranslator() override;
