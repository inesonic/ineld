...
* \file
*
* This header defines the \ref Ld::SubsetOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SUBSET_OPERATOR_ELEMENT_BASE_H
#define LD_SUBSET_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for subset operator elements.
     */
    class LD_PUBLIC_API SubsetOperatorElementBase:public BinaryRelationalOperatorElementBase {
        public:
            /**
            ...
            SubsetOperatorElementBase();

            ~SubsetOperatorElementBase() override;
