...
* \file
*
* This header defines the \ref Ld::MatrixCombineTopToBottomOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MATRIX_COMBINE_TOP_TO_BOTTOM_OPERATOR_ELEMENT_H
#define LD_MATRIX_COMBINE_TOP_TO_BOTTOM_OPERATOR_ELEMENT_H
...
namespace Ld {
    class MatrixCombineTopToBottomOperatorVisual;

    /**
     * Element that provides a Matrix combine operator.  Matrices are combined in top to bottom order.
     */
    class LD_PUBLIC_API MatrixCombineTopToBottomOperatorElement:public BinaryMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::MatrixCombineTopToBottomOperatorElement)
        ...
        public:
            ...
            MatrixCombineTopToBottomOperatorElement();

            ~MatrixCombineTopToBottomOperatorElement() override;
             ...
             * \ref MatrixCombineTopToBottomOperatorElement instance.
             *
             * If the newly added \ref MatrixCombineTopToBottomOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref MatrixCombineTopToBottomOperatorVisual instance and \ref MatrixCombineTopToBottomOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(MatrixCombineTopToBottomOperatorVisual* newVisual);
             ...
             */
            MatrixCombineTopToBottomOperatorVisual* visual() const;
    };
};
