...
* \file
*
* This header defines the \ref Ld::FunctionVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_FUNCTION_VISUAL_H
#define LD_FUNCTION_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::FunctionElement instance.
     */
    class LD_PUBLIC_API FunctionVisual:public virtual VisualWithPositionalChildren {
        friend class FunctionElement;

        public:
            FunctionVisual();

            ~FunctionVisual() override;

            /**
             * Method you can use to obtain the \ref FunctionElement class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref FunctionElement instance.
             */
            QSharedPointer<FunctionElement> element() const;
