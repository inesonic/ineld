...
* \file
*
* This header defines the \ref Ld::UnaryPlusOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_UNARY_PLUS_OPERATOR_ELEMENT_H
#define LD_UNARY_PLUS_OPERATOR_ELEMENT_H
...
namespace Ld {
    class UnaryPlusOperatorVisual;

    /**
     * Element that provides support for the unary plus operator.
     */
    class LD_PUBLIC_API UnaryPlusOperatorElement:public UnaryNumericAndMatrixOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::UnaryPlusOperatorElement)
        ...
        public:
            ...
            UnaryPlusOperatorElement();

            ~UnaryPlusOperatorElement() override;
             ...
             * \ref Ld::UnaryPlusOperatorElement instance.
             *
             * If the newly added \ref UnaryPlusOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref UnaryPlusOperatorVisual instance and \ref UnaryPlusOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(UnaryPlusOperatorVisual* newVisual);
             ...
             */
            UnaryPlusOperatorVisual* visual() const;
