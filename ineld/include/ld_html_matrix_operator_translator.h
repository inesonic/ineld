...
* \file
*
* This file defines the \ref Ld::HtmlMatrixOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_MATRIX_OPERATOR_TRANSLATOR_H
#define LD_HTML_MATRIX_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::MatrixOperatorElement class.
     */
    class LD_PUBLIC_API HtmlMatrixOperatorTranslator:public HtmlMatrixOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlMatrixOperatorTranslator)

        public:
            ~HtmlMatrixOperatorTranslator() override;
