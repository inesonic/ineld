...
* \file
*
* This header defines the \ref Ld::ImageVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_IMAGE_VISUAL_H
#define LD_IMAGE_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::ImageElement instance.
     */
    class LD_PUBLIC_API ImageVisual:public virtual PayloadVisual {
        public:
            ImageVisual();

            ~ImageVisual() override;
             ...
             */
            QSharedPointer<ImageElement> element() const;
