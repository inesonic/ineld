...
* \file
*
* This header defines the \ref Ld::MultiplicationOperatorFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_MULTIPLICATION_OPERATOR_FORMAT_H
#define LD_MULTIPLICATION_OPERATOR_FORMAT_H
...
namespace Ld {
    /**
     * Class used to track the multiplication operator format.  This class extends the \ref Ld::OperatorFormat class to
     * include support for different multiplication symbols.
     */
    class LD_PUBLIC_API MultiplicationOperatorFormat:public OperatorFormat {
        public:
            /**
             * Enumeration of different multiplication symbol styles.
             */
            enum class MultiplicationSymbol: quint8 {
                /**
                 * Indicates an invalid multiplication symbol.
                 */
                INVALID,

                /**
                 * Indicates the application should use the default multiplication symbol for the type of operation.
                 */
                DEFAULT,

                /**
                 * Indicates a small space between parameters.  This is the default for simple multiplication.
                 */
                SPACE,

                /**
                 * Indicates a dot between parameters.  This is the default for dot products.
                 */
                DOT,

                /**
                 * Indicates a cross between parameters.  This is the default for cross products.
                 */
                CROSS,

                /**
                 * Indicates a circle between parameters.  This is the default for Hadamard products.
                 */
                CIRCLE
            };

            /**
             * Class you can use to track an aggregation of multiple \ref Ld::OperatorFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual OperatorFormat::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to obtain a set of multiplication symbols across the aggregation.
                     *
                     * \return Returns a set of multiplication symbols found across the aggregation.
                     */
                    QSet<MultiplicationOperatorFormat::MultiplicationSymbol> multiplicationSymbols() const;

                private:
                    /*
                     * Set of multiplication symbols.
                     */
                    QSet<MultiplicationOperatorFormat::MultiplicationSymbol> currentMultiplicationSymbols;
            };
            ...
            /**
             * The default multiplication symbol.
             */
            static const MultiplicationOperatorFormat::MultiplicationSymbol defaultMultiplicationSymbol;

            MultiplicationOperatorFormat();
             ...
             */
            MultiplicationOperatorFormat(const MultiplicationOperatorFormat& other);

            ~MultiplicationOperatorFormat() override;
            ...
            /**
             * Method you can use to set the multiplication symbol.
             *
             * \param[in] newMultiplicationSymbol The new multiplication symbol.
             */
            void setMultiplicationSymbol(MultiplicationSymbol newMultiplicationSymbol);

            /**
             * Method you can use to determine current multiplication symbol.
             *
             * \return The current multiplication symbol.
             */
        ...
        private:
            /**
             * The current multiplication symbol.
             */
            MultiplicationSymbol currentMultiplicationSymbol;
    };

    /**
     * Hash function used to generate hashes of multiplication symbols.
     *
    ...
    LD_PUBLIC_API Util::HashResult qHash(
        MultiplicationOperatorFormat::MultiplicationSymbol symbol,
