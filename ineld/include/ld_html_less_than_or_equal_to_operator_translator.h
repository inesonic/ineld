...
* \file
*
* This file defines the \ref Ld::HtmlLessThanOrEqualToOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_LESS_THAN_OR_EQUAL_TO_OPERATOR_TRANSLATOR_H
#define LD_HTML_LESS_THAN_OR_EQUAL_TO_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::LessThanOrEqualToOperatorElement class.
     */
    class LD_PUBLIC_API HtmlLessThanOrEqualToOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlLessThanOrEqualToOperatorTranslator)

        public:
            ~HtmlLessThanOrEqualToOperatorTranslator() override;
