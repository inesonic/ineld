...
* \file
*
* This header defines the \ref Ld::CppGroupingOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_GROUPING_OPERATOR_TRANSLATOR_BASE_H
#define LD_CPP_GROUPING_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * C++ translator for grouping operators that simply control precedence.  This base class is not really intended
     * for grouping operators that perform manipulations on child data.
     */
    class LD_PUBLIC_API CppGroupingOperatorTranslatorBase:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppGroupingOperatorTranslatorBase)

        public:
            ~CppGroupingOperatorTranslatorBase() override;
