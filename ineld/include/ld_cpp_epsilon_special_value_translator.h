...
* \file
*
* This header defines the \ref Ld::CppEpsilonSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_EPSILON_SPECIAL_VALUE_TRANSLATOR_H
#define LD_CPP_EPSILON_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::EpsilonSpecialValueElement class.
     */
    class LD_PUBLIC_API CppEpsilonSpecialValueTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppEpsilonSpecialValueTranslator)

        public:
            ~CppEpsilonSpecialValueTranslator() override;
