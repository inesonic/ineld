...
* \file
*
* This header defines the \ref Ld::BinaryLogicalOperatorElementBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BINARY_LOGICAL_OPERATOR_ELEMENT_BASE_H
#define LD_BINARY_LOGICAL_OPERATOR_ELEMENT_BASE_H
...
namespace Ld {
    /**
     * Trivial base class for logical operator elements with two children.
     */
    class LD_PUBLIC_API BinaryLogicalOperatorElementBase:public BinaryOperatorElementBase {
        public:
            /**
            ...
            BinaryLogicalOperatorElementBase();

            ~BinaryLogicalOperatorElementBase() override;
