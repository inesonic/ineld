...
* \file
*
* This header defines the \ref Ld::HtmlThereforeOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_THEREFORE_OPERATOR_TRANSLATOR_H
#define LD_HTML_THEREFORE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ThereforeOperatorElement class.
     */
    class LD_PUBLIC_API HtmlThereforeOperatorTranslator:public HtmlUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlThereforeOperatorTranslator)

        public:
            ~HtmlThereforeOperatorTranslator() override;
