...
* \file
*
* This file defines the \ref Ld::HtmlElseIfOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_ELSE_IF_OPERATOR_TRANSLATOR_H
#define LD_HTML_ELSE_IF_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ElseIfOperatorElement class.
     */
    class LD_PUBLIC_API HtmlElseIfOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlElseIfOperatorTranslator)

        public:
            ~HtmlElseIfOperatorTranslator() override;
