...
* \file
*
* This header defines the \ref Ld::CppNotElementOfSetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_NOT_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
#define LD_CPP_NOT_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::NotElementOfSetOperatorElement class.
     */
    class LD_PUBLIC_API CppNotElementOfSetOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppNotElementOfSetOperatorTranslator)

        public:
            ~CppNotElementOfSetOperatorTranslator() override;
