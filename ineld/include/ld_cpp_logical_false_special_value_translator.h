...
* \file
*
* This header defines the \ref Ld::CppLogicalFalseSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_LOGICAL_FALSE_SPECIAL_VALUE_TRANSLATOR_H
#define LD_CPP_LOGICAL_FALSE_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::LogicalFalseSpecialValueElement class.
     */
    class LD_PUBLIC_API CppLogicalFalseSpecialValueTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppLogicalFalseSpecialValueTranslator)

        public:
            ~CppLogicalFalseSpecialValueTranslator() override;
