...
* \file
*
* This file defines the \ref Ld::HtmlSupersetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SUPERSET_OPERATOR_TRANSLATOR_H
#define LD_HTML_SUPERSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SupersetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSupersetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSupersetOperatorTranslator)

        public:
            ~HtmlSupersetOperatorTranslator() override;
