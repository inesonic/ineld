...
* \file
*
* This header defines the \ref Ld::ParenthesisFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PARENTHESIS_FORMAT_H
#define LD_PARENTHESIS_FORMAT_H
...
namespace Ld {
    /**
     * Class used to track the operator format.  This class extends the \ref Ld::FontFormat class to include support
     * for different types of parenthesis.
     *
     * Note that values are hard-coded to align with EQt::GraphicsMathGroup::ParenthesisStyle
     */
    class LD_PUBLIC_API ParenthesisFormat:public virtual FontFormat {
        public:
            /**
             * Enumeration of different parenthesis styles.
             */
            typedef Element::ParenthesisStyle ParenthesisStyle;

            /**
             * Class you can use to track an aggregation of multiple \ref Ld::ParenthesisFormat instances.
             */
            class LD_PUBLIC_API Aggregation:public virtual FontFormat::Aggregation {
                public:
                    ...
                    /**
                     * Method you can use to obtain whether default parenthesis styles are allowed.
                     *
                     * \return Returns an \ref Ld::Format::BooleanAggregation indicating if the default parenthesis
                     *         style is allowed.
                     */
                    const BooleanAggregation& defaultParenthesisStyleAllowed() const;

                    /**
                     * Method you can use to obtain a set all the parenthesis styles in the aggregation.
                     *
                     * \return Returns all the parenthesis styles in the aggregation.
                     */
                    const QSet<ParenthesisFormat::ParenthesisStyle>& parenthesisStyles() const;

                private:
                    /**
                     * Set indicating if default parenthesis style is allowed.
                     */
                    BooleanAggregation currentDefaultParenthesisStyleAllowed;

                    /**
                     * Set of parenthesis styles.
                     */
                    QSet<ParenthesisFormat::ParenthesisStyle> currentParenthesisStyles;
            };
            ...
            /**
             * The default parenthesis style.
             */
            static const ParenthesisFormat::ParenthesisStyle defaultParenthesisStyle;
             ...
             */
            ParenthesisFormat(const ParenthesisFormat& other);

            ~ParenthesisFormat() override;
             ...
             *
             * \return Returns the format identifying name, in this case, "ParenthesisFormat".
             */
            QString typeName() const override;
            ...
            /**
             * Method you can use to determine if this format supports the default parenthesis style setting.
             *
             * \return Returns true if the format supports the default parenthesis style.  Returns false if the format
             *         does not support the default parenthesis style.  The default implementation returns true.
             */
            virtual bool supportsDefaultParenthesisStyle() const;

            /**
             * Method you can use to set the parenthesis style.
             *
            ...
            /**
             * Method you can use to determine current parenthesis style.
             *
             * \return The current parenthesis style.
             */
        ...
        protected:
            /**
             * Method that converts a parenthesis style to a string.
             *
             * \param[in] parenthesisStyle The parenthesis style to be converted.
             *
             * \return Returns the parenthesis style converted to a string.
             */
            static QString toString(ParenthesisStyle parenthesisStyle);
             ...
             *
             * \param[out] ok  An optional pointer to a boolean value.  The value will be set to true if the string
             *                 represented a valid value.
             *
             * \return Returns the parenthesis style converted to a string.
             */
            static ParenthesisStyle toParenthesisStyle(const QString& str, bool* ok = nullptr);
        ...
        private:
            /**
             * The current parameter style.
             */
            ParenthesisStyle currentParenthesisStyle;
    };

    /**
     * Hash function used to generate hashes of parenthesis style values.
     *
     * \param[in] parenthesisStyle The parenthesis style to calculate a hash for.
     *
