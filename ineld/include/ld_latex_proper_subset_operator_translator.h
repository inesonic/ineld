...
* \file
*
* This header defines the \ref Ld::LaTeXProperSubsetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_PROPER_SUBSET_OPERATOR_TRANSLATOR_H
#define LD_LATEX_PROPER_SUBSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::ProperSubsetOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXProperSubsetOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXProperSubsetOperatorTranslator)

        public:
            ~LaTeXProperSubsetOperatorTranslator() override;
