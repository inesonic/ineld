...
* \file
*
* This header defines the \ref Ld::LaTeXPageBreakElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_PAGE_BREAK_ELEMENT_TRANSLATOR_H
#define LD_LATEX_PAGE_BREAK_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the page break element.
     */
    class LD_PUBLIC_API LaTeXPageBreakElementTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXPageBreakElementTranslator)

        public:
            ~LaTeXPageBreakElementTranslator() override;
