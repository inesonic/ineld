...
* \file
*
* This header defines the \ref Ld::TupleVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_TUPLE_VISUAL_H
#define LD_TUPLE_VISUAL_H
...
namespace Ld {
    ...
    /**
     * Visual used to interact with a \ref Ld::TupleElement instance.
     */
    class LD_PUBLIC_API TupleVisual:public virtual VisualWithPositionalChildren {
        public:
            TupleVisual();

            ~TupleVisual() override;

            /**
             * Method you can use to obtain the \ref TupleElement class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref TupleElement instance.
             */
            QSharedPointer<TupleElement> element() const;
