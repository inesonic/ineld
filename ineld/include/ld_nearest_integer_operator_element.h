...
* \file
*
* This header defines the \ref Ld::NearestIntegerOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NEAREST_INTEGER_OPERATOR_ELEMENT_H
#define LD_NEAREST_INTEGER_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NearestIntegerOperatorVisual;

    /**
     * Element that provides an IEEE 754 compliant nearest integer operator.
     */
    class LD_PUBLIC_API NearestIntegerOperatorElement:public NumericGroupingOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NearestIntegerOperatorElement)
        ...
        public:
            ...
            NearestIntegerOperatorElement();

            ~NearestIntegerOperatorElement() override;
             ...
             * \ref Ld::NearestIntegerOperatorElement instance.
             *
             * If the newly added \ref NearestIntegerOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NearestIntegerOperatorVisual instance and \ref NearestIntegerOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NearestIntegerOperatorVisual* newVisual);
             ...
             */
            NearestIntegerOperatorVisual* visual() const;
    };
};
