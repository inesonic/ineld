...
* \file
*
* This header defines the \ref Ld::ElseIfOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ELSE_IF_OPERATOR_ELEMENT_H
#define LD_ELSE_IF_OPERATOR_ELEMENT_H
...
namespace Ld {
    class ElseIfOperatorVisual;

    /**
     * Element that provides an else if conditional operator.
     */
    class LD_PUBLIC_API ElseIfOperatorElement:public BinaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::ElseIfOperatorElement)
        ...
        public:
            ...
            ElseIfOperatorElement();

            ~ElseIfOperatorElement() override;
             ...
             * \ref ElseIfOperatorElement instance.
             *
             * If the newly added \ref ElseIfOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref ElseIfOperatorVisual instance and \ref ElseIfOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(ElseIfOperatorVisual* newVisual);
             ...
             */
            ElseIfOperatorVisual* visual() const;
