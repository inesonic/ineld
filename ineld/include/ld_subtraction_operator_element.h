...
* \file
*
* This header defines the \ref Ld::SubtractionOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SUBTRACTION_OPERATOR_ELEMENT_H
#define LD_SUBTRACTION_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SubtractionOperatorVisual;

    /**
     * Element that provides support for the subtraction operator.
     */
    class LD_PUBLIC_API SubtractionOperatorElement:public AdditionOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SubtractionOperatorElement)
        ...
        public:
            ...
            SubtractionOperatorElement();

            ~SubtractionOperatorElement() override;
             ...
             * \ref SubtractionOperatorElement instance.
             *
             * If the newly added \ref SubtractionOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SubtractionOperatorVisual instance and \ref SubtractionOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SubtractionOperatorVisual* newVisual);
             ...
             */
            SubtractionOperatorVisual* visual() const;
    };
};
