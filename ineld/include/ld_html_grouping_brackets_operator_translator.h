...
* \file
*
* This header defines the \ref Ld::HtmlGroupingBracketsOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_GROUPING_BRACKETS_OPERATOR_TRANSLATOR_H
#define LD_HTML_GROUPING_BRACKETS_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    /**
     * HTML translator class for the \ref Ld::GroupingBracketsOperatorElement class.
     */
    class LD_PUBLIC_API HtmlGroupingBracketsOperatorTranslator:public HtmlSimpleGroupingOperatorTranslatorBase {
        public:
            ~HtmlGroupingBracketsOperatorTranslator() override;
