...
* \file
*
* This header defines the \ref Ld::CppBraceConditionalOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_BRACE_CONDITIONAL_OPERATOR_TRANSLATOR_H
#define LD_CPP_BRACE_CONDITIONAL_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::BraceConditionalOperatorElement class.
     */
    class LD_PUBLIC_API CppBraceConditionalOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppBraceConditionalOperatorTranslator)

        public:
            ~CppBraceConditionalOperatorTranslator() override;
