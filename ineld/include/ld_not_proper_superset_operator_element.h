...
* \file
*
* This header defines the \ref Ld::NotProperSupersetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_PROPER_SUPERSET_OPERATOR_ELEMENT_H
#define LD_NOT_PROPER_SUPERSET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotProperSupersetOperatorVisual;

    /**
     * Element that provides support for the not proper superset operator.
     */
    class LD_PUBLIC_API NotProperSupersetOperatorElement:public SubsetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotProperSupersetOperatorElement)
        ...
        public:
            ...
            NotProperSupersetOperatorElement();

            ~NotProperSupersetOperatorElement() override;
             ...
             * \ref NotProperSupersetOperatorElement instance.
             *
             * If the newly added \ref NotProperSupersetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotProperSupersetOperatorVisual instance and \ref NotProperSupersetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotProperSupersetOperatorVisual* newVisual);
             ...
             */
            NotProperSupersetOperatorVisual* visual() const;
    };
};
