...
* \file
*
* Ths file defines the \ref Ld::HtmlNotElementOfSetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NOT_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
#define LD_HTML_NOT_ELEMENT_OF_SET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NotElementOfSetOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNotElementOfSetOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNotElementOfSetOperatorTranslator)

        public:
            ~HtmlNotElementOfSetOperatorTranslator() override;
