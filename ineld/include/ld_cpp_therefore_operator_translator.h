...
* \file
*
* This header defines the \ref Ld::CppThereforeOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_THEREFORE_OPERATOR_TRANSLATOR_H
#define LD_CPP_THEREFORE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator class for the \ref Ld::ThereforeOperatorElement class.
     */
    class LD_PUBLIC_API CppThereforeOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppThereforeOperatorTranslator)

        public:
            ~CppThereforeOperatorTranslator() override;
