...
* \file
*
* This header defines the \ref Ld::SetDataTypeFormat class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SET_DATA_TYPE_FORMAT_H
#define LD_SET_DATA_TYPE_FORMAT_H
...
namespace Ld {
    /**
     * Class that provides format information to render set data type values.
     */
    class LD_PUBLIC_API SetDataTypeFormat:public virtual ListDataTypeFormat {
        public:
            /**
             ...
             */
            SetDataTypeFormat(const SetDataTypeFormat& other);

            ~SetDataTypeFormat() override;
