...
* \file
*
* This header defines the \ref Ld::RootOperatorVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ROOT_OPERATOR_VISUAL_H
#define LD_ROOT_OPERATOR_VISUAL_H
...
namespace Ld {
    class RootOperatorElement;

    /**
     * Visual used to interact with a \ref Ld::RootOperatorElement instance.
     */
    class LD_PUBLIC_API RootOperatorVisual:public virtual VisualWithFixedChildren {
        public:
            RootOperatorVisual();

            ~RootOperatorVisual() override;

            /**
             * Method you can use to obtain the \ref RootOperatorElement class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref RootOperatorElement instance.
             */
            QSharedPointer<RootOperatorElement> element() const;
