...
* \file
*
* This header defines the \ref Ld::LaTeXVariableTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_VARIABLE_TRANSLATOR_H
#define LD_LATEX_VARIABLE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::VariableElement.
     */
    class LD_PUBLIC_API LaTeXVariableTranslator:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXVariableTranslator)

        public:
            ~LaTeXVariableTranslator() override;
