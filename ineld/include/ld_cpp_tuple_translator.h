...
* \file
*
* This header defines the \ref Ld::CppTupleTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_TUPLE_TRANSLATOR_H
#define LD_CPP_TUPLE_TRANSLATOR_H
...
namespace Ld {
    /**
     * C++ translator class for tuples.
     */
    class LD_PUBLIC_API CppTupleTranslator:public CppTranslator {
        public:
            ~CppTupleTranslator() override;
