...
* \file
*
* This header defines the \ref Ld::CppVariableTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_VARIABLE_TRANSLATOR_H
#define LD_CPP_VARIABLE_TRANSLATOR_H
...
namespace Ld {
     ...
     */
    class LD_PUBLIC_API CppVariableTranslator:public CppTranslator {
        public:
            ~CppVariableTranslator() override;
