...
* \file
*
* This file defines the \ref Ld::HtmlForAllInOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_FOR_ALL_IN_OPERATOR_TRANSLATOR_H
#define LD_HTML_FOR_ALL_IN_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::ForAllInOperatorElement class.
     */
    class LD_PUBLIC_API HtmlForAllInOperatorTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlForAllInOperatorTranslator)

        public:
            ~HtmlForAllInOperatorTranslator() override;
