...
* \file
*
* This file defines the \ref Ld::HtmlSetDifferenceOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SET_DIFFERENCE_OPERATOR_TRANSLATOR_H
#define LD_HTML_SET_DIFFERENCE_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SetDifferenceOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSetDifferenceOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSetDifferenceOperatorTranslator)

        public:
            ~HtmlSetDifferenceOperatorTranslator() override;
