...
* \file
*
* This header defines the \ref Ld::BooleanTypeVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_BOOLEAN_TYPE_VISUAL_H
#define LD_BOOLEAN_TYPE_VISUAL_H
...
namespace Ld {
    class BooleanTypeElement;

    /**
     * Visual used to interact with a \ref Ld::BooleanTypeElement instance.
     */
    class LD_PUBLIC_API BooleanTypeVisual:public virtual VisualWithNoChildren {
        public:
            BooleanTypeVisual();

            ~BooleanTypeVisual() override;
             ...
             */
            QSharedPointer<BooleanTypeElement> element() const;
