...
* \file
*
* This header defines the \ref Ld::LaTeXCeilingOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_CEILING_OPERATOR_TRANSLATOR_H
#define LD_LATEX_CEILING_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator class for the \ref Ld::CeilingOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXCeilingOperatorTranslator:public LaTeXGroupingOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXCeilingOperatorTranslator)

        public:
            ~LaTeXCeilingOperatorTranslator() override;
