...
* \file
*
* This header defines the \ref Ld::RootOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ROOT_OPERATOR_ELEMENT_H
#define LD_ROOT_OPERATOR_ELEMENT_H
...
namespace Ld {
    class RootOperatorVisual;

    /**
     * Element that provides support for root operations.
     */
    class LD_PUBLIC_API RootOperatorElement:public BinaryNumericOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::RootOperatorElement)
        ...
        public:
             ...
             * \ref RootOperatorElement instance.
             *
             * If the newly added \ref RootOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref RootOperatorVisual instance and \ref RootOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(RootOperatorVisual* newVisual);
             ...
             */
            RootOperatorVisual* visual() const;
