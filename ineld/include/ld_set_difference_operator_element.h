...
* \file
*
* This header defines the \ref Ld::SetDifferenceOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_SET_DIFFERENCE_OPERATOR_ELEMENT_H
#define LD_SET_DIFFERENCE_OPERATOR_ELEMENT_H
...
namespace Ld {
    class SetDifferenceOperatorVisual;

    /**
     * Element that provides support for the set difference operator.
     */
    class LD_PUBLIC_API SetDifferenceOperatorElement:public BinarySetOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::SetDifferenceOperatorElement)
        ...
        public:
            ...
            SetDifferenceOperatorElement();

            ~SetDifferenceOperatorElement() override;
             ...
             * \ref SetDifferenceOperatorElement instance.
             *
             * If the newly added \ref SetDifferenceOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref SetDifferenceOperatorVisual instance and \ref SetDifferenceOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(SetDifferenceOperatorVisual* newVisual);
             ...
             */
            SetDifferenceOperatorVisual* visual() const;
