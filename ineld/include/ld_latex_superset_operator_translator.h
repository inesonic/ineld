...
* \file
*
* This header defines the \ref Ld::LaTeXSupersetOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_SUPERSET_OPERATOR_TRANSLATOR_H
#define LD_LATEX_SUPERSET_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::SupersetOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXSupersetOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXSupersetOperatorTranslator)

        public:
            ~LaTeXSupersetOperatorTranslator() override;
