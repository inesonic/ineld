...
* \file
*
* This header defines the \ref Ld::IfOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_IF_OPERATOR_ELEMENT_H
#define LD_IF_OPERATOR_ELEMENT_H
...
namespace Ld {
    class IfOperatorVisual;

    /**
     * Element that provides an if conditional operator.  This operator varies from the conditional operator is that
     * it provides a different presentation and does not return a true/false value.
     */
    class LD_PUBLIC_API IfOperatorElement:public BinaryOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::IfOperatorElement)
        ...
        public:
             ...
             * \ref IfOperatorElement instance.
             *
             * If the newly added \ref IfOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref IfOperatorVisual instance and \ref IfOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(IfOperatorVisual* newVisual);
