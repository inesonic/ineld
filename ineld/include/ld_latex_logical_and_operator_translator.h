...
* \file
*
* This header defines the \ref Ld::LaTeXLogicalAndOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_LOGICAL_AND_OPERATOR_TRANSLATOR_H
#define LD_LATEX_LOGICAL_AND_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::LogicalAndOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXLogicalAndOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXLogicalAndOperatorTranslator)

        public:
            ~LaTeXLogicalAndOperatorTranslator() override;
