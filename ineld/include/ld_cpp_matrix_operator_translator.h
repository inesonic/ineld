...
* \file
*
* This header defines the \ref Ld::CppMatrixOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_MATRIX_OPERATOR_TRANSLATOR_H
#define LD_CPP_MATRIX_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::MatrixOperatorElement class.
     */
    class LD_PUBLIC_API CppMatrixOperatorTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppMatrixOperatorTranslator)

        public:
            ~CppMatrixOperatorTranslator() override;
