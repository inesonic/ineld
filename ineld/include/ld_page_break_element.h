...
* \file
*
* This header defines the \ref Ld::PageBreakElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_PAGE_BREAK_ELEMENT_H
#define LD_PAGE_BREAK_ELEMENT_H
...
namespace Ld {
    class PageBreakVisual;

    /**
     * Element that is used to represent a page break.
     */
    class LD_PUBLIC_API PageBreakElement:public ElementWithNoChildren {
        Q_DECLARE_TR_FUNCTIONS(Ld::PageBreakElement)
        ...
        public:
             ...
             * \ref PageBreakElement instance.
             *
             * If the newly added \ref PageBreakVisual already points to a different element, then those connections
             * will be broken in order to maintain a 1:1 relationship between any \ref PageBreakVisual instance and
             * \ref PageBreakElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(PageBreakVisual* newVisual);
