...
* \file
*
* This header defines the \ref Ld::LaTeXTopLevelOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_TOP_LEVEL_OPERATOR_TRANSLATOR_BASE_H
#define LD_LATEX_TOP_LEVEL_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for LaTeX translators for top-level operators.
     */
    class LD_PUBLIC_API LaTeXTopLevelOperatorTranslatorBase:public LaTeXTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXTopLevelOperatorTranslatorBase)

        public:
            ~LaTeXTopLevelOperatorTranslatorBase() override;
