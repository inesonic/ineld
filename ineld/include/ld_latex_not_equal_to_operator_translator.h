...
* \file
*
* This header defines the \ref Ld::LaTeXNotEqualToOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_NOT_EQUAL_TO_OPERATOR_TRANSLATOR_H
#define LD_LATEX_NOT_EQUAL_TO_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the \ref Ld::NotEqualToOperatorElement class.
     */
    class LD_PUBLIC_API LaTeXNotEqualToOperatorTranslator:public LaTeXBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::LaTeXNotEqualToOperatorTranslator)

        public:
            ~LaTeXNotEqualToOperatorTranslator() override;
