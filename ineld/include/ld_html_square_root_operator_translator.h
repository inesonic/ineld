...
* \file
*
* This header defines the \ref Ld::HtmlSquareRootOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SQUARE_ROOT_OPERATOR_TRANSLATOR_H
#define LD_HTML_SQUARE_ROOT_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SquareRootOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSquareRootOperatorTranslator:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSquareRootOperatorTranslator)

        public:
            ~HtmlSquareRootOperatorTranslator() override;
