...
* \file
*
* This header defines the \ref Ld::HtmlPlaceholderElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_FUNCTION_PLACEHOLDER_ELEMENT_TRANSLATOR_H
#define LD_HTML_FUNCTION_PLACEHOLDER_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::FunctionPlaceholderElement class.
     */
    class LD_PUBLIC_API HtmlFunctionPlaceholderElementTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlFunctionPlaceholderElementTranslator)

        public:
            ~HtmlFunctionPlaceholderElementTranslator() override;
