...
* \file
*
* This header defines the \ref Ld::CppNullSetSpecialValueTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_NULL_SET_SPECIAL_VALUE_TRANSLATOR_H
#define LD_CPP_NULL_SET_SPECIAL_VALUE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::NullSetSpecialValueElement class.
     */
    class LD_PUBLIC_API CppNullSetSpecialValueTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppNullSetSpecialValueTranslator)

        public:
            ~CppNullSetSpecialValueTranslator() override;
