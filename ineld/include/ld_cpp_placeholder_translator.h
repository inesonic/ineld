...
* \file
*
* This header defines the \ref Ld::CppPlaceholderTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_CPP_PLACEHOLDER_TRANSLATOR_H
#define LD_CPP_PLACEHOLDER_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * C++ translator for the \ref Ld::PlaceholderElement class.
     */
    class LD_PUBLIC_API CppPlaceholderTranslator:public CppTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::CppPlaceholderTranslator)

        public:
            ~CppPlaceholderTranslator() override;
