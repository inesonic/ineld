...
* \file
*
* This header defines the \ref Ld::HtmlNaryDisjointUnionOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_NARY_DISJOINT_UNION_OPERATOR_TRANSLATOR_H
#define LD_HTML_NARY_DISJOINT_UNION_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::NaryDisjointUnionOperatorElement class.
     */
    class LD_PUBLIC_API HtmlNaryDisjointUnionOperatorTranslator:public HtmlUnaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlNaryDisjointUnionOperatorTranslator)

        public:
            ~HtmlNaryDisjointUnionOperatorTranslator() override;
