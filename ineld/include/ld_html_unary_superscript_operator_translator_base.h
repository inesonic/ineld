...
* \file
*
* This header defines the \ref Ld::HtmlUnarySuperscriptOperatorTranslatorBase class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_UNARY_SUPERSCRIPT_OPERATOR_TRANSLATOR_BASE_H
#define LD_HTML_UNARY_SUPERSCRIPT_OPERATOR_TRANSLATOR_BASE_H
...
namespace Ld {
    ...
    /**
     * Base class for HTML translators used to render superscripted unary operators.
     */
    class LD_PUBLIC_API HtmlUnarySuperscriptOperatorTranslatorBase:public HtmlOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlUnarySuperscriptOperatorTranslatorBase)

        public:
            ~HtmlUnarySuperscriptOperatorTranslatorBase() override;
