...
* \file
*
* This header defines the \ref Ld::HtmlGroupingBracesOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_GROUPING_BRACES_OPERATOR_TRANSLATOR_H
#define LD_HTML_GROUPING_BRACES_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    /**
     * HTML translator class for the \ref Ld::GroupingBracesOperatorElement class.
     */
    class LD_PUBLIC_API HtmlGroupingBracesOperatorTranslator:public HtmlSimpleGroupingOperatorTranslatorBase {
        public:
            ~HtmlGroupingBracesOperatorTranslator() override;
