...
* \file
*
* This header defines the \ref Ld::LaTeXTableCellElementTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_LATEX_TABLE_CELL_ELEMENT_TRANSLATOR_H
#define LD_LATEX_TABLE_CELL_ELEMENT_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * LaTeX translator for the table cell element.  This is a dummy translator that exists to keep the code generator
     * happy.  Translation is performed within the Ld::LaTeXTableElementTranslator class.
     */
    class LD_PUBLIC_API LaTeXTableCellElementTranslator:public LaTeXTranslator {
        public:
            ~LaTeXTableCellElementTranslator() override;
