...
* \file
*
* This file defines the \ref Ld::HtmlSetContainsAsMemberOperatorTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SET_CONTAINS_AS_MEMBER_OPERATOR_TRANSLATOR_H
#define LD_HTML_SET_CONTAINS_AS_MEMBER_OPERATOR_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SetContainsAsMemberOperatorElement class.
     */
    class LD_PUBLIC_API HtmlSetContainsAsMemberOperatorTranslator:public HtmlBinaryOperatorTranslatorBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSetContainsAsMemberOperatorTranslator)

        public:
            ~HtmlSetContainsAsMemberOperatorTranslator() override;
