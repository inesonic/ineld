...
* \file
*
* This header defines the \ref Ld::NotElementOfSetOperatorElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_NOT_ELEMENT_OF_SET_OPERATOR_ELEMENT_H
#define LD_NOT_ELEMENT_OF_SET_OPERATOR_ELEMENT_H
...
namespace Ld {
    class NotElementOfSetOperatorVisual;

    /**
     * Element that supports the not element of set operator.
     */
    class LD_PUBLIC_API NotElementOfSetOperatorElement:public BinaryRelationalOperatorElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::NotElementOfSetOperatorElement)
        ...
        public:
            ...
            NotElementOfSetOperatorElement();

            ~NotElementOfSetOperatorElement() override;
             ...
             * \ref NotElementOfSetOperatorElement instance.
             *
             * If the newly added \ref NotElementOfSetOperatorVisual already points to a different element, then those
             * connections will be broken in order to maintain a 1:1 relationship between any
             * \ref NotElementOfSetOperatorVisual instance and \ref NotElementOfSetOperatorElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(NotElementOfSetOperatorVisual* newVisual);
             ...
             */
            NotElementOfSetOperatorVisual* visual() const;
    };
};
