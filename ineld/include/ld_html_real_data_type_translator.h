...
* \file
*
* This header defines the \ref Ld::HtmlRealDataTypeTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_REAL_DATA_TYPE_TRANSLATOR_H
#define LD_HTML_REAL_DATA_TYPE_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML data type translator for real values.
     */
    class LD_PUBLIC_API HtmlRealDataTypeTranslator:public HtmlDataTypeTranslator {
        public:
            /**
             * Static instance.
             */
            static const HtmlRealDataTypeTranslator instance;

            HtmlRealDataTypeTranslator();

            ~HtmlRealDataTypeTranslator() override;
