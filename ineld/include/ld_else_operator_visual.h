...
* \file
*
* This header defines the \ref Ld::ElseOperatorVisual class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_ELSE_OPERATOR_VISUAL_H
#define LD_ELSE_OPERATOR_VISUAL_H
...
namespace Ld {
    class ElseOperatorElement;

    /**
     * Visual used to interact with a \ref Ld::ElseOperatorElement instance.
     */
    class LD_PUBLIC_API ElseOperatorVisual:public virtual VisualWithFixedChildren {
        public:
            ElseOperatorVisual();

            ~ElseOperatorVisual() override;

            /**
             * Method you can use to obtain the \ref ElseOperatorElement class associated with this visual.
             *
             * \return Returns a pointer to the associated \ref ElseOperatorElement instance.
             */
            QSharedPointer<ElseOperatorElement> element() const;
