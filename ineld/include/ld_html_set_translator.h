...
* \file
*
* This header defines the \ref Ld::HtmlSetTranslator class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_HTML_SET_TRANSLATOR_H
#define LD_HTML_SET_TRANSLATOR_H
...
namespace Ld {
    ...
    /**
     * HTML translator class for the \ref Ld::SetElement class.
     */
    class LD_PUBLIC_API HtmlSetTranslator:public HtmlTranslator {
        Q_DECLARE_TR_FUNCTIONS(Ld::HtmlSetTranslator)

        public:
            ~HtmlSetTranslator() override;
