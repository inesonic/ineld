...
* \file
*
* This header defines the \ref Ld::EulersNumberSpecialValueElement class.
***********************************************************************************************************************/

/* .. sphinx-project ineld */

#ifndef LD_EULERS_NUMBER_SPECIAL_VALUE_ELEMENT_H
#define LD_EULERS_NUMBER_SPECIAL_VALUE_ELEMENT_H
...
namespace Ld {
    class EulersNumberSpecialValueVisual;

    /**
     * Element that provides support for Euler's number as a special constant.
     */
    class LD_PUBLIC_API EulersNumberSpecialValueElement:public SpecialSymbolElementBase {
        Q_DECLARE_TR_FUNCTIONS(Ld::EulersNumberSpecialValueElement)
        ...
        public:
            ...
            EulersNumberSpecialValueElement();

            ~EulersNumberSpecialValueElement() override;
             ...
             * \ref Ld::EulersNumberSpecialValueElement instance.
             *
             * If the newly added \ref Ld::EulersNumberSpecialValueVisual already points to a different element, then
             * those connections will be broken in order to maintain a 1:1 relationship between any
             * \ref Ld::EulersNumberSpecialValueVisual instance and \ref Ld::EulersNumberSpecialValueElement instance.
             *
             ...
             *                      the visual.
             */
            void setVisual(EulersNumberSpecialValueVisual* newVisual);
             ...
             */
            EulersNumberSpecialValueVisual* visual() const;
    };
};
